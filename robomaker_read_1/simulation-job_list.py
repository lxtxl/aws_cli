...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/robomaker/describe-simulation-job.html
if __name__ == '__main__':
    ...
    execute_one_parameter("robomaker", "describe-simulation-job", "job", add_option_dict)