...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/emr/delete-security-configuration.html
if __name__ == '__main__':
    ...
    write_one_parameter("emr", "delete-security-configuration", "name", add_option_dict)
