...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/emr/terminate-clusters.html
if __name__ == '__main__':
    ...
    write_one_parameter("emr", "terminate-clusters", "cluster-ids  ...", add_option_dict)
