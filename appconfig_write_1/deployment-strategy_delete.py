...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/appconfig/delete-deployment-strategy.html
if __name__ == '__main__':
    ...
    # deployment-strategy-id : The ID of the deployment strategy you want to delete.
    """
    add_option_dict = {}
    ...
    write_one_parameter("appconfig", "delete-deployment-strategy", "deployment-strategy-id", add_option_dict)
