...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/appconfig/delete-application.html
if __name__ == '__main__':
    ...
    # application-id : The ID of the application to delete.
    """
    add_option_dict = {}
    ...
    write_one_parameter("appconfig", "delete-application", "application-id", add_option_dict)
