...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/appstream/describe-images.html
if __name__ == '__main__':
    ...
    read_no_parameter("appstream", "describe-images", add_option_dict)