...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/neptune/modify-db-subnet-group.html
...
(string)
    ...
    write_two_parameter("neptune", "modify-db-subnet-group", "db-subnet-group-name", "subnet-ids", add_option_dict)
