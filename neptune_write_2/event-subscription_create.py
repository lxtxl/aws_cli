...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/neptune/create-event-subscription.html
...
Constraints: The name must be less than 255 characters.
    ...
    write_two_parameter("neptune", "create-event-subscription", "subscription-name", "sns-topic-arn", add_option_dict)
