...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/apigatewayv2/delete-authorizer.html
if __name__ == '__main__':
    ...
    write_two_parameter("apigatewayv2", "delete-authorizer", "api-id", "authorizer-id", add_option_dict)
