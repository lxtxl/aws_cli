...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/apigatewayv2/update-model.html
if __name__ == '__main__':
    ...
    write_two_parameter("apigatewayv2", "update-model", "api-id", "model-id", add_option_dict)
