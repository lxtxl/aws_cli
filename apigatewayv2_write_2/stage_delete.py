...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/apigatewayv2/delete-stage.html
if __name__ == '__main__':
    ...
    write_two_parameter("apigatewayv2", "delete-stage", "api-id", "stage-name", add_option_dict)
