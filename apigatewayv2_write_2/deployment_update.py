...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/apigatewayv2/update-deployment.html
if __name__ == '__main__':
    ...
    write_two_parameter("apigatewayv2", "update-deployment", "api-id", "deployment-id", add_option_dict)
