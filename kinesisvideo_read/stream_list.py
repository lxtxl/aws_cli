...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/kinesisvideo/describe-stream.html
if __name__ == '__main__':
    ...
    read_no_parameter("kinesisvideo", "describe-stream", add_option_dict)