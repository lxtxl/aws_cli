...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/efs/delete-file-system.html
if __name__ == '__main__':
    ...
    write_one_parameter("efs", "delete-file-system", "file-system-id", add_option_dict)
