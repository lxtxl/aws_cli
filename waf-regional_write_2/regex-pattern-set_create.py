...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/waf-regional/create-regex-pattern-set.html
if __name__ == '__main__':
    ...
    write_two_parameter("waf-regional", "create-regex-pattern-set", "name", "change-token", add_option_dict)
