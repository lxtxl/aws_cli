...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/waf-regional/put-permission-policy.html
if __name__ == '__main__':
    ...
    write_two_parameter("waf-regional", "put-permission-policy", "resource-arn", "policy", add_option_dict)
