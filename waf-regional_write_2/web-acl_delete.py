...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/waf-regional/delete-web-acl.html
if __name__ == '__main__':
    ...
    write_two_parameter("waf-regional", "delete-web-acl", "web-acl-id", "change-token", add_option_dict)
