...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/waf-regional/delete-regex-match-set.html
if __name__ == '__main__':
    ...
    write_two_parameter("waf-regional", "delete-regex-match-set", "regex-match-set-id", "change-token", add_option_dict)
