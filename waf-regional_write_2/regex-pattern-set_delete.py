...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/waf-regional/delete-regex-pattern-set.html
if __name__ == '__main__':
    ...
    write_two_parameter("waf-regional", "delete-regex-pattern-set", "regex-pattern-set-id", "change-token", add_option_dict)
