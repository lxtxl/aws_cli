...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/waf-regional/untag-resource.html
if __name__ == '__main__':
    ...
    write_two_parameter("waf-regional", "untag-resource", "resource-arn", "tag-keys", add_option_dict)
