...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/rds/describe-event-subscriptions.html
if __name__ == '__main__':
    ...
    read_no_parameter("rds", "describe-event-subscriptions", add_option_dict)