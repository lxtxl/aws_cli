...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/rds/describe-db-subnet-groups.html
if __name__ == '__main__':
    ...
    read_no_parameter("rds", "describe-db-subnet-groups", add_option_dict)