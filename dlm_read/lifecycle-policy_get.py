...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/dlm/get-lifecycle-policies.html
if __name__ == '__main__':
    ...
    read_no_parameter("dlm", "get-lifecycle-policies", add_option_dict)