...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/personalize/create-schema.html
if __name__ == '__main__':
    ...
    write_two_parameter("personalize", "create-schema", "name", "schema", add_option_dict)
