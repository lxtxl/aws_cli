...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/mq/list-configurations.html
if __name__ == '__main__':
    ...
    read_no_parameter("mq", "list-configurations", add_option_dict)