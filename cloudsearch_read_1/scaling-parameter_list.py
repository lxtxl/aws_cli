...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/cloudsearch/describe-scaling-parameters.html
if __name__ == '__main__':
    ...
    execute_one_parameter("cloudsearch", "describe-scaling-parameters", "domain-name", add_option_dict)