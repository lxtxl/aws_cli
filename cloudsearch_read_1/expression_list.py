...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/cloudsearch/describe-expressions.html
if __name__ == '__main__':
    ...
    execute_one_parameter("cloudsearch", "describe-expressions", "domain-name", add_option_dict)