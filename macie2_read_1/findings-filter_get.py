...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/macie2/get-findings-filter.html
if __name__ == '__main__':
    ...
    execute_one_parameter("macie2", "get-findings-filter", "id", add_option_dict)