...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/comprehend/stop-sentiment-detection-job.html
if __name__ == '__main__':
    ...
    # job-id : The identifier of the sentiment detection job to stop.
    """
    add_option_dict = {}
    ...
    write_one_parameter("comprehend", "stop-sentiment-detection-job", "job-id", add_option_dict)
