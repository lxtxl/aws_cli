...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/comprehend/delete-endpoint.html
if __name__ == '__main__':
    ...
    # endpoint-arn : The Amazon Resource Number (ARN) of the endpoint being deleted.
    """
    add_option_dict = {}
    ...
    write_one_parameter("comprehend", "delete-endpoint", "endpoint-arn", add_option_dict)
