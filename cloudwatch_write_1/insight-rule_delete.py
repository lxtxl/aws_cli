...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/cloudwatch/delete-insight-rules.html
if __name__ == '__main__':
    ...
    # rule-names : An array of the rule names to delete. If you need to find out the names of your rules, use DescribeInsightRules .
(string)
    """
    add_option_dict = {}
    ...
    write_one_parameter("cloudwatch", "delete-insight-rules", "rule-names", add_option_dict)
