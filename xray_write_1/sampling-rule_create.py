...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/xray/create-sampling-rule.html
if __name__ == '__main__':
    ...
    write_one_parameter("xray", "create-sampling-rule", "sampling-rule", add_option_dict)
