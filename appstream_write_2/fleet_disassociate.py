...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/appstream/disassociate-fleet.html
if __name__ == '__main__':
    ...
    write_two_parameter("appstream", "disassociate-fleet", "fleet-name", "stack-name", add_option_dict)
