...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/appstream/delete-user.html
...
USERPOOL
    ...
    write_two_parameter("appstream", "delete-user", "user-name", "authentication-type", add_option_dict)
