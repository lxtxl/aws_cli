...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/swf/deprecate-activity-type.html
if __name__ == '__main__':
    ...
    write_two_parameter("swf", "deprecate-activity-type", "domain", "activity-type", add_option_dict)
