...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/connect/list-lambda-functions.html
if __name__ == '__main__':
    ...
    execute_one_parameter("connect", "list-lambda-functions", "instance-id", add_option_dict)