...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/connect/list-contact-flows.html
if __name__ == '__main__':
    ...
    execute_one_parameter("connect", "list-contact-flows", "instance-id", add_option_dict)