...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/connect/describe-instance.html
if __name__ == '__main__':
    ...
    execute_one_parameter("connect", "describe-instance", "instance-id", add_option_dict)