...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/connect/list-approved-origins.html
if __name__ == '__main__':
    ...
    execute_one_parameter("connect", "list-approved-origins", "instance-id", add_option_dict)