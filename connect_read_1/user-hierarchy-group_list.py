...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/connect/list-user-hierarchy-groups.html
if __name__ == '__main__':
    ...
    execute_one_parameter("connect", "list-user-hierarchy-groups", "instance-id", add_option_dict)