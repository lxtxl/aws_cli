...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/mediaconvert/get-job.html
if __name__ == '__main__':
    ...
    execute_one_parameter("mediaconvert", "get-job", "id", add_option_dict)