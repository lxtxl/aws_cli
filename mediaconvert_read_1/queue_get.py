...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/mediaconvert/get-queue.html
if __name__ == '__main__':
    ...
    execute_one_parameter("mediaconvert", "get-queue", "name", add_option_dict)