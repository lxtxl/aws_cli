...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/datapipeline/deactivate-pipeline.html
if __name__ == '__main__':
    ...
    write_one_parameter("datapipeline", "deactivate-pipeline", "pipeline-id", add_option_dict)
