...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/datapipeline/delete-pipeline.html
if __name__ == '__main__':
    ...
    write_one_parameter("datapipeline", "delete-pipeline", "pipeline-id", add_option_dict)
