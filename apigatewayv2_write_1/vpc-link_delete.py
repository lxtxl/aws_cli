...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/apigatewayv2/delete-vpc-link.html
if __name__ == '__main__':
    ...
    write_one_parameter("apigatewayv2", "delete-vpc-link", "vpc-link-id", add_option_dict)
