...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/apigatewayv2/create-domain-name.html
if __name__ == '__main__':
    ...
    write_one_parameter("apigatewayv2", "create-domain-name", "domain-name", add_option_dict)
