...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/apigatewayv2/import-api.html
if __name__ == '__main__':
    ...
    write_one_parameter("apigatewayv2", "import-api", "body", add_option_dict)
