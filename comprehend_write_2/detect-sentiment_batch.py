...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/comprehend/batch-detect-sentiment.html
...
zh-TW
    ...
    write_two_parameter("comprehend", "batch-detect-sentiment", "text-list", "language-code", add_option_dict)
