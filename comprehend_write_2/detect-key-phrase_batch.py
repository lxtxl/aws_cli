...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/comprehend/batch-detect-key-phrases.html
...
zh-TW
    ...
    write_two_parameter("comprehend", "batch-detect-key-phrases", "text-list", "language-code", add_option_dict)
