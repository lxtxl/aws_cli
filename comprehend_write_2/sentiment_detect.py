...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/comprehend/detect-sentiment.html
...
zh-TW
    ...
    write_two_parameter("comprehend", "detect-sentiment", "text", "language-code", add_option_dict)
