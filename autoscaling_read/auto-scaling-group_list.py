...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/autoscaling/describe-auto-scaling-groups.html
if __name__ == '__main__':
    ...
    read_no_parameter("autoscaling", "describe-auto-scaling-groups", add_option_dict)