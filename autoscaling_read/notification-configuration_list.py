...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/autoscaling/describe-notification-configurations.html
if __name__ == '__main__':
    ...
    read_no_parameter("autoscaling", "describe-notification-configurations", add_option_dict)