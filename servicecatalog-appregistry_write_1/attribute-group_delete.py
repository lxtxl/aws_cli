...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/servicecatalog-appregistry/delete-attribute-group.html
if __name__ == '__main__':
    ...
    write_one_parameter("servicecatalog-appregistry", "delete-attribute-group", "attribute-group", add_option_dict)
