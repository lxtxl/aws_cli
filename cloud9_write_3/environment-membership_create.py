...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/cloud9/create-environment-membership.html
if __name__ == '__main__':
    ...
    # environment-id : The ID of the environment that contains the environment member you want to add.
    # user-arn : The Amazon Resource Name (ARN) of the environment member you want to add.
...
read-only
    ...
    write_three_parameter("cloud9", "create-environment-membership", "environment-id", "user-arn", "permissions", add_option_dict)
