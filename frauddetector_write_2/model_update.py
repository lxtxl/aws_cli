...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/frauddetector/update-model.html
...
ONLINE_FRAUD_INSIGHTS
    ...
    write_two_parameter("frauddetector", "update-model", "model-id", "model-type", add_option_dict)
