...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/describe-client-vpn-routes.html
if __name__ == '__main__':
    ...
    execute_one_parameter("ec2", "describe-client-vpn-routes", "client-vpn-endpoint-id", add_option_dict)