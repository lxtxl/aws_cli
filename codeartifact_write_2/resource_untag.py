...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/codeartifact/untag-resource.html
...
(string)
    ...
    write_two_parameter("codeartifact", "untag-resource", "resource-arn", "tag-keys", add_option_dict)
