...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/redshift/delete-usage-limit.html
if __name__ == '__main__':
    ...
    # usage-limit-id : The identifier of the usage limit to delete.
    """
    add_option_dict = {}
    ...
    write_one_parameter("redshift", "delete-usage-limit", "usage-limit-id", add_option_dict)
