...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/redshift/resize-cluster.html
if __name__ == '__main__':
    ...
    # cluster-identifier : The unique identifier for the cluster to resize.
    """
    add_option_dict = {}
    ...
    write_one_parameter("redshift", "resize-cluster", "cluster-identifier", add_option_dict)
