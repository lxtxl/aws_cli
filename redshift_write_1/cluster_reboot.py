...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/redshift/reboot-cluster.html
if __name__ == '__main__':
    ...
    write_one_parameter("redshift", "reboot-cluster", "cluster-identifier", add_option_dict)
