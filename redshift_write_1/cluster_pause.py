...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/redshift/pause-cluster.html
if __name__ == '__main__':
    ...
    # cluster-identifier : The identifier of the cluster to be paused.
    """
    add_option_dict = {}
    ...
    write_one_parameter("redshift", "pause-cluster", "cluster-identifier", add_option_dict)
