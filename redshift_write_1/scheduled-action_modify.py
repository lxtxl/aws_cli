...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/redshift/modify-scheduled-action.html
if __name__ == '__main__':
    ...
    # scheduled-action-name : The name of the scheduled action to modify.
    """
    add_option_dict = {}
    ...
    write_one_parameter("redshift", "modify-scheduled-action", "scheduled-action-name", add_option_dict)
