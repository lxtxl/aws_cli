...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/redshift/reset-cluster-parameter-group.html
if __name__ == '__main__':
    ...
    # parameter-group-name : The name of the cluster parameter group to be reset.
    """
    add_option_dict = {}
    ...
    write_one_parameter("redshift", "reset-cluster-parameter-group", "parameter-group-name", add_option_dict)
