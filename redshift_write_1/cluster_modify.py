...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/redshift/modify-cluster.html
if __name__ == '__main__':
    ...
    # cluster-identifier : The unique identifier of the cluster to be modified.
Example: examplecluster
    ...
    write_one_parameter("redshift", "modify-cluster", "cluster-identifier", add_option_dict)
