...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/kendra/start-data-source-sync-job.html
if __name__ == '__main__':
    ...
    write_two_parameter("kendra", "start-data-source-sync-job", "id", "index-id", add_option_dict)
