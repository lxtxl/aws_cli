...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/securityhub/describe-action-targets.html
if __name__ == '__main__':
    ...
    read_no_parameter("securityhub", "describe-action-targets", add_option_dict)