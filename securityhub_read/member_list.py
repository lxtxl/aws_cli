...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/securityhub/list-members.html
if __name__ == '__main__':
    ...
    read_no_parameter("securityhub", "list-members", add_option_dict)