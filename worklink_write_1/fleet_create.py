...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/worklink/create-fleet.html
if __name__ == '__main__':
    ...
    # fleet-name : A unique name for the fleet.
    """
    add_option_dict = {}
    ...
    write_one_parameter("worklink", "create-fleet", "fleet-name", add_option_dict)
