...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ram/reject-resource-share-invitation.html
if __name__ == '__main__':
    ...
    write_one_parameter("ram", "reject-resource-share-invitation", "resource-share-invitation-arn", add_option_dict)
