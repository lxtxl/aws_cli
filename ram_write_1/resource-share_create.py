...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ram/create-resource-share.html
if __name__ == '__main__':
    ...
    write_one_parameter("ram", "create-resource-share", "name", add_option_dict)
