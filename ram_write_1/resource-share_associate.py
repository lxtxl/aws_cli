...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ram/associate-resource-share.html
if __name__ == '__main__':
    ...
    write_one_parameter("ram", "associate-resource-share", "resource-share-arn", add_option_dict)
