...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ram/delete-resource-share.html
if __name__ == '__main__':
    ...
    write_one_parameter("ram", "delete-resource-share", "resource-share-arn", add_option_dict)
