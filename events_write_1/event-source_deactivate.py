...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/events/deactivate-event-source.html
if __name__ == '__main__':
    ...
    write_one_parameter("events", "deactivate-event-source", "name", add_option_dict)
