...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/events/disable-rule.html
if __name__ == '__main__':
    ...
    write_one_parameter("events", "disable-rule", "name", add_option_dict)
