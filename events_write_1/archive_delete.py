...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/events/delete-archive.html
if __name__ == '__main__':
    ...
    # archive-name : The name of the archive to delete.
    """
    add_option_dict = {}
    ...
    write_one_parameter("events", "delete-archive", "archive-name", add_option_dict)
