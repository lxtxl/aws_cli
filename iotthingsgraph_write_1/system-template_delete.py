...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iotthingsgraph/delete-system-template.html
...
urn:tdm:REGION/ACCOUNT ID/default:system:SYSTEMNAME
    ...
    write_one_parameter("iotthingsgraph", "delete-system-template", "id", add_option_dict)
