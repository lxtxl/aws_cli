...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iotthingsgraph/delete-flow-template.html
...
urn:tdm:REGION/ACCOUNT ID/default:workflow:WORKFLOWNAME
    ...
    write_one_parameter("iotthingsgraph", "delete-flow-template", "id", add_option_dict)
