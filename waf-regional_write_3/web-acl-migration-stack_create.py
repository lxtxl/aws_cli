...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/waf-regional/create-web-acl-migration-stack.html
...
The bucket policies must permit the migration process to write data. For listings of the bucket policies, see the Examples section.
    ...
    write_three_parameter("waf-regional", "create-web-acl-migration-stack", "web-acl-id", "s3-bucket-name", "ignore-unsupported-type | --no-ignore-unsupported-type", add_option_dict)
