...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/waf-regional/create-rule.html
if __name__ == '__main__':
    ...
    write_three_parameter("waf-regional", "create-rule", "name", "metric-name", "change-token", add_option_dict)
