...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/waf-regional/update-xss-match-set.html
if __name__ == '__main__':
    ...
    # xss-match-set-id : The XssMatchSetId of the XssMatchSet that you want to update. XssMatchSetId is returned by  CreateXssMatchSet and by  ListXssMatchSets .
...
Specify NONE if you donât want to perform any text transformations.
    ...
    write_three_parameter("waf-regional", "update-xss-match-set", "xss-match-set-id", "change-token", "updates", add_option_dict)
