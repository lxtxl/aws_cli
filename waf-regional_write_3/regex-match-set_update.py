...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/waf-regional/update-regex-match-set.html
...
RegexPatternSetId is returned by  CreateRegexPatternSet and by  ListRegexPatternSets .
    ...
    write_three_parameter("waf-regional", "update-regex-match-set", "regex-match-set-id", "updates", "change-token", add_option_dict)
