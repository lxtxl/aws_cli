...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/waf-regional/update-geo-match-set.html
...
The country that you want AWS WAF to search for.
    ...
    write_three_parameter("waf-regional", "update-geo-match-set", "geo-match-set-id", "change-token", "updates", add_option_dict)
