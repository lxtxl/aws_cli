...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/waf-regional/update-byte-match-set.html
...
The value of TargetString must appear at the end of the specified part of the web request.
    ...
    write_three_parameter("waf-regional", "update-byte-match-set", "byte-match-set-id", "change-token", "updates", add_option_dict)
