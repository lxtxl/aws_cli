...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/waf-regional/update-regex-pattern-set.html
...
Specifies the regular expression (regex) pattern that you want AWS WAF to search for, such as B[a@]dB[o0]t .
    ...
    write_three_parameter("waf-regional", "update-regex-pattern-set", "regex-pattern-set-id", "updates", "change-token", add_option_dict)
