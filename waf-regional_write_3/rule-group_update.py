...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/waf-regional/update-rule-group.html
...
The unique identifier for the rule to exclude from the rule group.
    ...
    write_three_parameter("waf-regional", "update-rule-group", "rule-group-id", "updates", "change-token", add_option_dict)
