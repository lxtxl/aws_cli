...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/waf-regional/update-sql-injection-match-set.html
...
Specify NONE if you donât want to perform any text transformations.
    ...
    write_three_parameter("waf-regional", "update-sql-injection-match-set", "sql-injection-match-set-id", "change-token", "updates", add_option_dict)
