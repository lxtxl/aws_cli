...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/globalaccelerator/delete-endpoint-group.html
if __name__ == '__main__':
    ...
    # endpoint-group-arn : The Amazon Resource Name (ARN) of the endpoint group to delete.
    """
    add_option_dict = {}
    ...
    write_one_parameter("globalaccelerator", "delete-endpoint-group", "endpoint-group-arn", add_option_dict)
