...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/globalaccelerator/update-accelerator.html
if __name__ == '__main__':
    ...
    # accelerator-arn : The Amazon Resource Name (ARN) of the accelerator to update.
    """
    add_option_dict = {}
    ...
    write_one_parameter("globalaccelerator", "update-accelerator", "accelerator-arn", add_option_dict)
