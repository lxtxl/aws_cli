...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/globalaccelerator/withdraw-byoip-cidr.html
if __name__ == '__main__':
    ...
    write_one_parameter("globalaccelerator", "withdraw-byoip-cidr", "cidr", add_option_dict)
