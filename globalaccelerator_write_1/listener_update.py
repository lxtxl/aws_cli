...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/globalaccelerator/update-listener.html
if __name__ == '__main__':
    ...
    # listener-arn : The Amazon Resource Name (ARN) of the listener to update.
    """
    add_option_dict = {}
    ...
    write_one_parameter("globalaccelerator", "update-listener", "listener-arn", add_option_dict)
