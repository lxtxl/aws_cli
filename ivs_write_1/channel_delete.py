...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ivs/delete-channel.html
if __name__ == '__main__':
    ...
    write_one_parameter("ivs", "delete-channel", "arn", add_option_dict)
