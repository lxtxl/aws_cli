...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/cognito-sync/describe-dataset.html
if __name__ == '__main__':
    ...
    execute_two_parameter("cognito-sync", "describe-dataset", "identity-pool-id", "identity-id", parameter_display_string)