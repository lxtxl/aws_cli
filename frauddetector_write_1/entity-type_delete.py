...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/frauddetector/delete-entity-type.html
if __name__ == '__main__':
    ...
    write_one_parameter("frauddetector", "delete-entity-type", "name", add_option_dict)
