...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/frauddetector/delete-outcome.html
if __name__ == '__main__':
    ...
    write_one_parameter("frauddetector", "delete-outcome", "name", add_option_dict)
