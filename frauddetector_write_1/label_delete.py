...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/frauddetector/delete-label.html
if __name__ == '__main__':
    ...
    write_one_parameter("frauddetector", "delete-label", "name", add_option_dict)
