...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/frauddetector/put-outcome.html
if __name__ == '__main__':
    ...
    write_one_parameter("frauddetector", "put-outcome", "name", add_option_dict)
