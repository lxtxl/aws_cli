...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/frauddetector/delete-rule.html
if __name__ == '__main__':
    ...
    write_one_parameter("frauddetector", "delete-rule", "rule", add_option_dict)
