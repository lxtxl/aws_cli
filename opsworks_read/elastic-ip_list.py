...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/opsworks/describe-elastic-ips.html
if __name__ == '__main__':
    ...
    read_no_parameter("opsworks", "describe-elastic-ips", add_option_dict)