...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/opsworks/describe-apps.html
if __name__ == '__main__':
    ...
    read_no_parameter("opsworks", "describe-apps", add_option_dict)