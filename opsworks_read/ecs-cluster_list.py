...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/opsworks/describe-ecs-clusters.html
if __name__ == '__main__':
    ...
    read_no_parameter("opsworks", "describe-ecs-clusters", add_option_dict)