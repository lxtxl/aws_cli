...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/glacier/list-tags-for-vault.html
if __name__ == '__main__':
    ...
    execute_two_parameter("glacier", "list-tags-for-vault", "account-id", "vault-name", parameter_display_string)