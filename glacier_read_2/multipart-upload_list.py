...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/glacier/list-multipart-uploads.html
if __name__ == '__main__':
    ...
    execute_two_parameter("glacier", "list-multipart-uploads", "account-id", "vault-name", parameter_display_string)