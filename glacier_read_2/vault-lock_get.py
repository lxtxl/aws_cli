...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/glacier/get-vault-lock.html
if __name__ == '__main__':
    ...
    execute_two_parameter("glacier", "get-vault-lock", "account-id", "vault-name", parameter_display_string)