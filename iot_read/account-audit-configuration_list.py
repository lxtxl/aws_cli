...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iot/describe-account-audit-configuration.html
if __name__ == '__main__':
    ...
    read_no_parameter("iot", "describe-account-audit-configuration", add_option_dict)