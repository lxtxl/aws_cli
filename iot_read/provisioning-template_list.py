...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iot/list-provisioning-templates.html
if __name__ == '__main__':
    ...
    read_no_parameter("iot", "list-provisioning-templates", add_option_dict)