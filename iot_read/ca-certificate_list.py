...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iot/list-ca-certificates.html
if __name__ == '__main__':
    ...
    read_no_parameter("iot", "list-ca-certificates", add_option_dict)