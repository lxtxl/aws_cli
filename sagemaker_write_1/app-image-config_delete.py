...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sagemaker/delete-app-image-config.html
if __name__ == '__main__':
    ...
    # app-image-config-name : The name of the AppImageConfig to delete.
    """
    add_option_dict = {}
    ...
    write_one_parameter("sagemaker", "delete-app-image-config", "app-image-config-name", add_option_dict)
