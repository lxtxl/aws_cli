...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sagemaker/delete-notebook-instance-lifecycle-config.html
if __name__ == '__main__':
    ...
    # notebook-instance-lifecycle-config-name : The name of the lifecycle configuration to delete.
    """
    add_option_dict = {}
    ...
    write_one_parameter("sagemaker", "delete-notebook-instance-lifecycle-config", "notebook-instance-lifecycle-config-name", add_option_dict)
