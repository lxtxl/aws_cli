...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sagemaker/delete-code-repository.html
if __name__ == '__main__':
    ...
    # code-repository-name : The name of the Git repository to delete.
    """
    add_option_dict = {}
    ...
    write_one_parameter("sagemaker", "delete-code-repository", "code-repository-name", add_option_dict)
