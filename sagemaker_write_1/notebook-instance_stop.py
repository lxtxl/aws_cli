...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sagemaker/stop-notebook-instance.html
if __name__ == '__main__':
    ...
    # notebook-instance-name : The name of the notebook instance to terminate.
    """
    add_option_dict = {}
    ...
    write_one_parameter("sagemaker", "stop-notebook-instance", "notebook-instance-name", add_option_dict)
