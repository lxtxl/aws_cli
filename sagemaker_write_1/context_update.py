...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sagemaker/update-context.html
if __name__ == '__main__':
    ...
    # context-name : The name of the context to update.
    """
    add_option_dict = {}
    ...
    write_one_parameter("sagemaker", "update-context", "context-name", add_option_dict)
