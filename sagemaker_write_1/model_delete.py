...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sagemaker/delete-model.html
if __name__ == '__main__':
    ...
    write_one_parameter("sagemaker", "delete-model", "model-name", add_option_dict)
