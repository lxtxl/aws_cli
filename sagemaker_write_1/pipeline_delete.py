...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sagemaker/delete-pipeline.html
if __name__ == '__main__':
    ...
    write_one_parameter("sagemaker", "delete-pipeline", "pipeline-name", add_option_dict)
