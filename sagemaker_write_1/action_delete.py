...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sagemaker/delete-action.html
if __name__ == '__main__':
    ...
    # action-name : The name of the action to delete.
    """
    add_option_dict = {}
    ...
    write_one_parameter("sagemaker", "delete-action", "action-name", add_option_dict)
