...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sagemaker/delete-notebook-instance.html
if __name__ == '__main__':
    ...
    # notebook-instance-name : The name of the Amazon SageMaker notebook instance to delete.
    """
    add_option_dict = {}
    ...
    write_one_parameter("sagemaker", "delete-notebook-instance", "notebook-instance-name", add_option_dict)
