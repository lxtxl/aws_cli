...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sagemaker/update-workteam.html
if __name__ == '__main__':
    ...
    # workteam-name : The name of the work team to update.
    """
    add_option_dict = {}
    ...
    write_one_parameter("sagemaker", "update-workteam", "workteam-name", add_option_dict)
