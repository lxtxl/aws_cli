...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sagemaker/stop-pipeline-execution.html
if __name__ == '__main__':
    ...
    write_one_parameter("sagemaker", "stop-pipeline-execution", "pipeline-execution-arn", add_option_dict)
