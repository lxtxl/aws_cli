...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sagemaker/start-monitoring-schedule.html
if __name__ == '__main__':
    ...
    # monitoring-schedule-name : The name of the schedule to start.
    """
    add_option_dict = {}
    ...
    write_one_parameter("sagemaker", "start-monitoring-schedule", "monitoring-schedule-name", add_option_dict)
