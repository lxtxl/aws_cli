...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sagemaker/create-notebook-instance-lifecycle-config.html
if __name__ == '__main__':
    ...
    write_one_parameter("sagemaker", "create-notebook-instance-lifecycle-config", "notebook-instance-lifecycle-config-name", add_option_dict)
