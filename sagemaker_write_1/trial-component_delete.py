...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sagemaker/delete-trial-component.html
if __name__ == '__main__':
    ...
    # trial-component-name : The name of the component to delete.
    """
    add_option_dict = {}
    ...
    write_one_parameter("sagemaker", "delete-trial-component", "trial-component-name", add_option_dict)
