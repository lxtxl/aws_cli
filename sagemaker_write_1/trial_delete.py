...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sagemaker/delete-trial.html
if __name__ == '__main__':
    ...
    # trial-name : The name of the trial to delete.
    """
    add_option_dict = {}
    ...
    write_one_parameter("sagemaker", "delete-trial", "trial-name", add_option_dict)
