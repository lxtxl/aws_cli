...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sagemaker/delete-image.html
if __name__ == '__main__':
    ...
    # image-name : The name of the image to delete.
    """
    add_option_dict = {}
    ...
    write_one_parameter("sagemaker", "delete-image", "image-name", add_option_dict)
