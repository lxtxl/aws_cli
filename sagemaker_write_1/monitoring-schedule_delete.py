...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sagemaker/delete-monitoring-schedule.html
if __name__ == '__main__':
    ...
    # monitoring-schedule-name : The name of the monitoring schedule to delete.
    """
    add_option_dict = {}
    ...
    write_one_parameter("sagemaker", "delete-monitoring-schedule", "monitoring-schedule-name", add_option_dict)
