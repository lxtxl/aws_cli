...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sagemaker/start-notebook-instance.html
if __name__ == '__main__':
    ...
    # notebook-instance-name : The name of the notebook instance to start.
    """
    add_option_dict = {}
    ...
    write_one_parameter("sagemaker", "start-notebook-instance", "notebook-instance-name", add_option_dict)
