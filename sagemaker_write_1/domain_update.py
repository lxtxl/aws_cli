...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sagemaker/update-domain.html
if __name__ == '__main__':
    ...
    write_one_parameter("sagemaker", "update-domain", "domain-id", add_option_dict)
