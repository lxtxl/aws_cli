...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sagemaker/create-trial-component.html
if __name__ == '__main__':
    ...
    # trial-component-name : The name of the component. The name must be unique in your AWS account and is not case-sensitive.
    """
    add_option_dict = {}
    ...
    write_one_parameter("sagemaker", "create-trial-component", "trial-component-name", add_option_dict)
