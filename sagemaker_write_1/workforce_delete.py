...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sagemaker/delete-workforce.html
if __name__ == '__main__':
    ...
    # workforce-name : The name of the workforce.
    """
    add_option_dict = {}
    ...
    write_one_parameter("sagemaker", "delete-workforce", "workforce-name", add_option_dict)
