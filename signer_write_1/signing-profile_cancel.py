...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/signer/cancel-signing-profile.html
if __name__ == '__main__':
    ...
    # profile-name : The name of the signing profile to be canceled.
    """
    add_option_dict = {}
    ...
    write_one_parameter("signer", "cancel-signing-profile", "profile-name", add_option_dict)
