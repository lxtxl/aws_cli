...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/rds/restore-db-cluster-from-snapshot.html
...
Constraint: Must be compatible with the engine of the source
    ...
    write_three_parameter("rds", "restore-db-cluster-from-snapshot", "db-cluster-identifier", "snapshot-identifier", "engine", add_option_dict)
