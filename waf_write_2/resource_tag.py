...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/waf/tag-resource.html
...
Value -> (string)
    ...
    write_two_parameter("waf", "tag-resource", "resource-arn", "tags", add_option_dict)
