...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/waf/delete-xss-match-set.html
if __name__ == '__main__':
    ...
    write_two_parameter("waf", "delete-xss-match-set", "xss-match-set-id", "change-token", add_option_dict)
