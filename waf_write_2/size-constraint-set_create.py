...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/waf/create-size-constraint-set.html
if __name__ == '__main__':
    ...
    write_two_parameter("waf", "create-size-constraint-set", "name", "change-token", add_option_dict)
