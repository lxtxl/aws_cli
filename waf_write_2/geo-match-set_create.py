...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/waf/create-geo-match-set.html
if __name__ == '__main__':
    ...
    write_two_parameter("waf", "create-geo-match-set", "name", "change-token", add_option_dict)
