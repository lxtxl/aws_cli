...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/waf/delete-size-constraint-set.html
if __name__ == '__main__':
    ...
    write_two_parameter("waf", "delete-size-constraint-set", "size-constraint-set-id", "change-token", add_option_dict)
