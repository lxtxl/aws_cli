...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/waf/delete-sql-injection-match-set.html
if __name__ == '__main__':
    ...
    write_two_parameter("waf", "delete-sql-injection-match-set", "sql-injection-match-set-id", "change-token", add_option_dict)
