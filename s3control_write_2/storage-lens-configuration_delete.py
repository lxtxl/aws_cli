...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/s3control/delete-storage-lens-configuration.html
if __name__ == '__main__':
    ...
    write_two_parameter("s3control", "delete-storage-lens-configuration", "config-id", "account-id", add_option_dict)
