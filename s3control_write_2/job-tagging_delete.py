...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/s3control/delete-job-tagging.html
if __name__ == '__main__':
    ...
    # job-id : The ID for the S3 Batch Operations job whose tags you want to delete.
    """
    add_option_dict = {}
    add_option_dict["parameter_display_string"] = parameter_display_string
    # ex: add_option_dict["no_value_parameter_list"] = "--single-parameter"
    write_two_parameter("s3control", "delete-job-tagging", "account-id", "job-id", add_option_dict)
