...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/mediaconnect/create-flow.html
if __name__ == '__main__':
    ...
    write_one_parameter("mediaconnect", "create-flow", "name", add_option_dict)
