...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/mediaconnect/delete-flow.html
if __name__ == '__main__':
    ...
    # flow-arn : The ARN of the flow that you want to delete.
    """
    add_option_dict = {}
    ...
    write_one_parameter("mediaconnect", "delete-flow", "flow-arn", add_option_dict)
