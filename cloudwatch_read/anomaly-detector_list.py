...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/cloudwatch/describe-anomaly-detectors.html
if __name__ == '__main__':
    ...
    read_no_parameter("cloudwatch", "describe-anomaly-detectors", add_option_dict)