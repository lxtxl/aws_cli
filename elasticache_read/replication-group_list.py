...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/elasticache/describe-replication-groups.html
if __name__ == '__main__':
    ...
    read_no_parameter("elasticache", "describe-replication-groups", add_option_dict)