...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/elasticache/describe-user-groups.html
if __name__ == '__main__':
    ...
    read_no_parameter("elasticache", "describe-user-groups", add_option_dict)