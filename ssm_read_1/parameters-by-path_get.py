...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ssm/get-parameters-by-path.html
if __name__ == '__main__':
    ...
    execute_one_parameter("ssm", "get-parameters-by-path", "path", add_option_dict)