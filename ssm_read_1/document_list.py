...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ssm/describe-document.html
if __name__ == '__main__':
    ...
    execute_one_parameter("ssm", "describe-document", "name", add_option_dict)