...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/pinpoint-email/create-configuration-set.html
if __name__ == '__main__':
    ...
    write_one_parameter("pinpoint-email", "create-configuration-set", "configuration-set-name", add_option_dict)
