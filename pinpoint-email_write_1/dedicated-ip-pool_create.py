...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/pinpoint-email/create-dedicated-ip-pool.html
if __name__ == '__main__':
    ...
    write_one_parameter("pinpoint-email", "create-dedicated-ip-pool", "pool-name", add_option_dict)
