...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/pinpoint-email/create-email-identity.html
if __name__ == '__main__':
    ...
    write_one_parameter("pinpoint-email", "create-email-identity", "email-identity", add_option_dict)
