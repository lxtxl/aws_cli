...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/lookoutvision/delete-project.html
if __name__ == '__main__':
    ...
    write_one_parameter("lookoutvision", "delete-project", "project-name", add_option_dict)
