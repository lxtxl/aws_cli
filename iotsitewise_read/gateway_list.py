...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iotsitewise/list-gateways.html
if __name__ == '__main__':
    ...
    read_no_parameter("iotsitewise", "list-gateways", add_option_dict)