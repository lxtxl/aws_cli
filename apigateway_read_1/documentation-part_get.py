...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/apigateway/get-documentation-parts.html
if __name__ == '__main__':
    ...
    execute_one_parameter("apigateway", "get-documentation-parts", "rest-api-id", add_option_dict)