...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/apigateway/get-usage-plan.html
if __name__ == '__main__':
    ...
    # usage-plan-id : [Required] The identifier of the  UsagePlan resource to be retrieved.
    """
    ...
    execute_one_parameter("apigateway", "get-usage-plan", "usage-plan-id", add_option_dict)