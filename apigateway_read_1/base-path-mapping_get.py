...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/apigateway/get-base-path-mappings.html
if __name__ == '__main__':
    ...
    # domain-name : [Required] The domain name of a  BasePathMapping resource.
    """
    ...
    execute_one_parameter("apigateway", "get-base-path-mappings", "domain-name", add_option_dict)