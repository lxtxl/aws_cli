...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/accessanalyzer/list-analyzers.html
if __name__ == '__main__':
    ...
    read_no_parameter("accessanalyzer", "list-analyzers", add_option_dict)