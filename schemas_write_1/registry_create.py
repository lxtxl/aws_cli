...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/schemas/create-registry.html
if __name__ == '__main__':
    ...
    write_one_parameter("schemas", "create-registry", "registry-name", add_option_dict)
