...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/schemas/stop-discoverer.html
if __name__ == '__main__':
    ...
    write_one_parameter("schemas", "stop-discoverer", "discoverer-id", add_option_dict)
