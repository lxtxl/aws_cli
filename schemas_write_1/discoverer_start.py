...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/schemas/start-discoverer.html
if __name__ == '__main__':
    ...
    write_one_parameter("schemas", "start-discoverer", "discoverer-id", add_option_dict)
