...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/chime/update-account.html
if __name__ == '__main__':
    ...
    write_one_parameter("chime", "update-account", "account-id", add_option_dict)
