...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/chime/delete-voice-connector-group.html
if __name__ == '__main__':
    ...
    write_one_parameter("chime", "delete-voice-connector-group", "voice-connector-group-id", add_option_dict)
