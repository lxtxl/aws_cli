...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/chime/delete-sip-media-application.html
if __name__ == '__main__':
    ...
    write_one_parameter("chime", "delete-sip-media-application", "sip-media-application-id", add_option_dict)
