...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/chime/update-phone-number.html
if __name__ == '__main__':
    ...
    write_one_parameter("chime", "update-phone-number", "phone-number-id", add_option_dict)
