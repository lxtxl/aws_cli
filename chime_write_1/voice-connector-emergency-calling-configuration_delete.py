...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/chime/delete-voice-connector-emergency-calling-configuration.html
if __name__ == '__main__':
    ...
    write_one_parameter("chime", "delete-voice-connector-emergency-calling-configuration", "voice-connector-id", add_option_dict)
