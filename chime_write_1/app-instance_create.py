...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/chime/create-app-instance.html
if __name__ == '__main__':
    ...
    write_one_parameter("chime", "create-app-instance", "name", add_option_dict)
