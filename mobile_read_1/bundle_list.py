...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/mobile/describe-bundle.html
if __name__ == '__main__':
    ...
    execute_one_parameter("mobile", "describe-bundle", "bundle-id", add_option_dict)