...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sagemaker-a2i-runtime/stop-human-loop.html
if __name__ == '__main__':
    ...
    # human-loop-name : The name of the human loop that you want to stop.
    """
    add_option_dict = {}
    ...
    write_one_parameter("sagemaker-a2i-runtime", "stop-human-loop", "human-loop-name", add_option_dict)
