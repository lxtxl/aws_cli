...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/backup/create-backup-plan.html
if __name__ == '__main__':
    ...
    write_one_parameter("backup", "create-backup-plan", "backup-plan", add_option_dict)
