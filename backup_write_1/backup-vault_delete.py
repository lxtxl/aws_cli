...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/backup/delete-backup-vault.html
if __name__ == '__main__':
    ...
    write_one_parameter("backup", "delete-backup-vault", "backup-vault-name", add_option_dict)
