...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/opsworks/start-stack.html
if __name__ == '__main__':
    ...
    write_one_parameter("opsworks", "start-stack", "stack-id", add_option_dict)
