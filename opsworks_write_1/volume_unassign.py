...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/opsworks/unassign-volume.html
if __name__ == '__main__':
    ...
    write_one_parameter("opsworks", "unassign-volume", "volume-id", add_option_dict)
