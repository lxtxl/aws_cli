...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/opsworks/deregister-elastic-ip.html
if __name__ == '__main__':
    ...
    write_one_parameter("opsworks", "deregister-elastic-ip", "elastic-ip", add_option_dict)
