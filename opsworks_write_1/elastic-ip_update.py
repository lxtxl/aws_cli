...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/opsworks/update-elastic-ip.html
if __name__ == '__main__':
    ...
    # elastic-ip : The IP address for which you want to update the name.
    """
    add_option_dict = {}
    ...
    write_one_parameter("opsworks", "update-elastic-ip", "elastic-ip", add_option_dict)
