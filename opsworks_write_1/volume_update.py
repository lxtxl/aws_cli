...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/opsworks/update-volume.html
if __name__ == '__main__':
    ...
    write_one_parameter("opsworks", "update-volume", "volume-id", add_option_dict)
