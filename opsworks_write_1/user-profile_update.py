...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/opsworks/update-user-profile.html
if __name__ == '__main__':
    ...
    # iam-user-arn : The user IAM ARN. This can also be a federated userâs ARN.
    """
    add_option_dict = {}
    ...
    write_one_parameter("opsworks", "update-user-profile", "iam-user-arn", add_option_dict)
