...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/opsworks/create-user-profile.html
if __name__ == '__main__':
    ...
    write_one_parameter("opsworks", "create-user-profile", "iam-user-arn", add_option_dict)
