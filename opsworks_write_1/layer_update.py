...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/opsworks/update-layer.html
if __name__ == '__main__':
    ...
    write_one_parameter("opsworks", "update-layer", "layer-id", add_option_dict)
