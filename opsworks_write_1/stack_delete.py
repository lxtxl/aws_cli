...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/opsworks/delete-stack.html
if __name__ == '__main__':
    ...
    write_one_parameter("opsworks", "delete-stack", "stack-id", add_option_dict)
