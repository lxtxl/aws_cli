...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/opsworks/assign-volume.html
if __name__ == '__main__':
    ...
    write_one_parameter("opsworks", "assign-volume", "volume-id", add_option_dict)
