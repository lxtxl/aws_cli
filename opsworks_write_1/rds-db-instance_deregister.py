...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/opsworks/deregister-rds-db-instance.html
if __name__ == '__main__':
    ...
    write_one_parameter("opsworks", "deregister-rds-db-instance", "rds-db-instance-arn", add_option_dict)
