...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/opsworks/delete-app.html
if __name__ == '__main__':
    ...
    write_one_parameter("opsworks", "delete-app", "app-id", add_option_dict)
