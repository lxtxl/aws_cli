...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/opsworks/deregister-volume.html
if __name__ == '__main__':
    ...
    # volume-id : The AWS OpsWorks Stacks volume ID, which is the GUID that AWS OpsWorks Stacks assigned to the instance when you registered the volume with the stack, not the Amazon EC2 volume ID.
    """
    add_option_dict = {}
    ...
    write_one_parameter("opsworks", "deregister-volume", "volume-id", add_option_dict)
