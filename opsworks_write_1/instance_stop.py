...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/opsworks/stop-instance.html
if __name__ == '__main__':
    ...
    write_one_parameter("opsworks", "stop-instance", "instance-id", add_option_dict)
