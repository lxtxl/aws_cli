...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/opsworks/unassign-instance.html
if __name__ == '__main__':
    ...
    write_one_parameter("opsworks", "unassign-instance", "instance-id", add_option_dict)
