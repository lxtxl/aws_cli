...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/opsworks/register-instance.html
if __name__ == '__main__':
    ...
    # stack-id : The ID of the stack that the instance is to be registered with.
    """
    add_option_dict = {}
    ...
    write_one_parameter("opsworks", "register-instance", "stack-id", add_option_dict)
