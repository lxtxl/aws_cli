...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iotanalytics/update-dataset.html
if __name__ == '__main__':
    ...
    # dataset-name : The name of the data set to update.
...
The URI of the location where dataset contents are stored, usually the URI of a file in an S3 bucket.
    ...
    write_two_parameter("iotanalytics", "update-dataset", "dataset-name", "actions", add_option_dict)
