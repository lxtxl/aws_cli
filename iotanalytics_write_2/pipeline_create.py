...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iotanalytics/create-pipeline.html
...
The next activity in the pipeline.
    ...
    write_two_parameter("iotanalytics", "create-pipeline", "pipeline-name", "pipeline-activities", add_option_dict)
