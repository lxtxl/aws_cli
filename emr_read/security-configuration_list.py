...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/emr/list-security-configurations.html
if __name__ == '__main__':
    ...
    read_no_parameter("emr", "list-security-configurations", add_option_dict)