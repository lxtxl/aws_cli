...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/cloudformation/describe-change-set.html
if __name__ == '__main__':
    ...
    # change-set-name : The name or Amazon Resource Name (ARN) of the change set that you want to describe.
    """
    ...
    execute_one_parameter("cloudformation", "describe-change-set", "change-set-name", add_option_dict)