...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/codepipeline/list-webhooks.html
if __name__ == '__main__':
    ...
    read_no_parameter("codepipeline", "list-webhooks", add_option_dict)