...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/cloudhsm/describe-hapg.html
if __name__ == '__main__':
    ...
    # hapg-arn : The ARN of the high-availability partition group to describe.
    """
    ...
    execute_one_parameter("cloudhsm", "describe-hapg", "hapg-arn", add_option_dict)