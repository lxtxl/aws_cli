...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/application-insights/update-log-pattern.html
if __name__ == '__main__':
    ...
    write_three_parameter("application-insights", "update-log-pattern", "resource-group-name", "pattern-set-name", "pattern-name", add_option_dict)
