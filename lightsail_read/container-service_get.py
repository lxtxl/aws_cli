...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/lightsail/get-container-services.html
if __name__ == '__main__':
    ...
    read_no_parameter("lightsail", "get-container-services", add_option_dict)