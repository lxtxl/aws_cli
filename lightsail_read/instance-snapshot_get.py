...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/lightsail/get-instance-snapshots.html
if __name__ == '__main__':
    ...
    read_no_parameter("lightsail", "get-instance-snapshots", add_option_dict)