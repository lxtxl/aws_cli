...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/lightsail/get-certificates.html
if __name__ == '__main__':
    ...
    read_no_parameter("lightsail", "get-certificates", add_option_dict)