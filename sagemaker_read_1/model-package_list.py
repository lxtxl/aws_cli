...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sagemaker/describe-model-package.html
if __name__ == '__main__':
    ...
    # model-package-name : The name of the model package to describe.
    """
    ...
    execute_one_parameter("sagemaker", "describe-model-package", "model-package-name", add_option_dict)