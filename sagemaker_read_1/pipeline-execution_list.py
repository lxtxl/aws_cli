...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sagemaker/describe-pipeline-execution.html
if __name__ == '__main__':
    ...
    execute_one_parameter("sagemaker", "describe-pipeline-execution", "pipeline-execution-arn", add_option_dict)