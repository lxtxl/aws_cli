...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sagemaker/describe-training-job.html
if __name__ == '__main__':
    ...
    # training-job-name : The name of the training job.
    """
    ...
    execute_one_parameter("sagemaker", "describe-training-job", "training-job-name", add_option_dict)