...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sagemaker/describe-project.html
if __name__ == '__main__':
    ...
    # project-name : The name of the project to describe.
    """
    ...
    execute_one_parameter("sagemaker", "describe-project", "project-name", add_option_dict)