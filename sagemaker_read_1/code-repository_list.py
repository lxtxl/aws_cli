...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sagemaker/describe-code-repository.html
if __name__ == '__main__':
    ...
    # code-repository-name : The name of the Git repository to describe.
    """
    ...
    execute_one_parameter("sagemaker", "describe-code-repository", "code-repository-name", add_option_dict)