...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sagemaker/describe-context.html
if __name__ == '__main__':
    ...
    # context-name : The name of the context to describe.
    """
    ...
    execute_one_parameter("sagemaker", "describe-context", "context-name", add_option_dict)