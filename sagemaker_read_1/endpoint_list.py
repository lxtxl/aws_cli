...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sagemaker/describe-endpoint.html
if __name__ == '__main__':
    ...
    execute_one_parameter("sagemaker", "describe-endpoint", "endpoint-name", add_option_dict)