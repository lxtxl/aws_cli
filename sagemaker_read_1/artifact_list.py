...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sagemaker/describe-artifact.html
if __name__ == '__main__':
    ...
    # artifact-arn : The Amazon Resource Name (ARN) of the artifact to describe.
    """
    ...
    execute_one_parameter("sagemaker", "describe-artifact", "artifact-arn", add_option_dict)