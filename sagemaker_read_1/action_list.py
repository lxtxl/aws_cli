...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sagemaker/describe-action.html
if __name__ == '__main__':
    ...
    # action-name : The name of the action to describe.
    """
    ...
    execute_one_parameter("sagemaker", "describe-action", "action-name", add_option_dict)