...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sagemaker/describe-image-version.html
if __name__ == '__main__':
    ...
    execute_one_parameter("sagemaker", "describe-image-version", "image-name", add_option_dict)