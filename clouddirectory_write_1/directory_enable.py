...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/clouddirectory/enable-directory.html
if __name__ == '__main__':
    ...
    # directory-arn : The ARN of the directory to enable.
    """
    add_option_dict = {}
    ...
    write_one_parameter("clouddirectory", "enable-directory", "directory-arn", add_option_dict)
