...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/clouddirectory/delete-directory.html
if __name__ == '__main__':
    ...
    # directory-arn : The ARN of the directory to delete.
    """
    add_option_dict = {}
    ...
    write_one_parameter("clouddirectory", "delete-directory", "directory-arn", add_option_dict)
