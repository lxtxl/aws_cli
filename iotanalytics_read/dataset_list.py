...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iotanalytics/list-datasets.html
if __name__ == '__main__':
    ...
    read_no_parameter("iotanalytics", "list-datasets", add_option_dict)