...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iotanalytics/list-channels.html
if __name__ == '__main__':
    ...
    read_no_parameter("iotanalytics", "list-channels", add_option_dict)