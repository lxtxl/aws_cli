...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/amplify/delete-branch.html
if __name__ == '__main__':
    ...
    write_two_parameter("amplify", "delete-branch", "app-id", "branch-name", add_option_dict)
