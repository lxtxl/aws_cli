...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/amplify/create-backend-environment.html
if __name__ == '__main__':
    ...
    write_two_parameter("amplify", "create-backend-environment", "app-id", "environment-name", add_option_dict)
