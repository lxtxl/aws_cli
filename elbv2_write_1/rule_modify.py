...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/elbv2/modify-rule.html
if __name__ == '__main__':
    ...
    write_one_parameter("elbv2", "modify-rule", "rule-arn", add_option_dict)
