...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/elbv2/delete-listener.html
if __name__ == '__main__':
    ...
    write_one_parameter("elbv2", "delete-listener", "listener-arn", add_option_dict)
