...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/cloudfront/get-cache-policy.html
if __name__ == '__main__':
    ...
    execute_one_parameter("cloudfront", "get-cache-policy", "id", add_option_dict)