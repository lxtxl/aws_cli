...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/license-manager/list-tokens.html
if __name__ == '__main__':
    ...
    read_no_parameter("license-manager", "list-tokens", add_option_dict)