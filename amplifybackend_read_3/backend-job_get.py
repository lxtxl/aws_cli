...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/amplifybackend/get-backend-job.html
if __name__ == '__main__':
    ...
    execute_two_parameter("amplifybackend", "get-backend-job", "app-id", "backend-environment-name", parameter_display_string)