...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/medialive/list-reservations.html
if __name__ == '__main__':
    ...
    read_no_parameter("medialive", "list-reservations", add_option_dict)