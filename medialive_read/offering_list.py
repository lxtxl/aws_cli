...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/medialive/list-offerings.html
if __name__ == '__main__':
    ...
    read_no_parameter("medialive", "list-offerings", add_option_dict)