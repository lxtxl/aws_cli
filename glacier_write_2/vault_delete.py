...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/glacier/delete-vault.html
if __name__ == '__main__':
    ...
    write_two_parameter("glacier", "delete-vault", "account-id", "vault-name", add_option_dict)
