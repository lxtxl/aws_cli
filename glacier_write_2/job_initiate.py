...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/glacier/initiate-job.html
if __name__ == '__main__':
    ...
    write_two_parameter("glacier", "initiate-job", "account-id", "vault-name", add_option_dict)
