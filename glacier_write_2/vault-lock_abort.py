...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/glacier/abort-vault-lock.html
if __name__ == '__main__':
    ...
    write_two_parameter("glacier", "abort-vault-lock", "account-id", "vault-name", add_option_dict)
