...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/glacier/add-tags-to-vault.html
if __name__ == '__main__':
    ...
    write_two_parameter("glacier", "add-tags-to-vault", "account-id", "vault-name", add_option_dict)
