...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/glacier/delete-vault-notifications.html
if __name__ == '__main__':
    ...
    write_two_parameter("glacier", "delete-vault-notifications", "account-id", "vault-name", add_option_dict)
