...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/glacier/set-vault-notifications.html
if __name__ == '__main__':
    ...
    write_two_parameter("glacier", "set-vault-notifications", "account-id", "vault-name", add_option_dict)
