...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/glacier/remove-tags-from-vault.html
if __name__ == '__main__':
    ...
    write_two_parameter("glacier", "remove-tags-from-vault", "account-id", "vault-name", add_option_dict)
