...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/glacier/initiate-multipart-upload.html
if __name__ == '__main__':
    ...
    write_two_parameter("glacier", "initiate-multipart-upload", "account-id", "vault-name", add_option_dict)
