...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/route53resolver/disassociate-resolver-query-log-config.html
if __name__ == '__main__':
    ...
    # resolver-query-log-config-id : The ID of the query logging configuration that you want to disassociate a specified VPC from.
    # resource-id : The ID of the Amazon VPC that you want to disassociate from a specified query logging configuration.
    """
    add_option_dict = {}
    add_option_dict["parameter_display_string"] = parameter_display_string
    # ex: add_option_dict["no_value_parameter_list"] = "--single-parameter"
    write_two_parameter("route53resolver", "disassociate-resolver-query-log-config", "resolver-query-log-config-id", "resource-id", add_option_dict)
