...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/glacier/get-job-output.html
if __name__ == '__main__':
    ...
    execute_two_parameter("glacier", "get-job-output", "account-id", "vault-name", parameter_display_string)