...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/glacier/describe-job.html
if __name__ == '__main__':
    ...
    execute_two_parameter("glacier", "describe-job", "account-id", "vault-name", parameter_display_string)