...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/glacier/list-parts.html
if __name__ == '__main__':
    ...
    execute_two_parameter("glacier", "list-parts", "account-id", "vault-name", parameter_display_string)