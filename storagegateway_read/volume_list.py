...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/storagegateway/list-volumes.html
if __name__ == '__main__':
    ...
    read_no_parameter("storagegateway", "list-volumes", add_option_dict)