...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/storagegateway/list-automatic-tape-creation-policies.html
if __name__ == '__main__':
    ...
    read_no_parameter("storagegateway", "list-automatic-tape-creation-policies", add_option_dict)