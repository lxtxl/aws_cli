...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/storagegateway/describe-tape-archives.html
if __name__ == '__main__':
    ...
    read_no_parameter("storagegateway", "describe-tape-archives", add_option_dict)