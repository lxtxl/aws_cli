...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/kendra/delete-index.html
if __name__ == '__main__':
    ...
    write_one_parameter("kendra", "delete-index", "id", add_option_dict)
