...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/route53domains/list-tags-for-domain.html
if __name__ == '__main__':
    ...
    # domain-name : The domain for which you want to get a list of tags.
    """
    ...
    execute_one_parameter("route53domains", "list-tags-for-domain", "domain-name", add_option_dict)