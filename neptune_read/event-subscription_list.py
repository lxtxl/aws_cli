...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/neptune/describe-event-subscriptions.html
if __name__ == '__main__':
    ...
    read_no_parameter("neptune", "describe-event-subscriptions", add_option_dict)