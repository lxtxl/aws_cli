...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/neptune/describe-db-cluster-endpoints.html
if __name__ == '__main__':
    ...
    read_no_parameter("neptune", "describe-db-cluster-endpoints", add_option_dict)