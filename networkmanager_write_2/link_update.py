...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/networkmanager/update-link.html
if __name__ == '__main__':
    ...
    write_two_parameter("networkmanager", "update-link", "global-network-id", "link-id", add_option_dict)
