...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/networkmanager/update-device.html
if __name__ == '__main__':
    ...
    write_two_parameter("networkmanager", "update-device", "global-network-id", "device-id", add_option_dict)
