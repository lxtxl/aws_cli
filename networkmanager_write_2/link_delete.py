...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/networkmanager/delete-link.html
if __name__ == '__main__':
    ...
    write_two_parameter("networkmanager", "delete-link", "global-network-id", "link-id", add_option_dict)
