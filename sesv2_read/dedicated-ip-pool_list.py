...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sesv2/list-dedicated-ip-pools.html
if __name__ == '__main__':
    ...
    read_no_parameter("sesv2", "list-dedicated-ip-pools", add_option_dict)