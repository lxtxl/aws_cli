...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sesv2/list-import-jobs.html
if __name__ == '__main__':
    ...
    read_no_parameter("sesv2", "list-import-jobs", add_option_dict)