...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/detective/list-invitations.html
if __name__ == '__main__':
    ...
    read_no_parameter("detective", "list-invitations", add_option_dict)