...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/globalaccelerator/list-accelerators.html
if __name__ == '__main__':
    ...
    read_no_parameter("globalaccelerator", "list-accelerators", add_option_dict)