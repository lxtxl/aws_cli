...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/comprehendmedical/describe-phi-detection-job.html
if __name__ == '__main__':
    ...
    # job-id : The identifier that Amazon Comprehend Medical generated for the job. The StartPHIDetectionJob operation returns this identifier in its response.
    """
    ...
    execute_one_parameter("comprehendmedical", "describe-phi-detection-job", "job-id", add_option_dict)