...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/resource-groups/get-group.html
if __name__ == '__main__':
    ...
    read_no_parameter("resource-groups", "get-group", add_option_dict)