...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/personalize/describe-solution.html
if __name__ == '__main__':
    ...
    # solution-arn : The Amazon Resource Name (ARN) of the solution to describe.
    """
    ...
    execute_one_parameter("personalize", "describe-solution", "solution-arn", add_option_dict)