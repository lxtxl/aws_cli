...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/dynamodb/update-item.html
...
"BOOL": true
    ...
    write_two_parameter("dynamodb", "update-item", "table-name", "key", add_option_dict)
