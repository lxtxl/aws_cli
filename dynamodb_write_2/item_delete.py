...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/dynamodb/delete-item.html
if __name__ == '__main__':
    ...
    # table-name : The name of the table from which to delete the item.
...
"BOOL": true
    ...
    write_two_parameter("dynamodb", "delete-item", "table-name", "key", add_option_dict)
