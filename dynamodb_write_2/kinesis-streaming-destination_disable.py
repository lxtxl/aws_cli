...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/dynamodb/disable-kinesis-streaming-destination.html
if __name__ == '__main__':
    ...
    write_two_parameter("dynamodb", "disable-kinesis-streaming-destination", "table-name", "stream-arn", add_option_dict)
