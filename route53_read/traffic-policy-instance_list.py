...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/route53/list-traffic-policy-instances.html
if __name__ == '__main__':
    ...
    read_no_parameter("route53", "list-traffic-policy-instances", add_option_dict)