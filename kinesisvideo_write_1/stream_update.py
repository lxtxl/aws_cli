...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/kinesisvideo/update-stream.html
if __name__ == '__main__':
    ...
    # current-version : The version of the stream whose metadata you want to update.
    """
    add_option_dict = {}
    ...
    write_one_parameter("kinesisvideo", "update-stream", "current-version", add_option_dict)
