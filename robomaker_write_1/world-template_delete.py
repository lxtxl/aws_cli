...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/robomaker/delete-world-template.html
if __name__ == '__main__':
    ...
    write_one_parameter("robomaker", "delete-world-template", "template", add_option_dict)
