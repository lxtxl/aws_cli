...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/accessanalyzer/get-analyzer.html
if __name__ == '__main__':
    ...
    # analyzer-name : The name of the analyzer retrieved.
    """
    ...
    execute_one_parameter("accessanalyzer", "get-analyzer", "analyzer-name", add_option_dict)