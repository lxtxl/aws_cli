...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/accessanalyzer/list-archive-rules.html
if __name__ == '__main__':
    ...
    execute_one_parameter("accessanalyzer", "list-archive-rules", "analyzer-name", add_option_dict)