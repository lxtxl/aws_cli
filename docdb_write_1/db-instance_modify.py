...
if __name__ == '__main__':
    ...
    # db-instance-identifier : The instance identifier. This value is stored as a lowercase string.
Constraints:
...
Must match the identifier of an existing DBInstance .
    ...
    write_one_parameter("docdb", "modify-db-instance", "db-instance-identifier", add_option_dict)
