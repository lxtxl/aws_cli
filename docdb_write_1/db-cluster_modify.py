...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/docdb/modify-db-cluster.html
if __name__ == '__main__':
    ...
    # db-cluster-identifier : The cluster identifier for the cluster that is being modified. This parameter is not case sensitive.
Constraints:
...
Must match the identifier of an existing DBCluster .
    ...
    write_one_parameter("docdb", "modify-db-cluster", "db-cluster-identifier", add_option_dict)
