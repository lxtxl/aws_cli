...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/docdb/start-db-cluster.html
if __name__ == '__main__':
    ...
    # db-cluster-identifier : The identifier of the cluster to restart. Example: docdb-2019-05-28-15-24-52
    """
    add_option_dict = {}
    ...
    write_one_parameter("docdb", "start-db-cluster", "db-cluster-identifier", add_option_dict)
