...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/workdocs/delete-folder.html
if __name__ == '__main__':
    ...
    write_one_parameter("workdocs", "delete-folder", "folder-id", add_option_dict)
