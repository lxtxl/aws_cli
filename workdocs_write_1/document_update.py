...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/workdocs/update-document.html
if __name__ == '__main__':
    ...
    write_one_parameter("workdocs", "update-document", "document-id", add_option_dict)
