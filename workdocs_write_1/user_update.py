...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/workdocs/update-user.html
if __name__ == '__main__':
    ...
    write_one_parameter("workdocs", "update-user", "user-id", add_option_dict)
