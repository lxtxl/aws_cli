...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/workdocs/activate-user.html
if __name__ == '__main__':
    ...
    write_one_parameter("workdocs", "activate-user", "user-id", add_option_dict)
