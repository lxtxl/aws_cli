...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/budgets/update-budget-action.html
if __name__ == '__main__':
    ...
    write_three_parameter("budgets", "update-budget-action", "account-id", "budget-name", "action-id", add_option_dict)
