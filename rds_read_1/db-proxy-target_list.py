...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/rds/describe-db-proxy-targets.html
if __name__ == '__main__':
    ...
    # db-proxy-name : The identifier of the DBProxyTarget to describe.
    """
    ...
    execute_one_parameter("rds", "describe-db-proxy-targets", "db-proxy-name", add_option_dict)