...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ram/list-resources.html
...
OTHER-ACCOUNTS
    ...
    execute_one_parameter("ram", "list-resources", "resource-owner", add_option_dict)