...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/cognito-identity/describe-identity.html
if __name__ == '__main__':
    ...
    execute_one_parameter("cognito-identity", "describe-identity", "identity-id", add_option_dict)