...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/databrew/list-recipes.html
if __name__ == '__main__':
    ...
    read_no_parameter("databrew", "list-recipes", add_option_dict)