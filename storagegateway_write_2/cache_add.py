...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/storagegateway/add-cache.html
...
(string)
    ...
    write_two_parameter("storagegateway", "add-cache", "gateway-arn", "disk-ids", add_option_dict)
