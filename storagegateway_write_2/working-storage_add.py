...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/storagegateway/add-working-storage.html
...
(string)
    ...
    write_two_parameter("storagegateway", "add-working-storage", "gateway-arn", "disk-ids", add_option_dict)
