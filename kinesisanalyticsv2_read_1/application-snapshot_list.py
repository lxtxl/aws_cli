...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/kinesisanalyticsv2/list-application-snapshots.html
if __name__ == '__main__':
    ...
    execute_one_parameter("kinesisanalyticsv2", "list-application-snapshots", "application-name", add_option_dict)