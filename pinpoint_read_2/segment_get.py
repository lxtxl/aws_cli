...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/pinpoint/get-segment.html
if __name__ == '__main__':
    ...
    execute_two_parameter("pinpoint", "get-segment", "application-id", "segment-id", parameter_display_string)