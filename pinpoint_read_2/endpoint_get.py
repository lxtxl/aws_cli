...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/pinpoint/get-endpoint.html
if __name__ == '__main__':
    ...
    execute_two_parameter("pinpoint", "get-endpoint", "application-id", "endpoint-id", parameter_display_string)