...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/workspaces/disassociate-connection-alias.html
if __name__ == '__main__':
    ...
    # alias-id : The identifier of the connection alias to disassociate.
    """
    add_option_dict = {}
    ...
    write_one_parameter("workspaces", "disassociate-connection-alias", "alias-id", add_option_dict)
