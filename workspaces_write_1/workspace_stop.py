...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/workspaces/stop-workspaces.html
if __name__ == '__main__':
    ...
    # stop-workspace-requests : The WorkSpaces to stop. You can specify up to 25 WorkSpaces.
(structure)
...
The identifier of the WorkSpace.
    ...
    write_one_parameter("workspaces", "stop-workspaces", "stop-workspace-requests", add_option_dict)
