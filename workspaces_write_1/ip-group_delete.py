...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/workspaces/delete-ip-group.html
if __name__ == '__main__':
    ...
    # group-id : The identifier of the IP access control group.
    """
    add_option_dict = {}
    ...
    write_one_parameter("workspaces", "delete-ip-group", "group-id", add_option_dict)
