...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/workspaces/terminate-workspaces.html
if __name__ == '__main__':
    ...
    # terminate-workspace-requests : The WorkSpaces to terminate. You can specify up to 25 WorkSpaces.
(structure)
...
The identifier of the WorkSpace.
    ...
    write_one_parameter("workspaces", "terminate-workspaces", "terminate-workspace-requests", add_option_dict)
