...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/kms/describe-custom-key-stores.html
if __name__ == '__main__':
    ...
    read_no_parameter("kms", "describe-custom-key-stores", add_option_dict)