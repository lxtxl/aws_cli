...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iam/reset-service-specific-credential.html
...
This parameter allows (through its regex pattern ) a string of characters that can consist of any upper or lowercased letter or digit.
    ...
    write_one_parameter("iam", "reset-service-specific-credential", "service-specific-credential-id", add_option_dict)
