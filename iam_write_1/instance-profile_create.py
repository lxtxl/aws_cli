...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iam/create-instance-profile.html
if __name__ == '__main__':
    ...
    # instance-profile-name : The name of the instance profile to create.
This parameter allows (through its regex pattern ) a string of characters consisting of upper and lowercase alphanumeric characters with no spaces. You can also include any of the following characters: _+=,.@-
    ...
    write_one_parameter("iam", "create-instance-profile", "instance-profile-name", add_option_dict)
