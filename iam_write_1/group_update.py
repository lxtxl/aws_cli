...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iam/update-group.html
if __name__ == '__main__':
    ...
    # group-name : Name of the IAM group to update. If youâre changing the name of the group, this is the original name.
This parameter allows (through its regex pattern ) a string of characters consisting of upper and lowercase alphanumeric characters with no spaces. You can also include any of the following characters: _+=,.@-
    ...
    write_one_parameter("iam", "update-group", "group-name", add_option_dict)
