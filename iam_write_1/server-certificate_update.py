...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iam/update-server-certificate.html
if __name__ == '__main__':
    ...
    # server-certificate-name : The name of the server certificate that you want to update.
This parameter allows (through its regex pattern ) a string of characters consisting of upper and lowercase alphanumeric characters with no spaces. You can also include any of the following characters: _+=,.@-
    ...
    write_one_parameter("iam", "update-server-certificate", "server-certificate-name", add_option_dict)
