...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iam/update-user.html
if __name__ == '__main__':
    ...
    # user-name : Name of the user to update. If youâre changing the name of the user, this is the original user name.
This parameter allows (through its regex pattern ) a string of characters consisting of upper and lowercase alphanumeric characters with no spaces. You can also include any of the following characters: _+=,.@-
    ...
    write_one_parameter("iam", "update-user", "user-name", add_option_dict)
