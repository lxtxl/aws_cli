...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/imagebuilder/get-image-recipe.html
if __name__ == '__main__':
    ...
    # image-recipe-arn : The Amazon Resource Name (ARN) of the image recipe that you want to retrieve.
    """
    ...
    execute_one_parameter("imagebuilder", "get-image-recipe", "image-recipe-arn", add_option_dict)