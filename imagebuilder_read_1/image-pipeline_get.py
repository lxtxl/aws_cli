...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/imagebuilder/get-image-pipeline.html
if __name__ == '__main__':
    ...
    # image-pipeline-arn : The Amazon Resource Name (ARN) of the image pipeline that you want to retrieve.
    """
    ...
    execute_one_parameter("imagebuilder", "get-image-pipeline", "image-pipeline-arn", add_option_dict)