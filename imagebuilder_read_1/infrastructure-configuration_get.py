...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/imagebuilder/get-infrastructure-configuration.html
if __name__ == '__main__':
    ...
    # infrastructure-configuration-arn : The Amazon Resource Name (ARN) of the infrastructure configuration that you want to retrieve.
    """
    ...
    execute_one_parameter("imagebuilder", "get-infrastructure-configuration", "infrastructure-configuration-arn", add_option_dict)