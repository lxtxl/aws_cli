...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/polly/get-speech-synthesis-task.html
if __name__ == '__main__':
    ...
    # task-id : The Amazon Polly generated identifier for a speech synthesis task.
    """
    ...
    execute_one_parameter("polly", "get-speech-synthesis-task", "task-id", add_option_dict)