...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/polly/get-lexicon.html
if __name__ == '__main__':
    ...
    execute_one_parameter("polly", "get-lexicon", "name", add_option_dict)