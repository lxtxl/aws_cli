...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/autoscaling/delete-launch-configuration.html
if __name__ == '__main__':
    ...
    # launch-configuration-name : The name of the launch configuration.
    """
    add_option_dict = {}
    ...
    write_one_parameter("autoscaling", "delete-launch-configuration", "launch-configuration-name", add_option_dict)
