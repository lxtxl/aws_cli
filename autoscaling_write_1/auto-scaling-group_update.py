...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/autoscaling/update-auto-scaling-group.html
if __name__ == '__main__':
    ...
    write_one_parameter("autoscaling", "update-auto-scaling-group", "auto-scaling-group-name", add_option_dict)
