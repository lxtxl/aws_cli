...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/transcribe/list-vocabularies.html
if __name__ == '__main__':
    ...
    read_no_parameter("transcribe", "list-vocabularies", add_option_dict)