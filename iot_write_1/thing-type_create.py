...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iot/create-thing-type.html
if __name__ == '__main__':
    ...
    write_one_parameter("iot", "create-thing-type", "thing-type-name", add_option_dict)
