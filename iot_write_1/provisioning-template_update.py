...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iot/update-provisioning-template.html
if __name__ == '__main__':
    ...
    write_one_parameter("iot", "update-provisioning-template", "template-name", add_option_dict)
