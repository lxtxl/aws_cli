...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iot/delete-thing.html
if __name__ == '__main__':
    ...
    # thing-name : The name of the thing to delete.
    """
    add_option_dict = {}
    ...
    write_one_parameter("iot", "delete-thing", "thing-name", add_option_dict)
