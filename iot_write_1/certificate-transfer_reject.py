...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iot/reject-certificate-transfer.html
if __name__ == '__main__':
    ...
    write_one_parameter("iot", "reject-certificate-transfer", "certificate-id", add_option_dict)
