...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iot/delete-mitigation-action.html
if __name__ == '__main__':
    ...
    # action-name : The name of the mitigation action that you want to delete.
    """
    add_option_dict = {}
    ...
    write_one_parameter("iot", "delete-mitigation-action", "action-name", add_option_dict)
