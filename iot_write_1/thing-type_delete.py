...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iot/delete-thing-type.html
if __name__ == '__main__':
    ...
    write_one_parameter("iot", "delete-thing-type", "thing-type-name", add_option_dict)
