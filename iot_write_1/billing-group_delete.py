...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iot/delete-billing-group.html
if __name__ == '__main__':
    ...
    write_one_parameter("iot", "delete-billing-group", "billing-group-name", add_option_dict)
