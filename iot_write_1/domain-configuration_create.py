...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iot/create-domain-configuration.html
if __name__ == '__main__':
    ...
    # domain-configuration-name : The name of the domain configuration. This value must be unique to a region.
    """
    add_option_dict = {}
    ...
    write_one_parameter("iot", "create-domain-configuration", "domain-configuration-name", add_option_dict)
