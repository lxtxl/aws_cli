...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iot/create-security-profile.html
if __name__ == '__main__':
    ...
    # security-profile-name : The name you are giving to the security profile.
    """
    add_option_dict = {}
    ...
    write_one_parameter("iot", "create-security-profile", "security-profile-name", add_option_dict)
