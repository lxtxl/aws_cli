...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iot/update-domain-configuration.html
if __name__ == '__main__':
    ...
    # domain-configuration-name : The name of the domain configuration to be updated.
    """
    add_option_dict = {}
    ...
    write_one_parameter("iot", "update-domain-configuration", "domain-configuration-name", add_option_dict)
