...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iot/delete-topic-rule.html
if __name__ == '__main__':
    ...
    write_one_parameter("iot", "delete-topic-rule", "rule-name", add_option_dict)
