...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iot/delete-security-profile.html
if __name__ == '__main__':
    ...
    # security-profile-name : The name of the security profile to be deleted.
    """
    add_option_dict = {}
    ...
    write_one_parameter("iot", "delete-security-profile", "security-profile-name", add_option_dict)
