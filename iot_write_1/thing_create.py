...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iot/create-thing.html
if __name__ == '__main__':
    ...
    # thing-name : The name of the thing to create.
You canât change a thingâs name after you create it. To change a thingâs name, you must create a new thing, give it the new name, and then delete the old thing.
    ...
    write_one_parameter("iot", "create-thing", "thing-name", add_option_dict)
