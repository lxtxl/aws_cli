...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iot/confirm-topic-rule-destination.html
if __name__ == '__main__':
    ...
    # confirmation-token : The token used to confirm ownership or access to the topic rule confirmation URL.
    """
    add_option_dict = {}
    ...
    write_one_parameter("iot", "confirm-topic-rule-destination", "confirmation-token", add_option_dict)
