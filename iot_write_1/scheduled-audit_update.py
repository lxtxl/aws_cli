...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iot/update-scheduled-audit.html
if __name__ == '__main__':
    ...
    # scheduled-audit-name : The name of the scheduled audit. (Max. 128 chars)
    """
    add_option_dict = {}
    ...
    write_one_parameter("iot", "update-scheduled-audit", "scheduled-audit-name", add_option_dict)
