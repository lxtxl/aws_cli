...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/apigatewayv2/get-authorizers.html
if __name__ == '__main__':
    ...
    execute_one_parameter("apigatewayv2", "get-authorizers", "api-id", add_option_dict)