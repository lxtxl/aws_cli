...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/apigatewayv2/get-domain-name.html
if __name__ == '__main__':
    ...
    execute_one_parameter("apigatewayv2", "get-domain-name", "domain-name", add_option_dict)