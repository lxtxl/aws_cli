...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/mediapackage/describe-origin-endpoint.html
if __name__ == '__main__':
    ...
    execute_one_parameter("mediapackage", "describe-origin-endpoint", "id", add_option_dict)