...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/mediapackage/describe-harvest-job.html
if __name__ == '__main__':
    ...
    execute_one_parameter("mediapackage", "describe-harvest-job", "id", add_option_dict)