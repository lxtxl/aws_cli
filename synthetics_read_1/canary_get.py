...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/synthetics/get-canary.html
if __name__ == '__main__':
    ...
    execute_one_parameter("synthetics", "get-canary", "name", add_option_dict)