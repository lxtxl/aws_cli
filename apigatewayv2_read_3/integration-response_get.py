...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/apigatewayv2/get-integration-response.html
if __name__ == '__main__':
    ...
    execute_two_parameter("apigatewayv2", "get-integration-response", "api-id", "integration-id", parameter_display_string)