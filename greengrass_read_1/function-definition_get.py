...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/greengrass/get-function-definition.html
if __name__ == '__main__':
    ...
    execute_one_parameter("greengrass", "get-function-definition", "function-definition-id", add_option_dict)