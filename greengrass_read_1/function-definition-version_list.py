...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/greengrass/list-function-definition-versions.html
if __name__ == '__main__':
    ...
    execute_one_parameter("greengrass", "list-function-definition-versions", "function-definition-id", add_option_dict)