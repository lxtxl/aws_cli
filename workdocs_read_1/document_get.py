...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/workdocs/get-document.html
if __name__ == '__main__':
    ...
    execute_one_parameter("workdocs", "get-document", "document-id", add_option_dict)