...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/workdocs/describe-document-versions.html
if __name__ == '__main__':
    ...
    execute_one_parameter("workdocs", "describe-document-versions", "document-id", add_option_dict)