...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/workdocs/describe-resource-permissions.html
if __name__ == '__main__':
    ...
    execute_one_parameter("workdocs", "describe-resource-permissions", "resource-id", add_option_dict)