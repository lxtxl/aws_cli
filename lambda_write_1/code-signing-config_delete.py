...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/lambda/delete-code-signing-config.html
if __name__ == '__main__':
    ...
    write_one_parameter("lambda", "delete-code-signing-config", "code-signing-config-arn", add_option_dict)
