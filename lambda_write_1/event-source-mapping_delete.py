...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/lambda/delete-event-source-mapping.html
if __name__ == '__main__':
    ...
    write_one_parameter("lambda", "delete-event-source-mapping", "uuid", add_option_dict)
