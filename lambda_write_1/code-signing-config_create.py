...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/lambda/create-code-signing-config.html
if __name__ == '__main__':
    ...
    write_one_parameter("lambda", "create-code-signing-config", "allowed-publishers", add_option_dict)
