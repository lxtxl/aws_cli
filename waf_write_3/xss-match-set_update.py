...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/waf/update-xss-match-set.html
...
Specify NONE if you donât want to perform any text transformations.
    ...
    write_three_parameter("waf", "update-xss-match-set", "xss-match-set-id", "change-token", "updates", add_option_dict)
