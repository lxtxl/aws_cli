...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/waf/update-rule.html
...
A unique identifier for a predicate in a Rule , such as ByteMatchSetId or IPSetId . The ID is returned by the corresponding Create or List command.
    ...
    write_three_parameter("waf", "update-rule", "rule-id", "change-token", "updates", add_option_dict)
