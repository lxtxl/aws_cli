...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/waf/update-size-constraint-set.html
...
If you specify URI for the value of Type , the / in the URI counts as one character. For example, the URI /logo.jpg is nine characters long.
    ...
    write_three_parameter("waf", "update-size-constraint-set", "size-constraint-set-id", "change-token", "updates", add_option_dict)
