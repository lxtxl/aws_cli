...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/dax/describe-clusters.html
if __name__ == '__main__':
    ...
    read_no_parameter("dax", "describe-clusters", add_option_dict)