...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/snowball/describe-job.html
if __name__ == '__main__':
    ...
    # job-id : The automatically generated ID for a job, for example JID123e4567-e89b-12d3-a456-426655440000 .
    """
    ...
    execute_one_parameter("snowball", "describe-job", "job-id", add_option_dict)