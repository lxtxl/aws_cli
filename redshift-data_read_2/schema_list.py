...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/redshift-data/list-schemas.html
if __name__ == '__main__':
    ...
    execute_two_parameter("redshift-data", "list-schemas", "cluster-identifier", "database", parameter_display_string)