...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sms/get-app-replication-configuration.html
if __name__ == '__main__':
    ...
    read_no_parameter("sms", "get-app-replication-configuration", add_option_dict)