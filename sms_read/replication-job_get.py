...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sms/get-replication-jobs.html
if __name__ == '__main__':
    ...
    read_no_parameter("sms", "get-replication-jobs", add_option_dict)