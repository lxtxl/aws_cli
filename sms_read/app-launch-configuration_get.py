...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sms/get-app-launch-configuration.html
if __name__ == '__main__':
    ...
    read_no_parameter("sms", "get-app-launch-configuration", add_option_dict)