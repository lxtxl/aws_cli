...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/s3api/delete-bucket-analytics-configuration.html
if __name__ == '__main__':
    ...
    write_two_parameter("s3api", "delete-bucket-analytics-configuration", "bucket", "id", add_option_dict)
