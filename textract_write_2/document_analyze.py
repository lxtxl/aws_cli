...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/textract/analyze-document.html
...
(string)
    ...
    write_two_parameter("textract", "analyze-document", "document", "feature-types", add_option_dict)
