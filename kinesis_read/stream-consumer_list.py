...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/kinesis/describe-stream-consumer.html
if __name__ == '__main__':
    ...
    read_no_parameter("kinesis", "describe-stream-consumer", add_option_dict)