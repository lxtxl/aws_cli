...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/servicediscovery/list-services.html
if __name__ == '__main__':
    ...
    read_no_parameter("servicediscovery", "list-services", add_option_dict)