...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/mturk/list-qualification-requests.html
if __name__ == '__main__':
    ...
    read_no_parameter("mturk", "list-qualification-requests", add_option_dict)