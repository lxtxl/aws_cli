...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ecr-public/delete-repository.html
if __name__ == '__main__':
    ...
    write_one_parameter("ecr-public", "delete-repository", "repository-name", add_option_dict)
