...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/synthetics/stop-canary.html
if __name__ == '__main__':
    ...
    write_one_parameter("synthetics", "stop-canary", "name", add_option_dict)
