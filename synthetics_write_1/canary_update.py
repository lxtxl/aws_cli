...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/synthetics/update-canary.html
...
You cannot change the name of a canary that has already been created.
    ...
    write_one_parameter("synthetics", "update-canary", "name", add_option_dict)
