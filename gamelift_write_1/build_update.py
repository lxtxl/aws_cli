...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/gamelift/update-build.html
if __name__ == '__main__':
    ...
    # build-id : A unique identifier for a build to update. You can use either the build ID or ARN value.
    """
    add_option_dict = {}
    ...
    write_one_parameter("gamelift", "update-build", "build-id", add_option_dict)
