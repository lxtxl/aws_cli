...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/gamelift/delete-game-server-group.html
if __name__ == '__main__':
    ...
    write_one_parameter("gamelift", "delete-game-server-group", "game-server-group-name", add_option_dict)
