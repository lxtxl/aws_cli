...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/gamelift/update-game-session-queue.html
if __name__ == '__main__':
    ...
    write_one_parameter("gamelift", "update-game-session-queue", "name", add_option_dict)
