...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/gamelift/stop-game-session-placement.html
if __name__ == '__main__':
    ...
    # placement-id : A unique identifier for a game session placement to cancel.
    """
    add_option_dict = {}
    ...
    write_one_parameter("gamelift", "stop-game-session-placement", "placement-id", add_option_dict)
