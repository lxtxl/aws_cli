...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/gamelift/update-script.html
if __name__ == '__main__':
    ...
    # script-id : A unique identifier for a Realtime script to update. You can use either the script ID or ARN value.
    """
    add_option_dict = {}
    ...
    write_one_parameter("gamelift", "update-script", "script-id", add_option_dict)
