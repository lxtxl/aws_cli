...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/gamelift/delete-alias.html
if __name__ == '__main__':
    ...
    # alias-id : A unique identifier of the alias that you want to delete. You can use either the alias ID or ARN value.
    """
    add_option_dict = {}
    ...
    write_one_parameter("gamelift", "delete-alias", "alias-id", add_option_dict)
