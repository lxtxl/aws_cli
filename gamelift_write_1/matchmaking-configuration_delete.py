...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/gamelift/delete-matchmaking-configuration.html
if __name__ == '__main__':
    ...
    write_one_parameter("gamelift", "delete-matchmaking-configuration", "name", add_option_dict)
