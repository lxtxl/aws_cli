...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/mediapackage-vod/tag-resource.html
if __name__ == '__main__':
    ...
    write_two_parameter("mediapackage-vod", "tag-resource", "resource-arn", "tags", add_option_dict)
