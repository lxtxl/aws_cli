...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/dms/modify-replication-subnet-group.html
if __name__ == '__main__':
    ...
    # replication-subnet-group-identifier : The name of the replication instance subnet group.
    # subnet-ids : A list of subnet IDs.
(string)
    """
    add_option_dict = {}
    add_option_dict["parameter_display_string"] = parameter_display_string
    # ex: add_option_dict["no_value_parameter_list"] = "--single-parameter"
    write_two_parameter("dms", "modify-replication-subnet-group", "replication-subnet-group-identifier", "subnet-ids", add_option_dict)
