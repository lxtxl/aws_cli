...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/codestar-notifications/list-notification-rules.html
if __name__ == '__main__':
    ...
    read_no_parameter("codestar-notifications", "list-notification-rules", add_option_dict)