...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/appsync/list-functions.html
if __name__ == '__main__':
    ...
    execute_one_parameter("appsync", "list-functions", "api-id", add_option_dict)