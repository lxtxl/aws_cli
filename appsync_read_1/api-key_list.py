...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/appsync/list-api-keys.html
if __name__ == '__main__':
    ...
    execute_one_parameter("appsync", "list-api-keys", "api-id", add_option_dict)