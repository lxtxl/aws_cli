...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/amplifybackend/clone-backend.html
if __name__ == '__main__':
    ...
    # target-environment-name : The name of the destination backend environment to be created.
    """
    add_option_dict = {}
    add_option_dict["parameter_display_string"] = parameter_display_string
    # ex: add_option_dict["no_value_parameter_list"] = "--single-parameter"
    write_three_parameter("amplifybackend", "clone-backend", "app-id", "backend-environment-name", "target-environment-name", add_option_dict)
