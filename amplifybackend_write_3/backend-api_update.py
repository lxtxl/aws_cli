...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/amplifybackend/update-backend-api.html
if __name__ == '__main__':
    ...
    write_three_parameter("amplifybackend", "update-backend-api", "app-id", "backend-environment-name", "resource-name", add_option_dict)
