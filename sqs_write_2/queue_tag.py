...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sqs/tag-queue.html
...
Value -> (string)
    ...
    write_two_parameter("sqs", "tag-queue", "queue-url", "tags", add_option_dict)
