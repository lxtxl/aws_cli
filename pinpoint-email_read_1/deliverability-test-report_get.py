...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/pinpoint-email/get-deliverability-test-report.html
if __name__ == '__main__':
    ...
    execute_one_parameter("pinpoint-email", "get-deliverability-test-report", "report-id", add_option_dict)