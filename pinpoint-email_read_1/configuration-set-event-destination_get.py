...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/pinpoint-email/get-configuration-set-event-destinations.html
if __name__ == '__main__':
    ...
    execute_one_parameter("pinpoint-email", "get-configuration-set-event-destinations", "configuration-set-name", add_option_dict)