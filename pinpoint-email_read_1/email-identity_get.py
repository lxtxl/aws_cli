...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/pinpoint-email/get-email-identity.html
if __name__ == '__main__':
    ...
    # email-identity : The email identity that you want to retrieve details for.
    """
    ...
    execute_one_parameter("pinpoint-email", "get-email-identity", "email-identity", add_option_dict)