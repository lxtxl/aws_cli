...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/workmail/delete-resource.html
if __name__ == '__main__':
    ...
    # organization-id : The identifier associated with the organization from which the resource is deleted.
    # resource-id : The identifier of the resource to be deleted.
    """
    add_option_dict = {}
    add_option_dict["parameter_display_string"] = parameter_display_string
    # ex: add_option_dict["no_value_parameter_list"] = "--single-parameter"
    write_two_parameter("workmail", "delete-resource", "organization-id", "resource-id", add_option_dict)
