...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/imagebuilder/update-distribution-configuration.html
if __name__ == '__main__':
    ...
    # distribution-configuration-arn : The Amazon Resource Name (ARN) of the distribution configuration that you want to update.
...
(string)
    ...
    write_two_parameter("imagebuilder", "update-distribution-configuration", "distribution-configuration-arn", "distributions", add_option_dict)
