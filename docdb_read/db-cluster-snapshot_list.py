...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/docdb/describe-db-cluster-snapshots.html
if __name__ == '__main__':
    ...
    read_no_parameter("docdb", "describe-db-cluster-snapshots", add_option_dict)