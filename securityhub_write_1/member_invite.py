...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/securityhub/invite-members.html
if __name__ == '__main__':
    ...
    # account-ids : The list of account IDs of the AWS accounts to invite to Security Hub as members.
(string)
    """
    add_option_dict = {}
    ...
    write_one_parameter("securityhub", "invite-members", "account-ids", add_option_dict)
