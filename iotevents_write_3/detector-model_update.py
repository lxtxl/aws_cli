...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iotevents/update-detector-model.html
if __name__ == '__main__':
    ...
    # detector-model-name : The name of the detector model that is updated.
    ...
    write_three_parameter("iotevents", "update-detector-model", "detector-model-name", "detector-model-definition", "role-arn", add_option_dict)
