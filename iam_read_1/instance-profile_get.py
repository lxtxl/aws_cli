...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iam/get-instance-profile.html
if __name__ == '__main__':
    ...
    # instance-profile-name : The name of the instance profile to get information about.
This parameter allows (through its regex pattern ) a string of characters consisting of upper and lowercase alphanumeric characters with no spaces. You can also include any of the following characters: _+=,.@-
    ...
    execute_one_parameter("iam", "get-instance-profile", "instance-profile-name", add_option_dict)