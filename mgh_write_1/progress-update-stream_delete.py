...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/mgh/delete-progress-update-stream.html
if __name__ == '__main__':
    ...
    write_one_parameter("mgh", "delete-progress-update-stream", "progress-update-stream-name", add_option_dict)
