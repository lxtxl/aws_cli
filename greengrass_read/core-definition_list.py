...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/greengrass/list-core-definitions.html
if __name__ == '__main__':
    ...
    read_no_parameter("greengrass", "list-core-definitions", add_option_dict)