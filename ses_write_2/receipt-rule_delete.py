...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ses/delete-receipt-rule.html
if __name__ == '__main__':
    ...
    # rule-set-name : The name of the receipt rule set that contains the receipt rule to delete.
    # rule-name : The name of the receipt rule to delete.
    """
    add_option_dict = {}
    add_option_dict["parameter_display_string"] = parameter_display_string
    # ex: add_option_dict["no_value_parameter_list"] = "--single-parameter"
    write_two_parameter("ses", "delete-receipt-rule", "rule-set-name", "rule-name", add_option_dict)
