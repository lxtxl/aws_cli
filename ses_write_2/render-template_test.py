...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ses/test-render-template.html
if __name__ == '__main__':
    ...
    write_two_parameter("ses", "test-render-template", "template-name", "template-data", add_option_dict)
