...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/mediaconvert/list-job-templates.html
if __name__ == '__main__':
    ...
    read_no_parameter("mediaconvert", "list-job-templates", add_option_dict)