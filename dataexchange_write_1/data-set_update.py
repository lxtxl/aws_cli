...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/dataexchange/update-data-set.html
if __name__ == '__main__':
    ...
    write_one_parameter("dataexchange", "update-data-set", "data-set-id", add_option_dict)
