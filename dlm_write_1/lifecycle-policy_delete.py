...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/dlm/delete-lifecycle-policy.html
if __name__ == '__main__':
    ...
    write_one_parameter("dlm", "delete-lifecycle-policy", "policy-id", add_option_dict)
