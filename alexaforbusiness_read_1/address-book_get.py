...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/alexaforbusiness/get-address-book.html
if __name__ == '__main__':
    ...
    # address-book-arn : The ARN of the address book for which to request details.
    """
    ...
    execute_one_parameter("alexaforbusiness", "get-address-book", "address-book-arn", add_option_dict)