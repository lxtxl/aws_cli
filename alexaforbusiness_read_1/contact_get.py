...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/alexaforbusiness/get-contact.html
if __name__ == '__main__':
    ...
    # contact-arn : The ARN of the contact for which to request details.
    """
    ...
    execute_one_parameter("alexaforbusiness", "get-contact", "contact-arn", add_option_dict)