...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/clouddirectory/attach-policy.html
if __name__ == '__main__':
    ...
    write_three_parameter("clouddirectory", "attach-policy", "directory-arn", "policy-reference", "object-reference", add_option_dict)
