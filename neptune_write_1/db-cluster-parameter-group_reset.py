...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/neptune/reset-db-cluster-parameter-group.html
if __name__ == '__main__':
    ...
    # db-cluster-parameter-group-name : The name of the DB cluster parameter group to reset.
    """
    add_option_dict = {}
    ...
    write_one_parameter("neptune", "reset-db-cluster-parameter-group", "db-cluster-parameter-group-name", add_option_dict)
