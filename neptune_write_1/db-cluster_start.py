...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/neptune/start-db-cluster.html
if __name__ == '__main__':
    ...
    # db-cluster-identifier : The DB cluster identifier of the Neptune DB cluster to be started. This parameter is stored as a lowercase string.
    """
    add_option_dict = {}
    ...
    write_one_parameter("neptune", "start-db-cluster", "db-cluster-identifier", add_option_dict)
