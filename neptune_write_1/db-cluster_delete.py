...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/neptune/delete-db-cluster.html
if __name__ == '__main__':
    ...
    # db-cluster-identifier : The DB cluster identifier for the DB cluster to be deleted. This parameter isnât case-sensitive.
Constraints:
...
Must match an existing DBClusterIdentifier.
    ...
    write_one_parameter("neptune", "delete-db-cluster", "db-cluster-identifier", add_option_dict)
