...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/neptune/delete-db-cluster-endpoint.html
if __name__ == '__main__':
    ...
    # db-cluster-endpoint-identifier : The identifier associated with the custom endpoint. This parameter is stored as a lowercase string.
    """
    add_option_dict = {}
    ...
    write_one_parameter("neptune", "delete-db-cluster-endpoint", "db-cluster-endpoint-identifier", add_option_dict)
