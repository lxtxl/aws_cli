...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/neptune/modify-event-subscription.html
if __name__ == '__main__':
    ...
    # subscription-name : The name of the event notification subscription.
    """
    add_option_dict = {}
    ...
    write_one_parameter("neptune", "modify-event-subscription", "subscription-name", add_option_dict)
