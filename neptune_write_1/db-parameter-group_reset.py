...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/neptune/reset-db-parameter-group.html
...
Must match the name of an existing DBParameterGroup.
    ...
    write_one_parameter("neptune", "reset-db-parameter-group", "db-parameter-group-name", add_option_dict)
