...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/neptune/modify-db-cluster-endpoint.html
if __name__ == '__main__':
    ...
    write_one_parameter("neptune", "modify-db-cluster-endpoint", "db-cluster-endpoint-identifier", add_option_dict)
