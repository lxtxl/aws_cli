...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/neptune/delete-db-subnet-group.html
...
Example: mySubnetgroup
    ...
    write_one_parameter("neptune", "delete-db-subnet-group", "db-subnet-group-name", add_option_dict)
