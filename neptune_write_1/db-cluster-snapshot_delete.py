...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/neptune/delete-db-cluster-snapshot.html
if __name__ == '__main__':
    ...
    # db-cluster-snapshot-identifier : The identifier of the DB cluster snapshot to delete.
Constraints: Must be the name of an existing DB cluster snapshot in the available state.
    ...
    write_one_parameter("neptune", "delete-db-cluster-snapshot", "db-cluster-snapshot-identifier", add_option_dict)
