...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/kinesisanalytics/stop-application.html
if __name__ == '__main__':
    ...
    # application-name : Name of the running application to stop.
    """
    add_option_dict = {}
    ...
    write_one_parameter("kinesisanalytics", "stop-application", "application-name", add_option_dict)
