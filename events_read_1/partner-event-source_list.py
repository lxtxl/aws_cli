...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/events/describe-partner-event-source.html
if __name__ == '__main__':
    ...
    execute_one_parameter("events", "describe-partner-event-source", "name", add_option_dict)