...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sagemaker-a2i-runtime/describe-human-loop.html
if __name__ == '__main__':
    ...
    # human-loop-name : The name of the human loop that you want information about.
    """
    ...
    execute_one_parameter("sagemaker-a2i-runtime", "describe-human-loop", "human-loop-name", add_option_dict)