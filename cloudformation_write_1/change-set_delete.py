...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/cloudformation/delete-change-set.html
if __name__ == '__main__':
    ...
    # change-set-name : The name or Amazon Resource Name (ARN) of the change set that you want to delete.
    """
    add_option_dict = {}
    ...
    write_one_parameter("cloudformation", "delete-change-set", "change-set-name", add_option_dict)
