...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/cloudformation/update-stack-set.html
if __name__ == '__main__':
    ...
    # stack-set-name : The name or unique ID of the stack set that you want to update.
    """
    add_option_dict = {}
    ...
    write_one_parameter("cloudformation", "update-stack-set", "stack-set-name", add_option_dict)
