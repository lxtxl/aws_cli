...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/waf-regional/get-rule-group.html
if __name__ == '__main__':
    ...
    execute_one_parameter("waf-regional", "get-rule-group", "rule-group-id", add_option_dict)