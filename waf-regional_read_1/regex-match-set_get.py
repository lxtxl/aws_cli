...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/waf-regional/get-regex-match-set.html
if __name__ == '__main__':
    ...
    execute_one_parameter("waf-regional", "get-regex-match-set", "regex-match-set-id", add_option_dict)