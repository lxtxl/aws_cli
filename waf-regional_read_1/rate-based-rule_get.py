...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/waf-regional/get-rate-based-rule.html
if __name__ == '__main__':
    ...
    execute_one_parameter("waf-regional", "get-rate-based-rule", "rule-id", add_option_dict)