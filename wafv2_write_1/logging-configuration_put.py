...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/wafv2/put-logging-configuration.html
if __name__ == '__main__':
    ...
    write_one_parameter("wafv2", "put-logging-configuration", "logging-configuration", add_option_dict)
