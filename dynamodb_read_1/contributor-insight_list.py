...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/dynamodb/describe-contributor-insights.html
if __name__ == '__main__':
    ...
    execute_one_parameter("dynamodb", "describe-contributor-insights", "table-name", add_option_dict)