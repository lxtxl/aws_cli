...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/dynamodb/describe-table.html
if __name__ == '__main__':
    ...
    execute_one_parameter("dynamodb", "describe-table", "table-name", add_option_dict)