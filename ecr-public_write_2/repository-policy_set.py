...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ecr-public/set-repository-policy.html
if __name__ == '__main__':
    ...
    write_two_parameter("ecr-public", "set-repository-policy", "repository-name", "policy-text", add_option_dict)
