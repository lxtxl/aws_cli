...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/mediapackage/list-origin-endpoints.html
if __name__ == '__main__':
    ...
    read_no_parameter("mediapackage", "list-origin-endpoints", add_option_dict)