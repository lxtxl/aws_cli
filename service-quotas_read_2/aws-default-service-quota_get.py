...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/service-quotas/get-aws-default-service-quota.html
if __name__ == '__main__':
    ...
    execute_two_parameter("service-quotas", "get-aws-default-service-quota", "service-code", "quota-code", parameter_display_string)