...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/elasticache/modify-cache-cluster.html
if __name__ == '__main__':
    ...
    # cache-cluster-id : The cluster identifier. This value is stored as a lowercase string.
    """
    add_option_dict = {}
    ...
    write_one_parameter("elasticache", "modify-cache-cluster", "cache-cluster-id", add_option_dict)
