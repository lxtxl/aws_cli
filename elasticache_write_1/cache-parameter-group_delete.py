...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/elasticache/delete-cache-parameter-group.html
if __name__ == '__main__':
    ...
    # cache-parameter-group-name : The name of the cache parameter group to delete.
...
The specified cache security group must not be associated with any clusters.
    ...
    write_one_parameter("elasticache", "delete-cache-parameter-group", "cache-parameter-group-name", add_option_dict)
