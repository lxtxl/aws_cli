...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/elasticache/modify-user-group.html
if __name__ == '__main__':
    ...
    write_one_parameter("elasticache", "modify-user-group", "user-group-id", add_option_dict)
