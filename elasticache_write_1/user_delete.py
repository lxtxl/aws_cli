...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/elasticache/delete-user.html
if __name__ == '__main__':
    ...
    write_one_parameter("elasticache", "delete-user", "user-id", add_option_dict)
