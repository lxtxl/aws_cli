...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sso-admin/delete-instance-access-control-attribute-configuration.html
if __name__ == '__main__':
    ...
    write_one_parameter("sso-admin", "delete-instance-access-control-attribute-configuration", "instance-arn", add_option_dict)
