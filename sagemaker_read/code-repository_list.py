...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sagemaker/list-code-repositories.html
if __name__ == '__main__':
    ...
    read_no_parameter("sagemaker", "list-code-repositories", add_option_dict)