...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sagemaker/list-app-image-configs.html
if __name__ == '__main__':
    ...
    read_no_parameter("sagemaker", "list-app-image-configs", add_option_dict)