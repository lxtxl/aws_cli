...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sagemaker/list-algorithms.html
if __name__ == '__main__':
    ...
    read_no_parameter("sagemaker", "list-algorithms", add_option_dict)