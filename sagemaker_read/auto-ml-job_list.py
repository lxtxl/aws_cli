...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sagemaker/list-auto-ml-jobs.html
if __name__ == '__main__':
    ...
    read_no_parameter("sagemaker", "list-auto-ml-jobs", add_option_dict)