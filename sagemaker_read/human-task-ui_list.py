...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sagemaker/list-human-task-uis.html
if __name__ == '__main__':
    ...
    read_no_parameter("sagemaker", "list-human-task-uis", add_option_dict)