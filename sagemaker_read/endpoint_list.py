...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sagemaker/list-endpoints.html
if __name__ == '__main__':
    ...
    read_no_parameter("sagemaker", "list-endpoints", add_option_dict)