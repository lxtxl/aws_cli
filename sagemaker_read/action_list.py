...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sagemaker/list-actions.html
if __name__ == '__main__':
    ...
    read_no_parameter("sagemaker", "list-actions", add_option_dict)