...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/pinpoint-email/create-configuration-set-event-destination.html
if __name__ == '__main__':
    ...
    write_three_parameter("pinpoint-email", "create-configuration-set-event-destination", "configuration-set-name", "event-destination-name", "event-destination", add_option_dict)
