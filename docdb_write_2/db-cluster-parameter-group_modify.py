...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/docdb/modify-db-cluster-parameter-group.html
if __name__ == '__main__':
    ...
    # db-cluster-parameter-group-name : The name of the cluster parameter group to modify.
...
Indicates when to apply parameter updates.
    ...
    write_two_parameter("docdb", "modify-db-cluster-parameter-group", "db-cluster-parameter-group-name", "parameters", add_option_dict)
