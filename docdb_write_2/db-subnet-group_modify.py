...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/docdb/modify-db-subnet-group.html
if __name__ == '__main__':
    ...
    # db-subnet-group-name : The name for the subnet group. This value is stored as a lowercase string. You canât modify the default subnet group.
...
(string)
    ...
    write_two_parameter("docdb", "modify-db-subnet-group", "db-subnet-group-name", "subnet-ids", add_option_dict)
