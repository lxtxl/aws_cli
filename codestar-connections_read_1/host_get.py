...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/codestar-connections/get-host.html
if __name__ == '__main__':
    ...
    # host-arn : The Amazon Resource Name (ARN) of the requested host.
    """
    ...
    execute_one_parameter("codestar-connections", "get-host", "host-arn", add_option_dict)