...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/mwaa/get-environment.html
if __name__ == '__main__':
    ...
    execute_one_parameter("mwaa", "get-environment", "name", add_option_dict)