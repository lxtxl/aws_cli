...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iotsitewise/describe-portal.html
if __name__ == '__main__':
    ...
    # portal-id : The ID of the portal.
    """
    ...
    execute_one_parameter("iotsitewise", "describe-portal", "portal-id", add_option_dict)