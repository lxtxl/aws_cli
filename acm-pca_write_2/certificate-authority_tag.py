...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/acm-pca/tag-certificate-authority.html
...
Value of the tag.
    ...
    write_two_parameter("acm-pca", "tag-certificate-authority", "certificate-authority-arn", "tags", add_option_dict)
