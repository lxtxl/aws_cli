...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/pinpoint/update-journey.html
if __name__ == '__main__':
    ...
    write_three_parameter("pinpoint", "update-journey", "application-id", "journey-id", "write-journey-request", add_option_dict)
