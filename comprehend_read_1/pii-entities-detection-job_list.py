...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/comprehend/describe-pii-entities-detection-job.html
if __name__ == '__main__':
    ...
    execute_one_parameter("comprehend", "describe-pii-entities-detection-job", "job-id", add_option_dict)