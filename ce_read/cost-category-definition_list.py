...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ce/list-cost-category-definitions.html
if __name__ == '__main__':
    ...
    read_no_parameter("ce", "list-cost-category-definitions", add_option_dict)