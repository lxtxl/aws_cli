...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/configservice/describe-organization-conformance-packs.html
if __name__ == '__main__':
    ...
    read_no_parameter("configservice", "describe-organization-conformance-packs", add_option_dict)