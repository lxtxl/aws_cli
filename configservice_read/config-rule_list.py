...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/configservice/describe-config-rules.html
if __name__ == '__main__':
    ...
    read_no_parameter("configservice", "describe-config-rules", add_option_dict)