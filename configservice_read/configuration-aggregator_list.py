...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/configservice/describe-configuration-aggregators.html
if __name__ == '__main__':
    ...
    read_no_parameter("configservice", "describe-configuration-aggregators", add_option_dict)