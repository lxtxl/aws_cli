...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/configservice/describe-retention-configurations.html
if __name__ == '__main__':
    ...
    read_no_parameter("configservice", "describe-retention-configurations", add_option_dict)