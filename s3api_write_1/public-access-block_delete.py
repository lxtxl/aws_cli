...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/s3api/delete-public-access-block.html
if __name__ == '__main__':
    ...
    write_one_parameter("s3api", "delete-public-access-block", "bucket", add_option_dict)
