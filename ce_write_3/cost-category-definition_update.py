...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ce/update-cost-category-definition.html
...
(string)
    ...
    write_three_parameter("ce", "update-cost-category-definition", "cost-category-arn", "rule-version", "rules", add_option_dict)
