...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/databrew/describe-dataset.html
if __name__ == '__main__':
    ...
    execute_one_parameter("databrew", "describe-dataset", "name", add_option_dict)