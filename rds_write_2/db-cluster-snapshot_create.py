...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/rds/create-db-cluster-snapshot.html
...
Example: my-cluster1-snapshot1
    # db-cluster-identifier : The identifier of the DB cluster to create a snapshot for. This parameter isnât case-sensitive.
Constraints:
...
Example: my-cluster1
    ...
    write_two_parameter("rds", "create-db-cluster-snapshot", "db-cluster-snapshot-identifier", "db-cluster-identifier", add_option_dict)
