...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/budgets/delete-budget.html
if __name__ == '__main__':
    ...
    # account-id : The accountId that is associated with the budget that you want to delete.
    # budget-name : The name of the budget that you want to delete.
    """
    add_option_dict = {}
    add_option_dict["parameter_display_string"] = parameter_display_string
    # ex: add_option_dict["no_value_parameter_list"] = "--single-parameter"
    write_two_parameter("budgets", "delete-budget", "account-id", "budget-name", add_option_dict)
