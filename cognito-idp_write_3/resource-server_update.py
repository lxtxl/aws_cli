...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/cognito-idp/update-resource-server.html
if __name__ == '__main__':
    ...
    write_three_parameter("cognito-idp", "update-resource-server", "user-pool-id", "identifier", "name", add_option_dict)
