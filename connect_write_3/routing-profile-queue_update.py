...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/connect/update-routing-profile-queues.html
if __name__ == '__main__':
    ...
    # queue-configs : The queues to be updated for this routing profile. Queues must first be associated to the routing profile. You can do this using AssociateRoutingProfileQueues.
(structure)
...
The delay, in seconds, a contact should be in the queue before they are routed to an available agent. For more information, see Queues: priority and delay in the Amazon Connect Administrator Guide .
    ...
    write_three_parameter("connect", "update-routing-profile-queues", "instance-id", "routing-profile-id", "queue-configs", add_option_dict)
