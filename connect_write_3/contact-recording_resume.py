...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/connect/resume-contact-recording.html
if __name__ == '__main__':
    ...
    write_three_parameter("connect", "resume-contact-recording", "instance-id", "contact-id", "initial-contact-id", add_option_dict)
