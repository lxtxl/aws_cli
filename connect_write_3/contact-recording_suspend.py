...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/connect/suspend-contact-recording.html
if __name__ == '__main__':
    ...
    write_three_parameter("connect", "suspend-contact-recording", "instance-id", "contact-id", "initial-contact-id", add_option_dict)
