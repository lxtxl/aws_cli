...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/mediaconvert/update-job-template.html
if __name__ == '__main__':
    ...
    write_one_parameter("mediaconvert", "update-job-template", "name", add_option_dict)
