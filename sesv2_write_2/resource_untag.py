...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sesv2/untag-resource.html
...
(string)
    ...
    write_two_parameter("sesv2", "untag-resource", "resource-arn", "tag-keys", add_option_dict)
