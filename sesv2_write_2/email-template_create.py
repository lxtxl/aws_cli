...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sesv2/create-email-template.html
if __name__ == '__main__':
    ...
    # template-name : The name of the template you want to create.
    ...
    write_two_parameter("sesv2", "create-email-template", "template-name", "template-content", add_option_dict)
