...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sesv2/delete-contact.html
if __name__ == '__main__':
    ...
    # contact-list-name : The name of the contact list from which the contact should be removed.
    # email-address : The contactâs email address.
    """
    add_option_dict = {}
    add_option_dict["parameter_display_string"] = parameter_display_string
    # ex: add_option_dict["no_value_parameter_list"] = "--single-parameter"
    write_two_parameter("sesv2", "delete-contact", "contact-list-name", "email-address", add_option_dict)
