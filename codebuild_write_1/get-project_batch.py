...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/codebuild/batch-get-projects.html
...
(string)
    ...
    write_one_parameter("codebuild", "batch-get-projects", "names", add_option_dict)
