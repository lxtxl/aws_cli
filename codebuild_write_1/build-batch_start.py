...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/codebuild/start-build-batch.html
if __name__ == '__main__':
    ...
    write_one_parameter("codebuild", "start-build-batch", "project-name", add_option_dict)
