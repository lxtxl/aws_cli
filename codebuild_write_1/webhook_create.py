...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/codebuild/create-webhook.html
if __name__ == '__main__':
    ...
    write_one_parameter("codebuild", "create-webhook", "project-name", add_option_dict)
