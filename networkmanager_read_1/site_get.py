...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/networkmanager/get-sites.html
if __name__ == '__main__':
    ...
    execute_one_parameter("networkmanager", "get-sites", "global-network-id", add_option_dict)