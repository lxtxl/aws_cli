...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/es/get-upgrade-history.html
if __name__ == '__main__':
    ...
    execute_one_parameter("es", "get-upgrade-history", "domain-name", add_option_dict)