...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/route53resolver/list-resolver-query-log-configs.html
if __name__ == '__main__':
    ...
    read_no_parameter("route53resolver", "list-resolver-query-log-configs", add_option_dict)