...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/customer-profiles/get-integration.html
if __name__ == '__main__':
    ...
    execute_one_parameter("customer-profiles", "get-integration", "domain-name", add_option_dict)