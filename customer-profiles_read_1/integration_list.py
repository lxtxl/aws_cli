...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/customer-profiles/list-integrations.html
if __name__ == '__main__':
    ...
    execute_one_parameter("customer-profiles", "list-integrations", "domain-name", add_option_dict)