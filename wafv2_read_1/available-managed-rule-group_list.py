...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/wafv2/list-available-managed-rule-groups.html
...
REGIONAL
    ...
    execute_one_parameter("wafv2", "list-available-managed-rule-groups", "scope", add_option_dict)