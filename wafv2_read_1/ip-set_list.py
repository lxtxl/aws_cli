...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/wafv2/list-ip-sets.html
...
REGIONAL
    ...
    execute_one_parameter("wafv2", "list-ip-sets", "scope", add_option_dict)