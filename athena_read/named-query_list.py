...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/athena/list-named-queries.html
if __name__ == '__main__':
    ...
    read_no_parameter("athena", "list-named-queries", add_option_dict)