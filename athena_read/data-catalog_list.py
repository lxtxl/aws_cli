...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/athena/list-data-catalogs.html
if __name__ == '__main__':
    ...
    read_no_parameter("athena", "list-data-catalogs", add_option_dict)