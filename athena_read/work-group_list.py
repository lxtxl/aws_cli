...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/athena/list-work-groups.html
if __name__ == '__main__':
    ...
    read_no_parameter("athena", "list-work-groups", add_option_dict)