...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/databrew/delete-dataset.html
if __name__ == '__main__':
    ...
    write_one_parameter("databrew", "delete-dataset", "name", add_option_dict)
