...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/databrew/delete-project.html
if __name__ == '__main__':
    ...
    write_one_parameter("databrew", "delete-project", "name", add_option_dict)
