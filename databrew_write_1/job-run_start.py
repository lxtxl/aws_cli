...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/databrew/start-job-run.html
if __name__ == '__main__':
    ...
    write_one_parameter("databrew", "start-job-run", "name", add_option_dict)
