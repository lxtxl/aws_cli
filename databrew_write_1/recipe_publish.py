...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/databrew/publish-recipe.html
if __name__ == '__main__':
    ...
    write_one_parameter("databrew", "publish-recipe", "name", add_option_dict)
