...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/amplifybackend/create-token.html
if __name__ == '__main__':
    ...
    write_one_parameter("amplifybackend", "create-token", "app-id", add_option_dict)
