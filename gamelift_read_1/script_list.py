...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/gamelift/describe-script.html
if __name__ == '__main__':
    ...
    # script-id : A unique identifier for a Realtime script to retrieve properties for. You can use either the script ID or ARN value.
    """
    ...
    execute_one_parameter("gamelift", "describe-script", "script-id", add_option_dict)