...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/codestar/list-user-profiles.html
if __name__ == '__main__':
    ...
    read_no_parameter("codestar", "list-user-profiles", add_option_dict)