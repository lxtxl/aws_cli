...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/lightsail/get-disk.html
if __name__ == '__main__':
    ...
    # disk-name : The name of the disk (e.g., my-disk ).
    """
    ...
    execute_one_parameter("lightsail", "get-disk", "disk-name", add_option_dict)