...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/lightsail/get-load-balancer.html
if __name__ == '__main__':
    ...
    execute_one_parameter("lightsail", "get-load-balancer", "load-balancer-name", add_option_dict)