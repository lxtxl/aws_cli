...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/lightsail/get-domain.html
if __name__ == '__main__':
    ...
    # domain-name : The domain name for which your want to return information about.
    """
    ...
    execute_one_parameter("lightsail", "get-domain", "domain-name", add_option_dict)