...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/lightsail/get-relational-database-snapshot.html
if __name__ == '__main__':
    ...
    # relational-database-snapshot-name : The name of the database snapshot for which to get information.
    """
    ...
    execute_one_parameter("lightsail", "get-relational-database-snapshot", "relational-database-snapshot-name", add_option_dict)