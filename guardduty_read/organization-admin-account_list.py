...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/guardduty/list-organization-admin-accounts.html
if __name__ == '__main__':
    ...
    read_no_parameter("guardduty", "list-organization-admin-accounts", add_option_dict)