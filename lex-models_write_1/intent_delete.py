...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/lex-models/delete-intent.html
if __name__ == '__main__':
    ...
    write_one_parameter("lex-models", "delete-intent", "name", add_option_dict)
