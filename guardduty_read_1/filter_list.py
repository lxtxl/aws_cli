...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/guardduty/list-filters.html
if __name__ == '__main__':
    ...
    execute_one_parameter("guardduty", "list-filters", "detector-id", add_option_dict)