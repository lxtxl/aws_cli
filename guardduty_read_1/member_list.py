...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/guardduty/list-members.html
if __name__ == '__main__':
    ...
    # detector-id : The unique ID of the detector the member is associated with.
    """
    ...
    execute_one_parameter("guardduty", "list-members", "detector-id", add_option_dict)