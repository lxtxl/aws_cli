...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/application-insights/update-component.html
if __name__ == '__main__':
    ...
    write_two_parameter("application-insights", "update-component", "resource-group-name", "component-name", add_option_dict)
