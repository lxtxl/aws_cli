...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/apigateway/update-usage-plan.html
if __name__ == '__main__':
    ...
    # usage-plan-id : [Required] The Id of the to-be-updated usage plan.
    """
    add_option_dict = {}
    ...
    write_one_parameter("apigateway", "update-usage-plan", "usage-plan-id", add_option_dict)
