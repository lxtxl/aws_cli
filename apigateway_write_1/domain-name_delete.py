...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/apigateway/delete-domain-name.html
if __name__ == '__main__':
    ...
    # domain-name : [Required] The name of the  DomainName resource to be deleted.
    """
    add_option_dict = {}
    ...
    write_one_parameter("apigateway", "delete-domain-name", "domain-name", add_option_dict)
