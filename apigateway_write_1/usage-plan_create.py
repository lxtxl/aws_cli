...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/apigateway/create-usage-plan.html
if __name__ == '__main__':
    ...
    write_one_parameter("apigateway", "create-usage-plan", "name", add_option_dict)
