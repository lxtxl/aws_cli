...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/apigateway/import-rest-api.html
if __name__ == '__main__':
    ...
    write_one_parameter("apigateway", "import-rest-api", "body", add_option_dict)
