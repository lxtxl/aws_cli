...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/apigateway/delete-api-key.html
if __name__ == '__main__':
    ...
    # api-key : [Required] The identifier of the  ApiKey resource to be deleted.
    """
    add_option_dict = {}
    ...
    write_one_parameter("apigateway", "delete-api-key", "api-key", add_option_dict)
