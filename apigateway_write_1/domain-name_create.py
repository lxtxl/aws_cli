...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/apigateway/create-domain-name.html
if __name__ == '__main__':
    ...
    write_one_parameter("apigateway", "create-domain-name", "domain-name", add_option_dict)
