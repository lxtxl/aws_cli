...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/apigateway/delete-rest-api.html
if __name__ == '__main__':
    ...
    write_one_parameter("apigateway", "delete-rest-api", "rest-api-id", add_option_dict)
