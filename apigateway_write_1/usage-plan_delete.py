...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/apigateway/delete-usage-plan.html
if __name__ == '__main__':
    ...
    # usage-plan-id : [Required] The Id of the to-be-deleted usage plan.
    """
    add_option_dict = {}
    ...
    write_one_parameter("apigateway", "delete-usage-plan", "usage-plan-id", add_option_dict)
