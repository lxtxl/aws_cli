...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/apigateway/update-vpc-link.html
if __name__ == '__main__':
    ...
    write_one_parameter("apigateway", "update-vpc-link", "vpc-link-id", add_option_dict)
