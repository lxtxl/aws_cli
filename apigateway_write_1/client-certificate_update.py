...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/apigateway/update-client-certificate.html
if __name__ == '__main__':
    ...
    # client-certificate-id : [Required] The identifier of the  ClientCertificate resource to be updated.
    """
    add_option_dict = {}
    ...
    write_one_parameter("apigateway", "update-client-certificate", "client-certificate-id", add_option_dict)
