...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/lookoutvision/list-projects.html
if __name__ == '__main__':
    ...
    read_no_parameter("lookoutvision", "list-projects", add_option_dict)