...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/application-autoscaling/register-scalable-target.html
...
cassandra
kafka
    # resource-id : The identifier of the resource that is associated with the scalable target. This string consists of the resource type and unique identifier.
...
kafka:broker-storage:VolumeSize
    ...
    write_three_parameter("application-autoscaling", "register-scalable-target", "service-namespace", "resource-id", "scalable-dimension", add_option_dict)
