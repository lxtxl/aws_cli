...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/lex-models/get-slot-types.html
if __name__ == '__main__':
    ...
    read_no_parameter("lex-models", "get-slot-types", add_option_dict)