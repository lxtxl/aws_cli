...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/mobile/delete-project.html
if __name__ == '__main__':
    ...
    write_one_parameter("mobile", "delete-project", "project-id", add_option_dict)
