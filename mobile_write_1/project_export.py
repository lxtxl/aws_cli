...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/mobile/export-project.html
if __name__ == '__main__':
    ...
    write_one_parameter("mobile", "export-project", "project-id", add_option_dict)
