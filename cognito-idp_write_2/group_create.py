...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/cognito-idp/create-group.html
if __name__ == '__main__':
    ...
    # group-name : The name of the group. Must be unique.
    # user-pool-id : The user pool ID for the user pool.
    """
    add_option_dict = {}
    add_option_dict["parameter_display_string"] = parameter_display_string
    # ex: add_option_dict["no_value_parameter_list"] = "--single-parameter"
    write_two_parameter("cognito-idp", "create-group", "group-name", "user-pool-id", add_option_dict)
