...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/cognito-idp/delete-user-pool-client.html
if __name__ == '__main__':
    ...
    # user-pool-id : The user pool ID for the user pool where you want to delete the client.
    # client-id : The app client ID of the app associated with the user pool.
    """
    add_option_dict = {}
    add_option_dict["parameter_display_string"] = parameter_display_string
    # ex: add_option_dict["no_value_parameter_list"] = "--single-parameter"
    write_two_parameter("cognito-idp", "delete-user-pool-client", "user-pool-id", "client-id", add_option_dict)
