...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/cognito-idp/delete-user-pool-domain.html
if __name__ == '__main__':
    ...
    write_two_parameter("cognito-idp", "delete-user-pool-domain", "domain", "user-pool-id", add_option_dict)
