...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/cognito-idp/update-identity-provider.html
if __name__ == '__main__':
    ...
    write_two_parameter("cognito-idp", "update-identity-provider", "user-pool-id", "provider-name", add_option_dict)
