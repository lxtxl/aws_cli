...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/cognito-idp/stop-user-import-job.html
if __name__ == '__main__':
    ...
    write_two_parameter("cognito-idp", "stop-user-import-job", "user-pool-id", "job-id", add_option_dict)
