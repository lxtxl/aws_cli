...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/dms/delete-endpoint.html
if __name__ == '__main__':
    ...
    write_one_parameter("dms", "delete-endpoint", "endpoint-arn", add_option_dict)
