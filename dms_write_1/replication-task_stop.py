...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/dms/stop-replication-task.html
if __name__ == '__main__':
    ...
    # replication-task-arn : The Amazon Resource Name(ARN) of the replication task to be stopped.
    """
    add_option_dict = {}
    ...
    write_one_parameter("dms", "stop-replication-task", "replication-task-arn", add_option_dict)
