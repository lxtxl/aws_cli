...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/dms/reboot-replication-instance.html
if __name__ == '__main__':
    ...
    write_one_parameter("dms", "reboot-replication-instance", "replication-instance-arn", add_option_dict)
