...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/dms/delete-replication-instance.html
if __name__ == '__main__':
    ...
    # replication-instance-arn : The Amazon Resource Name (ARN) of the replication instance to be deleted.
    """
    add_option_dict = {}
    ...
    write_one_parameter("dms", "delete-replication-instance", "replication-instance-arn", add_option_dict)
