...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sesv2/delete-dedicated-ip-pool.html
if __name__ == '__main__':
    ...
    write_one_parameter("sesv2", "delete-dedicated-ip-pool", "pool-name", add_option_dict)
