...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sesv2/create-contact-list.html
if __name__ == '__main__':
    ...
    write_one_parameter("sesv2", "create-contact-list", "contact-list-name", add_option_dict)
