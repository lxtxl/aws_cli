...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sesv2/delete-contact-list.html
if __name__ == '__main__':
    ...
    write_one_parameter("sesv2", "delete-contact-list", "contact-list-name", add_option_dict)
