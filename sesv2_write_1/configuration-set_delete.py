...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sesv2/delete-configuration-set.html
if __name__ == '__main__':
    ...
    write_one_parameter("sesv2", "delete-configuration-set", "configuration-set-name", add_option_dict)
