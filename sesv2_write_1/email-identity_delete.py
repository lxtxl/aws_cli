...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sesv2/delete-email-identity.html
if __name__ == '__main__':
    ...
    # email-identity : The identity (that is, the email address or domain) that you want to delete.
    """
    add_option_dict = {}
    ...
    write_one_parameter("sesv2", "delete-email-identity", "email-identity", add_option_dict)
