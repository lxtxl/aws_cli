...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iot1click-projects/describe-project.html
if __name__ == '__main__':
    ...
    # project-name : The name of the project to be described.
    """
    ...
    execute_one_parameter("iot1click-projects", "describe-project", "project-name", add_option_dict)