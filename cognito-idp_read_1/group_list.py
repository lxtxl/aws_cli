...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/cognito-idp/list-groups.html
if __name__ == '__main__':
    ...
    execute_one_parameter("cognito-idp", "list-groups", "user-pool-id", add_option_dict)