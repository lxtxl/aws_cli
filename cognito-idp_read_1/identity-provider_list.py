...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/cognito-idp/list-identity-providers.html
if __name__ == '__main__':
    ...
    execute_one_parameter("cognito-idp", "list-identity-providers", "user-pool-id", add_option_dict)