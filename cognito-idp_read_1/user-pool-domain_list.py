...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/cognito-idp/describe-user-pool-domain.html
if __name__ == '__main__':
    ...
    execute_one_parameter("cognito-idp", "describe-user-pool-domain", "domain", add_option_dict)