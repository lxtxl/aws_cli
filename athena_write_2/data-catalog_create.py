...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/athena/create-data-catalog.html
...
HIVE
    ...
    write_two_parameter("athena", "create-data-catalog", "name", "type", add_option_dict)
