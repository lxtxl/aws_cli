...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sesv2/update-email-identity-policy.html
if __name__ == '__main__':
    ...
    # email-identity : The email identity for which you want to update policy.
...
For information about the syntax of sending authorization policies, see the Amazon SES Developer Guide .
    ...
    write_three_parameter("sesv2", "update-email-identity-policy", "email-identity", "policy-name", "policy", add_option_dict)
