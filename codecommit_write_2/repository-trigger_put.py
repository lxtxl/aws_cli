...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/codecommit/put-repository-triggers.html
if __name__ == '__main__':
    ...
    # repository-name : The name of the repository where you want to create or update the trigger.
...
(string)
    ...
    write_two_parameter("codecommit", "put-repository-triggers", "repository-name", "triggers", add_option_dict)
