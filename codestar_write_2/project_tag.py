...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/codestar/tag-project.html
...
value -> (string)
    ...
    write_two_parameter("codestar", "tag-project", "id", "tags", add_option_dict)
