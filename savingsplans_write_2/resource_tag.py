...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/savingsplans/tag-resource.html
...
value -> (string)
    ...
    write_two_parameter("savingsplans", "tag-resource", "resource-arn", "tags", add_option_dict)
