...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/savingsplans/untag-resource.html
...
(string)
    ...
    write_two_parameter("savingsplans", "untag-resource", "resource-arn", "tag-keys", add_option_dict)
