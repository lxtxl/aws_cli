...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/backup/delete-recovery-point.html
if __name__ == '__main__':
    ...
    write_two_parameter("backup", "delete-recovery-point", "backup-vault-name", "recovery-point-arn", add_option_dict)
