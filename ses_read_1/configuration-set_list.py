...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ses/describe-configuration-set.html
if __name__ == '__main__':
    ...
    # configuration-set-name : The name of the configuration set to describe.
    """
    ...
    execute_one_parameter("ses", "describe-configuration-set", "configuration-set-name", add_option_dict)