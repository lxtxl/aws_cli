...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ses/describe-receipt-rule-set.html
if __name__ == '__main__':
    ...
    # rule-set-name : The name of the receipt rule set to describe.
    """
    ...
    execute_one_parameter("ses", "describe-receipt-rule-set", "rule-set-name", add_option_dict)