...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ses/get-identity-notification-attributes.html
...
(string)
    ...
    execute_one_parameter("ses", "get-identity-notification-attributes", "identities", add_option_dict)