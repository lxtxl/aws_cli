...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/opsworks-cm/describe-backups.html
if __name__ == '__main__':
    ...
    read_no_parameter("opsworks-cm", "describe-backups", add_option_dict)