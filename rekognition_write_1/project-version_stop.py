...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/rekognition/stop-project-version.html
...
This operation requires permissions to perform the rekognition:StopProjectVersion action.
    ...
    write_one_parameter("rekognition", "stop-project-version", "project-version-arn", add_option_dict)
