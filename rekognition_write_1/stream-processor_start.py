...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/rekognition/start-stream-processor.html
if __name__ == '__main__':
    ...
    write_one_parameter("rekognition", "start-stream-processor", "name", add_option_dict)
