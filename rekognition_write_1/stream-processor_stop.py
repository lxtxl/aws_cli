...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/rekognition/stop-stream-processor.html
if __name__ == '__main__':
    ...
    write_one_parameter("rekognition", "stop-stream-processor", "name", add_option_dict)
