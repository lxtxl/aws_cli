...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/neptune/create-db-cluster-endpoint.html
if __name__ == '__main__':
    ...
    write_three_parameter("neptune", "create-db-cluster-endpoint", "db-cluster-identifier", "db-cluster-endpoint-identifier", "endpoint-type", add_option_dict)
