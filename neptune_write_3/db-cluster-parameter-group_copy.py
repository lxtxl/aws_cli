...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/neptune/copy-db-cluster-parameter-group.html
if __name__ == '__main__':
    ...
    # source-db-cluster-parameter-group-identifier : The identifier or Amazon Resource Name (ARN) for the source DB cluster parameter group. For information about creating an ARN, see Constructing an Amazon Resource Name (ARN) .
Constraints:
...
Example: my-cluster-param-group1
    ...
    write_three_parameter("neptune", "copy-db-cluster-parameter-group", "source-db-cluster-parameter-group-identifier", "target-db-cluster-parameter-group-identifier", "target-db-cluster-parameter-group-description", add_option_dict)
