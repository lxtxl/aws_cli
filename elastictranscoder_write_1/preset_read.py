...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/elastictranscoder/read-preset.html
if __name__ == '__main__':
    ...
    write_one_parameter("elastictranscoder", "read-preset", "id", add_option_dict)
