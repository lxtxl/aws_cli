...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/chime/update-voice-connector.html
if __name__ == '__main__':
    ...
    write_three_parameter("chime", "update-voice-connector", "voice-connector-id", "name", "require-encryption | --no-require-encryption", add_option_dict)
