...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/chime/delete-room-membership.html
if __name__ == '__main__':
    ...
    write_three_parameter("chime", "delete-room-membership", "account-id", "room-id", "member-id", add_option_dict)
