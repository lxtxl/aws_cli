...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/events/put-targets.html
...
The maximum amount of time, in seconds, to continue to make retry attempts.
    ...
    write_two_parameter("events", "put-targets", "rule", "targets", add_option_dict)
