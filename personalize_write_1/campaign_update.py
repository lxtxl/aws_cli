...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/personalize/update-campaign.html
if __name__ == '__main__':
    ...
    write_one_parameter("personalize", "update-campaign", "campaign-arn", add_option_dict)
