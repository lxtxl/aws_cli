...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/personalize/delete-event-tracker.html
if __name__ == '__main__':
    ...
    # event-tracker-arn : The Amazon Resource Name (ARN) of the event tracker to delete.
    """
    add_option_dict = {}
    ...
    write_one_parameter("personalize", "delete-event-tracker", "event-tracker-arn", add_option_dict)
