...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/schemas/update-schema.html
if __name__ == '__main__':
    ...
    write_two_parameter("schemas", "update-schema", "registry-name", "schema-name", add_option_dict)
