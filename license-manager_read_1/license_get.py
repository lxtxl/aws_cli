...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/license-manager/get-license.html
if __name__ == '__main__':
    ...
    execute_one_parameter("license-manager", "get-license", "license-arn", add_option_dict)