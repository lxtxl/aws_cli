...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/frauddetector/get-event-types.html
if __name__ == '__main__':
    ...
    read_no_parameter("frauddetector", "get-event-types", add_option_dict)