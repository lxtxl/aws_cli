...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/frauddetector/get-detectors.html
if __name__ == '__main__':
    ...
    read_no_parameter("frauddetector", "get-detectors", add_option_dict)