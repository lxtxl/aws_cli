...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iam/list-ssh-public-keys.html
if __name__ == '__main__':
    ...
    read_no_parameter("iam", "list-ssh-public-keys", add_option_dict)