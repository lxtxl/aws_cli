...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/es/associate-package.html
if __name__ == '__main__':
    ...
    write_two_parameter("es", "associate-package", "package-id", "domain-name", add_option_dict)
