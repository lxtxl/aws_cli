...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/datapipeline/list-pipelines.html
if __name__ == '__main__':
    ...
    read_no_parameter("datapipeline", "list-pipelines", add_option_dict)