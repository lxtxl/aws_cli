...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/batch/terminate-job.html
if __name__ == '__main__':
    ...
    # job-id : The AWS Batch job ID of the job to terminate.
    ...
    write_two_parameter("batch", "terminate-job", "job-id", "reason", add_option_dict)
