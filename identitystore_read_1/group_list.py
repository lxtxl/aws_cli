...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/identitystore/list-groups.html
if __name__ == '__main__':
    ...
    execute_one_parameter("identitystore", "list-groups", "identity-store-id", add_option_dict)