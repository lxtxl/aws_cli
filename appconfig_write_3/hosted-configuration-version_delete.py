...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/appconfig/delete-hosted-configuration-version.html
if __name__ == '__main__':
    ...
    # version-number : The versions number to delete.
    """
    add_option_dict = {}
    add_option_dict["parameter_display_string"] = parameter_display_string
    # ex: add_option_dict["no_value_parameter_list"] = "--single-parameter"
    write_three_parameter("appconfig", "delete-hosted-configuration-version", "application-id", "configuration-profile-id", "version-number", add_option_dict)
