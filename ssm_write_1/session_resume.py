...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ssm/resume-session.html
if __name__ == '__main__':
    ...
    # session-id : The ID of the disconnected session to resume.
    """
    add_option_dict = {}
    ...
    write_one_parameter("ssm", "resume-session", "session-id", add_option_dict)
