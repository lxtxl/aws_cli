...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ssm/delete-patch-baseline.html
if __name__ == '__main__':
    ...
    # baseline-id : The ID of the patch baseline to delete.
    """
    add_option_dict = {}
    ...
    write_one_parameter("ssm", "delete-patch-baseline", "baseline-id", add_option_dict)
