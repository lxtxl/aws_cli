...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ssm/create-resource-data-sync.html
if __name__ == '__main__':
    ...
    # sync-name : A name for the configuration.
    """
    add_option_dict = {}
    ...
    write_one_parameter("ssm", "create-resource-data-sync", "sync-name", add_option_dict)
