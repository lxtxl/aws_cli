...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ssm/update-maintenance-window.html
if __name__ == '__main__':
    ...
    # window-id : The ID of the maintenance window to update.
    """
    add_option_dict = {}
    ...
    write_one_parameter("ssm", "update-maintenance-window", "window-id", add_option_dict)
