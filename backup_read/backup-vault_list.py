...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/backup/list-backup-vaults.html
if __name__ == '__main__':
    ...
    read_no_parameter("backup", "list-backup-vaults", add_option_dict)