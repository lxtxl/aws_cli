...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/cloudsearch/index-documents.html
if __name__ == '__main__':
    ...
    write_one_parameter("cloudsearch", "index-documents", "domain-name", add_option_dict)
