...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/apigatewayv2/get-route-responses.html
if __name__ == '__main__':
    ...
    execute_two_parameter("apigatewayv2", "get-route-responses", "api-id", "route-id", parameter_display_string)