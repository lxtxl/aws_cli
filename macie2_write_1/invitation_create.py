...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/macie2/create-invitations.html
if __name__ == '__main__':
    ...
    # account-ids : An array that lists AWS account IDs, one for each account to send the invitation to.
(string)
    """
    add_option_dict = {}
    ...
    write_one_parameter("macie2", "create-invitations", "account-ids", add_option_dict)
