...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/macie2/disable-organization-admin-account.html
if __name__ == '__main__':
    ...
    # admin-account-id : The AWS account ID of the delegated administrator account.
    """
    add_option_dict = {}
    ...
    write_one_parameter("macie2", "disable-organization-admin-account", "admin-account-id", add_option_dict)
