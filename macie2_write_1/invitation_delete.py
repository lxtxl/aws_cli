...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/macie2/delete-invitations.html
if __name__ == '__main__':
    ...
    # account-ids : An array that lists AWS account IDs, one for each account that sent an invitation to delete.
(string)
    """
    add_option_dict = {}
    ...
    write_one_parameter("macie2", "delete-invitations", "account-ids", add_option_dict)
