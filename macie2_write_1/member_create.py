...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/macie2/create-member.html
if __name__ == '__main__':
    ...
    write_one_parameter("macie2", "create-member", "account", add_option_dict)
