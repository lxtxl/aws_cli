...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/macie2/delete-member.html
if __name__ == '__main__':
    ...
    write_one_parameter("macie2", "delete-member", "id", add_option_dict)
