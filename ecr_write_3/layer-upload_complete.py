...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ecr/complete-layer-upload.html
...
(string)
    ...
    write_three_parameter("ecr", "complete-layer-upload", "repository-name", "upload-id", "layer-digests", add_option_dict)
