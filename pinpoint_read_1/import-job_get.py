...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/pinpoint/get-import-jobs.html
if __name__ == '__main__':
    ...
    execute_one_parameter("pinpoint", "get-import-jobs", "application-id", add_option_dict)