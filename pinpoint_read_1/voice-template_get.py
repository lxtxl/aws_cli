...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/pinpoint/get-voice-template.html
if __name__ == '__main__':
    ...
    execute_one_parameter("pinpoint", "get-voice-template", "template-name", add_option_dict)