...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/pinpoint/get-apns-voip-channel.html
if __name__ == '__main__':
    ...
    execute_one_parameter("pinpoint", "get-apns-voip-channel", "application-id", add_option_dict)