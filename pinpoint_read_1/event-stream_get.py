...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/pinpoint/get-event-stream.html
if __name__ == '__main__':
    ...
    execute_one_parameter("pinpoint", "get-event-stream", "application-id", add_option_dict)