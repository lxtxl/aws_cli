...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/kinesisanalyticsv2/delete-application-output.html
if __name__ == '__main__':
    ...
    write_three_parameter("kinesisanalyticsv2", "delete-application-output", "application-name", "current-application-version-id", "output-id", add_option_dict)
