...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/resource-groups/tag.html
if __name__ == '__main__':
    ...
    write_one_parameter("resource-groups", "tag", "arn", add_option_dict)
