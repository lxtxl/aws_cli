...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/mediapackage/delete-channel.html
if __name__ == '__main__':
    ...
    write_one_parameter("mediapackage", "delete-channel", "id", add_option_dict)
