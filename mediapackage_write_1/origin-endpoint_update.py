...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/mediapackage/update-origin-endpoint.html
if __name__ == '__main__':
    ...
    write_one_parameter("mediapackage", "update-origin-endpoint", "id", add_option_dict)
