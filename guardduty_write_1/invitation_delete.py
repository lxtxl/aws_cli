...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/guardduty/delete-invitations.html
if __name__ == '__main__':
    ...
    # account-ids : A list of account IDs of the AWS accounts that sent invitations to the current member account that you want to delete invitations from.
(string)
    """
    add_option_dict = {}
    ...
    write_one_parameter("guardduty", "delete-invitations", "account-ids", add_option_dict)
