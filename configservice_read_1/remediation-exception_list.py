...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/configservice/describe-remediation-exceptions.html
if __name__ == '__main__':
    ...
    # config-rule-name : The name of the AWS Config rule.
    """
    ...
    execute_one_parameter("configservice", "describe-remediation-exceptions", "config-rule-name", add_option_dict)