...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/machinelearning/delete-batch-prediction.html
if __name__ == '__main__':
    ...
    # batch-prediction-id : A user-supplied ID that uniquely identifies the BatchPrediction .
    """
    add_option_dict = {}
    ...
    write_one_parameter("machinelearning", "delete-batch-prediction", "batch-prediction-id", add_option_dict)
