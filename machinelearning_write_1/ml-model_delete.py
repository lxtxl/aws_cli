...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/machinelearning/delete-ml-model.html
if __name__ == '__main__':
    ...
    write_one_parameter("machinelearning", "delete-ml-model", "ml-model-id", add_option_dict)
