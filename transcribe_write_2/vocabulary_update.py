...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/transcribe/update-vocabulary.html
if __name__ == '__main__':
    ...
    # vocabulary-name : The name of the vocabulary to update. The name is case sensitive. If you try to update a vocabulary with the same name as a previous vocabulary you will receive a ConflictException error.
...
zh-CN
    ...
    write_two_parameter("transcribe", "update-vocabulary", "vocabulary-name", "language-code", add_option_dict)
