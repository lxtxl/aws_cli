...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/fms/list-apps-lists.html
...
If you donât specify this, AWS Firewall Manager returns all available objects.
    ...
    execute_one_parameter("fms", "list-apps-lists", "max-results", add_option_dict)