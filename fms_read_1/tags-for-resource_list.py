...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/fms/list-tags-for-resource.html
if __name__ == '__main__':
    ...
    execute_one_parameter("fms", "list-tags-for-resource", "resource-arn", add_option_dict)