...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/amplify/list-domain-associations.html
if __name__ == '__main__':
    ...
    execute_one_parameter("amplify", "list-domain-associations", "app-id", add_option_dict)