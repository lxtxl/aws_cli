...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/amplify/get-webhook.html
if __name__ == '__main__':
    ...
    execute_one_parameter("amplify", "get-webhook", "webhook-id", add_option_dict)