...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/macie/list-member-accounts.html
if __name__ == '__main__':
    ...
    read_no_parameter("macie", "list-member-accounts", add_option_dict)