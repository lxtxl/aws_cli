...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/synthetics/tag-resource.html
if __name__ == '__main__':
    ...
    # resource-arn : The ARN of the canary that youâre adding tags to.
...
value -> (string)
    ...
    write_two_parameter("synthetics", "tag-resource", "resource-arn", "tags", add_option_dict)
