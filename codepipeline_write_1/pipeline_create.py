...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/codepipeline/create-pipeline.html
if __name__ == '__main__':
    ...
    write_one_parameter("codepipeline", "create-pipeline", "pipeline", add_option_dict)
