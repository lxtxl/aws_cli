...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/cognito-sync/describe-identity-pool-usage.html
if __name__ == '__main__':
    ...
    execute_one_parameter("cognito-sync", "describe-identity-pool-usage", "identity-pool-id", add_option_dict)