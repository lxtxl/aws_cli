...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/lambda/get-event-source-mapping.html
if __name__ == '__main__':
    ...
    execute_one_parameter("lambda", "get-event-source-mapping", "uuid", add_option_dict)