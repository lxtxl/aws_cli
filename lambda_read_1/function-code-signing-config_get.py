...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/lambda/get-function-code-signing-config.html
...
The length constraint applies only to the full ARN. If you specify only the function name, it is limited to 64 characters in length.
    ...
    execute_one_parameter("lambda", "get-function-code-signing-config", "function-name", add_option_dict)