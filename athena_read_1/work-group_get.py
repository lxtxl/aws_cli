...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/athena/get-work-group.html
if __name__ == '__main__':
    ...
    # work-group : The name of the workgroup.
    """
    ...
    execute_one_parameter("athena", "get-work-group", "work-group", add_option_dict)