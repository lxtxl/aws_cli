...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/acm/renew-certificate.html
if __name__ == '__main__':
    ...
    # certificate-arn : String that contains the ARN of the ACM certificate to be renewed. This must be of the form:
...
For more information about ARNs, see Amazon Resource Names (ARNs) and AWS Service Namespaces .
    ...
    write_one_parameter("acm", "renew-certificate", "certificate-arn", add_option_dict)
