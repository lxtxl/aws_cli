...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/deploy/list-on-premises-instances.html
if __name__ == '__main__':
    ...
    read_no_parameter("deploy", "list-on-premises-instances", add_option_dict)