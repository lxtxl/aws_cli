...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/mwaa/tag-resource.html
...
value -> (string)
    ...
    write_two_parameter("mwaa", "tag-resource", "resource-arn", "tags", add_option_dict)
