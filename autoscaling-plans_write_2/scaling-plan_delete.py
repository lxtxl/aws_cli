...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/autoscaling-plans/delete-scaling-plan.html
if __name__ == '__main__':
    ...
    write_two_parameter("autoscaling-plans", "delete-scaling-plan", "scaling-plan-name", "scaling-plan-version", add_option_dict)
