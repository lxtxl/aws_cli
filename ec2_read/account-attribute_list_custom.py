...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/describe-account-attributes.html
if __name__ == '__main__':
    ...
    read_no_parameter(profile_name, "ec2", "describe-account-attributes", add_option_dict)
