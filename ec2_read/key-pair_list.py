...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/describe-key-pairs.html
if __name__ == '__main__':
    ...
    read_no_parameter("ec2", "describe-key-pairs", add_option_dict)