...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/describe-regions.html
if __name__ == '__main__':
    ...
    read_no_parameter_custom("ec2", "describe-regions", add_option_dict)
