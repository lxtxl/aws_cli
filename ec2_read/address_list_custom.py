...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/describe-addresses.html
if __name__ == '__main__':
    ...
    read_no_parameter(profile_name, "ec2", "describe-addresses", add_option_dict)
