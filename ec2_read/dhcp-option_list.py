...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/describe-dhcp-options.html
if __name__ == '__main__':
    ...
    read_no_parameter("ec2", "describe-dhcp-options", add_option_dict)