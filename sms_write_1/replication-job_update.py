...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sms/update-replication-job.html
if __name__ == '__main__':
    ...
    write_one_parameter("sms", "update-replication-job", "replication-job-id", add_option_dict)
