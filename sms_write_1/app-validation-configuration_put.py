...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sms/put-app-validation-configuration.html
if __name__ == '__main__':
    ...
    write_one_parameter("sms", "put-app-validation-configuration", "app-id", add_option_dict)
