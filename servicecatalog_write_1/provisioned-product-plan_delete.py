...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/servicecatalog/delete-provisioned-product-plan.html
if __name__ == '__main__':
    ...
    write_one_parameter("servicecatalog", "delete-provisioned-product-plan", "plan-id", add_option_dict)
