...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/servicecatalog/delete-constraint.html
if __name__ == '__main__':
    ...
    write_one_parameter("servicecatalog", "delete-constraint", "id", add_option_dict)
