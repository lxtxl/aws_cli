...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/servicecatalog/update-product.html
if __name__ == '__main__':
    ...
    write_one_parameter("servicecatalog", "update-product", "id", add_option_dict)
