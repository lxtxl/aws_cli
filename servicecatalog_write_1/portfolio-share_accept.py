...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/servicecatalog/accept-portfolio-share.html
if __name__ == '__main__':
    ...
    write_one_parameter("servicecatalog", "accept-portfolio-share", "portfolio-id", add_option_dict)
