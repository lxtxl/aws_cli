...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/servicecatalog/update-service-action.html
if __name__ == '__main__':
    ...
    write_one_parameter("servicecatalog", "update-service-action", "id", add_option_dict)
