...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/servicecatalog/reject-portfolio-share.html
if __name__ == '__main__':
    ...
    write_one_parameter("servicecatalog", "reject-portfolio-share", "portfolio-id", add_option_dict)
