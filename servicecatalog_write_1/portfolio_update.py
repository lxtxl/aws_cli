...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/servicecatalog/update-portfolio.html
if __name__ == '__main__':
    ...
    write_one_parameter("servicecatalog", "update-portfolio", "id", add_option_dict)
