...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/servicecatalog/delete-tag-option.html
if __name__ == '__main__':
    ...
    write_one_parameter("servicecatalog", "delete-tag-option", "id", add_option_dict)
