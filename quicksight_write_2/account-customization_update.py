...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/quicksight/update-account-customization.html
if __name__ == '__main__':
    ...
    # aws-account-id : The ID for the AWS account that you want to update QuickSight customizations for.
    # account-customization : 
    """
    add_option_dict = {}
    add_option_dict["parameter_display_string"] = parameter_display_string
    # ex: add_option_dict["no_value_parameter_list"] = "--single-parameter"
    write_two_parameter("quicksight", "update-account-customization", "aws-account-id", "account-customization", add_option_dict)
