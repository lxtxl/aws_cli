...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/securityhub/get-members.html
if __name__ == '__main__':
    ...
    # account-ids : The list of account IDs for the Security Hub member accounts to return the details for.
(string)
    """
    ...
    execute_one_parameter("securityhub", "get-members", "account-ids", add_option_dict)