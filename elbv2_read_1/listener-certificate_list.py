...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/elbv2/describe-listener-certificates.html
if __name__ == '__main__':
    ...
    # listener-arn : The Amazon Resource Names (ARN) of the listener.
    """
    ...
    execute_one_parameter("elbv2", "describe-listener-certificates", "listener-arn", add_option_dict)