...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/connect/delete-instance.html
if __name__ == '__main__':
    ...
    write_one_parameter("connect", "delete-instance", "instance-id", add_option_dict)
