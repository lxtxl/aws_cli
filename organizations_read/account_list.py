...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/organizations/list-accounts.html
if __name__ == '__main__':
    ...
    read_no_parameter("organizations", "list-accounts", add_option_dict)