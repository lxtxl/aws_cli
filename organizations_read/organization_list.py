...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/organizations/describe-organization.html
if __name__ == '__main__':
    ...
    read_no_parameter("organizations", "describe-organization", add_option_dict)