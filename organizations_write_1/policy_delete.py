...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/organizations/delete-policy.html
if __name__ == '__main__':
    ...
    # policy-id : The unique identifier (ID) of the policy that you want to delete. You can get the ID from the  ListPolicies or  ListPoliciesForTarget operations.
The regex pattern for a policy ID string requires âp-â followed by from 8 to 128 lowercase or uppercase letters, digits, or the underscore character (_).
    ...
    write_one_parameter("organizations", "delete-policy", "policy-id", add_option_dict)
