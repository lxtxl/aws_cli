...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/organizations/cancel-handshake.html
if __name__ == '__main__':
    ...
    # handshake-id : The unique identifier (ID) of the handshake that you want to cancel. You can get the ID from the  ListHandshakesForOrganization operation.
The regex pattern for handshake ID string requires âh-â followed by from 8 to 32 lowercase letters or digits.
    ...
    write_one_parameter("organizations", "cancel-handshake", "handshake-id", add_option_dict)
