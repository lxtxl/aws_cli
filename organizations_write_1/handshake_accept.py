...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/organizations/accept-handshake.html
if __name__ == '__main__':
    ...
    # handshake-id : The unique identifier (ID) of the handshake that you want to accept.
The regex pattern for handshake ID string requires âh-â followed by from 8 to 32 lowercase letters or digits.
    ...
    write_one_parameter("organizations", "accept-handshake", "handshake-id", add_option_dict)
