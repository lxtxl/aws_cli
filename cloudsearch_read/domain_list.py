...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/cloudsearch/describe-domains.html
if __name__ == '__main__':
    ...
    read_no_parameter("cloudsearch", "describe-domains", add_option_dict)