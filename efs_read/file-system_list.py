...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/efs/describe-file-systems.html
if __name__ == '__main__':
    ...
    read_no_parameter("efs", "describe-file-systems", add_option_dict)