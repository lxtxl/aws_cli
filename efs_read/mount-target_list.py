...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/efs/describe-mount-targets.html
if __name__ == '__main__':
    ...
    read_no_parameter("efs", "describe-mount-targets", add_option_dict)