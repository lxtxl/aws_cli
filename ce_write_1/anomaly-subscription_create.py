...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ce/create-anomaly-subscription.html
if __name__ == '__main__':
    ...
    write_one_parameter("ce", "create-anomaly-subscription", "anomaly-subscription", add_option_dict)
