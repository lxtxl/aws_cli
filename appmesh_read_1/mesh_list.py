...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/appmesh/describe-mesh.html
if __name__ == '__main__':
    ...
    # mesh-name : The name of the service mesh to describe.
    """
    ...
    execute_one_parameter("appmesh", "describe-mesh", "mesh-name", add_option_dict)