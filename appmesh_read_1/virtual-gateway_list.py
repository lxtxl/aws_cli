...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/appmesh/list-virtual-gateways.html
if __name__ == '__main__':
    ...
    # mesh-name : The name of the service mesh to list virtual gateways in.
    """
    ...
    execute_one_parameter("appmesh", "list-virtual-gateways", "mesh-name", add_option_dict)