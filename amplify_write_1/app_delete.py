...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/amplify/delete-app.html
if __name__ == '__main__':
    ...
    write_one_parameter("amplify", "delete-app", "app-id", add_option_dict)
