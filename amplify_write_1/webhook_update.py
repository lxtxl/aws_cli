...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/amplify/update-webhook.html
if __name__ == '__main__':
    ...
    write_one_parameter("amplify", "update-webhook", "webhook-id", add_option_dict)
