...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/workmail/list-groups.html
if __name__ == '__main__':
    ...
    # organization-id : The identifier for the organization under which the groups exist.
    """
    ...
    execute_one_parameter("workmail", "list-groups", "organization-id", add_option_dict)