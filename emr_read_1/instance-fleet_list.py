...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/emr/list-instance-fleets.html
if __name__ == '__main__':
    ...
    execute_one_parameter("emr", "list-instance-fleets", "cluster-id", add_option_dict)