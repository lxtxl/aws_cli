...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/emr/describe-security-configuration.html
if __name__ == '__main__':
    ...
    execute_one_parameter("emr", "describe-security-configuration", "name", add_option_dict)