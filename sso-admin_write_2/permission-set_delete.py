...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sso-admin/delete-permission-set.html
if __name__ == '__main__':
    ...
    # permission-set-arn : The ARN of the permission set that should be deleted.
    """
    add_option_dict = {}
    add_option_dict["parameter_display_string"] = parameter_display_string
    # ex: add_option_dict["no_value_parameter_list"] = "--single-parameter"
    write_two_parameter("sso-admin", "delete-permission-set", "instance-arn", "permission-set-arn", add_option_dict)
