...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sso-admin/update-permission-set.html
if __name__ == '__main__':
    ...
    write_two_parameter("sso-admin", "update-permission-set", "instance-arn", "permission-set-arn", add_option_dict)
