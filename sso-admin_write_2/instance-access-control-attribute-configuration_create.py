...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sso-admin/create-instance-access-control-attribute-configuration.html
if __name__ == '__main__':
    ...
    write_two_parameter("sso-admin", "create-instance-access-control-attribute-configuration", "instance-arn", "instance-access-control-attribute-configuration", add_option_dict)
