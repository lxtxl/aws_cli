...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/mediastore/describe-container.html
if __name__ == '__main__':
    ...
    read_no_parameter("mediastore", "describe-container", add_option_dict)