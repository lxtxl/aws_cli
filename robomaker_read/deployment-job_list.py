...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/robomaker/list-deployment-jobs.html
if __name__ == '__main__':
    ...
    read_no_parameter("robomaker", "list-deployment-jobs", add_option_dict)