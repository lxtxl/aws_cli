...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/robomaker/list-world-generation-jobs.html
if __name__ == '__main__':
    ...
    read_no_parameter("robomaker", "list-world-generation-jobs", add_option_dict)