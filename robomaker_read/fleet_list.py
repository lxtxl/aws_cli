...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/robomaker/list-fleets.html
if __name__ == '__main__':
    ...
    read_no_parameter("robomaker", "list-fleets", add_option_dict)