...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/elbv2/describe-load-balancers.html
if __name__ == '__main__':
    ...
    read_no_parameter("elbv2", "describe-load-balancers", add_option_dict)