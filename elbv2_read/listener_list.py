...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/elbv2/describe-listeners.html
if __name__ == '__main__':
    ...
    read_no_parameter("elbv2", "describe-listeners", add_option_dict)