...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/signer/describe-signing-job.html
if __name__ == '__main__':
    ...
    # job-id : The ID of the signing job on input.
    """
    ...
    execute_one_parameter("signer", "describe-signing-job", "job-id", add_option_dict)