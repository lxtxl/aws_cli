...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/mediaconnect/list-offerings.html
if __name__ == '__main__':
    ...
    read_no_parameter("mediaconnect", "list-offerings", add_option_dict)