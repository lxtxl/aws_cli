...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/codeguru-reviewer/describe-code-review.html
if __name__ == '__main__':
    ...
    execute_one_parameter("codeguru-reviewer", "describe-code-review", "code-review-arn", add_option_dict)