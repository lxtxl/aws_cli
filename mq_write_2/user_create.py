...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/mq/create-user.html
if __name__ == '__main__':
    ...
    write_two_parameter("mq", "create-user", "broker-id", "username", add_option_dict)
