...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/mq/update-user.html
if __name__ == '__main__':
    ...
    write_two_parameter("mq", "update-user", "broker-id", "username", add_option_dict)
