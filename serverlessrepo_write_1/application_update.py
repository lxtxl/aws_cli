...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/serverlessrepo/update-application.html
if __name__ == '__main__':
    ...
    write_one_parameter("serverlessrepo", "update-application", "application-id", add_option_dict)
