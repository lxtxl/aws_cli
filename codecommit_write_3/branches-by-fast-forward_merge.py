...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/codecommit/merge-branches-by-fast-forward.html
if __name__ == '__main__':
    ...
    write_three_parameter("codecommit", "merge-branches-by-fast-forward", "repository-name", "source-commit-specifier", "destination-commit-specifier", add_option_dict)
