...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/codecommit/merge-branches-by-squash.html
if __name__ == '__main__':
    ...
    write_three_parameter("codecommit", "merge-branches-by-squash", "repository-name", "source-commit-specifier", "destination-commit-specifier", add_option_dict)
