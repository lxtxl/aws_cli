...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/greengrass/update-subscription-definition.html
if __name__ == '__main__':
    ...
    write_one_parameter("greengrass", "update-subscription-definition", "subscription-definition-id", add_option_dict)
