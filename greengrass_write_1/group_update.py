...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/greengrass/update-group.html
if __name__ == '__main__':
    ...
    write_one_parameter("greengrass", "update-group", "group-id", add_option_dict)
