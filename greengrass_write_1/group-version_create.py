...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/greengrass/create-group-version.html
if __name__ == '__main__':
    ...
    write_one_parameter("greengrass", "create-group-version", "group-id", add_option_dict)
