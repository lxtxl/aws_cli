...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/greengrass/delete-core-definition.html
if __name__ == '__main__':
    ...
    write_one_parameter("greengrass", "delete-core-definition", "core-definition-id", add_option_dict)
