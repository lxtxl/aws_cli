...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/greengrass/delete-logger-definition.html
if __name__ == '__main__':
    ...
    write_one_parameter("greengrass", "delete-logger-definition", "logger-definition-id", add_option_dict)
