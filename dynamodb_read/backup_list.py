...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/dynamodb/list-backups.html
if __name__ == '__main__':
    ...
    read_no_parameter("dynamodb", "list-backups", add_option_dict)