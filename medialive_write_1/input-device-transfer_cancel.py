...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/medialive/cancel-input-device-transfer.html
if __name__ == '__main__':
    ...
    # input-device-id : The unique ID of the input device to cancel. For example, hd-123456789abcdef.
    """
    add_option_dict = {}
    ...
    write_one_parameter("medialive", "cancel-input-device-transfer", "input-device-id", add_option_dict)
