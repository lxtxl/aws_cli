...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/medialive/update-input-security-group.html
if __name__ == '__main__':
    ...
    # input-security-group-id : The id of the Input Security Group to update.
    """
    add_option_dict = {}
    ...
    write_one_parameter("medialive", "update-input-security-group", "input-security-group-id", add_option_dict)
