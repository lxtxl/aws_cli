...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/medialive/delete-reservation.html
if __name__ == '__main__':
    ...
    write_one_parameter("medialive", "delete-reservation", "reservation-id", add_option_dict)
