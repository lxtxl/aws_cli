...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/medialive/delete-input.html
if __name__ == '__main__':
    ...
    write_one_parameter("medialive", "delete-input", "input-id", add_option_dict)
