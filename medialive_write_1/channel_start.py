...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/medialive/start-channel.html
if __name__ == '__main__':
    ...
    # channel-id : A request to start a channel
    """
    add_option_dict = {}
    ...
    write_one_parameter("medialive", "start-channel", "channel-id", add_option_dict)
