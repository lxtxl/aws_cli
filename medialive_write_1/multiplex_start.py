...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/medialive/start-multiplex.html
if __name__ == '__main__':
    ...
    write_one_parameter("medialive", "start-multiplex", "multiplex-id", add_option_dict)
