...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/medialive/delete-channel.html
if __name__ == '__main__':
    ...
    # channel-id : Unique ID of the channel.
    """
    add_option_dict = {}
    ...
    write_one_parameter("medialive", "delete-channel", "channel-id", add_option_dict)
