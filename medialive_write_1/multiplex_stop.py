...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/medialive/stop-multiplex.html
if __name__ == '__main__':
    ...
    write_one_parameter("medialive", "stop-multiplex", "multiplex-id", add_option_dict)
