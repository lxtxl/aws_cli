...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/medialive/transfer-input-device.html
if __name__ == '__main__':
    ...
    write_one_parameter("medialive", "transfer-input-device", "input-device-id", add_option_dict)
