...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/medialive/update-channel.html
if __name__ == '__main__':
    ...
    write_one_parameter("medialive", "update-channel", "channel-id", add_option_dict)
