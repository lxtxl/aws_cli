...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sqs/delete-queue.html
if __name__ == '__main__':
    ...
    # queue-url : The URL of the Amazon SQS queue to delete.
Queue URLs and names are case-sensitive.
    ...
    write_one_parameter("sqs", "delete-queue", "queue-url", add_option_dict)
