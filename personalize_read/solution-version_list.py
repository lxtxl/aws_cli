...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/personalize/list-solution-versions.html
if __name__ == '__main__':
    ...
    read_no_parameter("personalize", "list-solution-versions", add_option_dict)