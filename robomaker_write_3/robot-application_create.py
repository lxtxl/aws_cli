...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/robomaker/create-robot-application.html
...
The target processor architecture for the application.
    ...
    write_three_parameter("robomaker", "create-robot-application", "name", "sources", "robot-software-suite", add_option_dict)
