...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/alexaforbusiness/delete-gateway-group.html
if __name__ == '__main__':
    ...
    # gateway-group-arn : The ARN of the gateway group to delete.
    """
    add_option_dict = {}
    ...
    write_one_parameter("alexaforbusiness", "delete-gateway-group", "gateway-group-arn", add_option_dict)
