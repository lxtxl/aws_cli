...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/alexaforbusiness/update-contact.html
if __name__ == '__main__':
    ...
    # contact-arn : The ARN of the contact to update.
    """
    add_option_dict = {}
    ...
    write_one_parameter("alexaforbusiness", "update-contact", "contact-arn", add_option_dict)
