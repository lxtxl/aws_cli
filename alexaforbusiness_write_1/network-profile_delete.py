...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/alexaforbusiness/delete-network-profile.html
if __name__ == '__main__':
    ...
    write_one_parameter("alexaforbusiness", "delete-network-profile", "network-profile-arn", add_option_dict)
