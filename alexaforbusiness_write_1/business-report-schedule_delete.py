...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/alexaforbusiness/delete-business-report-schedule.html
if __name__ == '__main__':
    ...
    write_one_parameter("alexaforbusiness", "delete-business-report-schedule", "schedule-arn", add_option_dict)
