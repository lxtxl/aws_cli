...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/devicefarm/list-vpce-configurations.html
if __name__ == '__main__':
    ...
    read_no_parameter("devicefarm", "list-vpce-configurations", add_option_dict)