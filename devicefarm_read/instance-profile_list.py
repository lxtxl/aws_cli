...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/devicefarm/list-instance-profiles.html
if __name__ == '__main__':
    ...
    read_no_parameter("devicefarm", "list-instance-profiles", add_option_dict)