...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/waf/list-rate-based-rules.html
if __name__ == '__main__':
    ...
    read_no_parameter("waf", "list-rate-based-rules", add_option_dict)