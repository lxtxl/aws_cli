...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/waf/list-xss-match-sets.html
if __name__ == '__main__':
    ...
    read_no_parameter("waf", "list-xss-match-sets", add_option_dict)