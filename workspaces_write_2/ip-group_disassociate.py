...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/workspaces/disassociate-ip-groups.html
...
(string)
    ...
    write_two_parameter("workspaces", "disassociate-ip-groups", "directory-id", "group-ids", add_option_dict)
