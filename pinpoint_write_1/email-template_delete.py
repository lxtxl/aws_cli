...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/pinpoint/delete-email-template.html
if __name__ == '__main__':
    ...
    write_one_parameter("pinpoint", "delete-email-template", "template-name", add_option_dict)
