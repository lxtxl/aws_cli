...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/pinpoint/delete-apns-voip-channel.html
if __name__ == '__main__':
    ...
    write_one_parameter("pinpoint", "delete-apns-voip-channel", "application-id", add_option_dict)
