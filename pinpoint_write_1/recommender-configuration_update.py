...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/pinpoint/update-recommender-configuration.html
if __name__ == '__main__':
    ...
    write_one_parameter("pinpoint", "update-recommender-configuration", "recommender-id", add_option_dict)
