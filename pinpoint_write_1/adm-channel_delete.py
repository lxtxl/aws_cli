...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/pinpoint/delete-adm-channel.html
if __name__ == '__main__':
    ...
    write_one_parameter("pinpoint", "delete-adm-channel", "application-id", add_option_dict)
