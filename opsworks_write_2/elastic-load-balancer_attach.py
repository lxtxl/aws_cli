...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/opsworks/attach-elastic-load-balancer.html
if __name__ == '__main__':
    ...
    # layer-id : The ID of the layer to which the Elastic Load Balancing instance is to be attached.
    """
    add_option_dict = {}
    add_option_dict["parameter_display_string"] = parameter_display_string
    # ex: add_option_dict["no_value_parameter_list"] = "--single-parameter"
    write_two_parameter("opsworks", "attach-elastic-load-balancer", "elastic-load-balancer-name", "layer-id", add_option_dict)
