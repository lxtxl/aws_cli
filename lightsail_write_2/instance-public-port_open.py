...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/lightsail/open-instance-public-ports.html
if __name__ == '__main__':
    ...
    write_two_parameter("lightsail", "open-instance-public-ports", "port-info", "instance-name", add_option_dict)
