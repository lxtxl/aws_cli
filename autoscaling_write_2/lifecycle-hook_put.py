...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/autoscaling/put-lifecycle-hook.html
if __name__ == '__main__':
    ...
    write_two_parameter("autoscaling", "put-lifecycle-hook", "lifecycle-hook-name", "auto-scaling-group-name", add_option_dict)
