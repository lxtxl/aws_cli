...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/datasync/describe-agent.html
if __name__ == '__main__':
    ...
    # agent-arn : The Amazon Resource Name (ARN) of the agent to describe.
    """
    ...
    execute_one_parameter("datasync", "describe-agent", "agent-arn", add_option_dict)