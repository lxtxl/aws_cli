...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/kinesisanalytics/tag-resource.html
...
The value of the key-value tag. The value is optional.
    ...
    write_two_parameter("kinesisanalytics", "tag-resource", "resource-arn", "tags", add_option_dict)
