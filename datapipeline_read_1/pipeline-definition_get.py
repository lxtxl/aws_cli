...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/datapipeline/get-pipeline-definition.html
if __name__ == '__main__':
    ...
    execute_one_parameter("datapipeline", "get-pipeline-definition", "pipeline-id", add_option_dict)