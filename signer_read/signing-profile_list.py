...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/signer/list-signing-profiles.html
if __name__ == '__main__':
    ...
    read_no_parameter("signer", "list-signing-profiles", add_option_dict)