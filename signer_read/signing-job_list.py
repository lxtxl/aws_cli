...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/signer/list-signing-jobs.html
if __name__ == '__main__':
    ...
    read_no_parameter("signer", "list-signing-jobs", add_option_dict)