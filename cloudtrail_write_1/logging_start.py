...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/cloudtrail/start-logging.html
...
arn:aws:cloudtrail:us-east-2:123456789012:trail/MyTrail
    ...
    write_one_parameter("cloudtrail", "start-logging", "name", add_option_dict)
