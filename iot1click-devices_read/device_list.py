...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iot1click-devices/list-devices.html
if __name__ == '__main__':
    ...
    read_no_parameter("iot1click-devices", "list-devices", add_option_dict)