...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/kms/update-custom-key-store.html
if __name__ == '__main__':
    ...
    # custom-key-store-id : Identifies the custom key store that you want to update. Enter the ID of the custom key store. To find the ID of a custom key store, use the  DescribeCustomKeyStores operation.
    """
    add_option_dict = {}
    ...
    write_one_parameter("kms", "update-custom-key-store", "custom-key-store-id", add_option_dict)
