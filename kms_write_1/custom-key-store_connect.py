...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/kms/connect-custom-key-store.html
if __name__ == '__main__':
    ...
    # custom-key-store-id : Enter the key store ID of the custom key store that you want to connect. To find the ID of a custom key store, use the  DescribeCustomKeyStores operation.
    """
    add_option_dict = {}
    ...
    write_one_parameter("kms", "connect-custom-key-store", "custom-key-store-id", add_option_dict)
