...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/kms/enable-key-rotation.html
...
To get the key ID and key ARN for a CMK, use  ListKeys or  DescribeKey .
    ...
    write_one_parameter("kms", "enable-key-rotation", "key-id", add_option_dict)
