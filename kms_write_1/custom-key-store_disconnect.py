...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/kms/disconnect-custom-key-store.html
if __name__ == '__main__':
    ...
    # custom-key-store-id : Enter the ID of the custom key store you want to disconnect. To find the ID of a custom key store, use the  DescribeCustomKeyStores operation.
    """
    add_option_dict = {}
    ...
    write_one_parameter("kms", "disconnect-custom-key-store", "custom-key-store-id", add_option_dict)
