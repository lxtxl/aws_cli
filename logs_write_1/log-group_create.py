...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/logs/create-log-group.html
if __name__ == '__main__':
    ...
    write_one_parameter("logs", "create-log-group", "log-group-name", add_option_dict)
