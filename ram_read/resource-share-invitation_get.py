...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ram/get-resource-share-invitations.html
if __name__ == '__main__':
    ...
    read_no_parameter("ram", "get-resource-share-invitations", add_option_dict)