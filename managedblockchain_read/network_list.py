...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/managedblockchain/list-networks.html
if __name__ == '__main__':
    ...
    read_no_parameter("managedblockchain", "list-networks", add_option_dict)