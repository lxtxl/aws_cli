...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ecs/put-account-setting.html
...
containerInsights
    ...
    write_two_parameter("ecs", "put-account-setting", "name", "value", add_option_dict)
