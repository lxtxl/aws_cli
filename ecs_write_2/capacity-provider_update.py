...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ecs/update-capacity-provider.html
if __name__ == '__main__':
    ...
    write_two_parameter("ecs", "update-capacity-provider", "name", "auto-scaling-group-provider", add_option_dict)
