...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/deploy/create-application.html
if __name__ == '__main__':
    ...
    # application-name : The name of the application. This name must be unique with the applicable IAM user or AWS account.
    """
    add_option_dict = {}
    ...
    write_one_parameter("deploy", "create-application", "application-name", add_option_dict)
