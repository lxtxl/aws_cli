...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/deploy/delete-deployment-config.html
if __name__ == '__main__':
    ...
    write_one_parameter("deploy", "delete-deployment-config", "deployment-config-name", add_option_dict)
