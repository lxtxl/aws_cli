...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/mediapackage-vod/delete-packaging-configuration.html
if __name__ == '__main__':
    ...
    write_one_parameter("mediapackage-vod", "delete-packaging-configuration", "id", add_option_dict)
