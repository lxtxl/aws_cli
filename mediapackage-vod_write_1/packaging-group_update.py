...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/mediapackage-vod/update-packaging-group.html
if __name__ == '__main__':
    ...
    write_one_parameter("mediapackage-vod", "update-packaging-group", "id", add_option_dict)
