...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iot/list-audit-mitigation-actions-tasks.html
if __name__ == '__main__':
    ...
    execute_two_parameter("iot", "list-audit-mitigation-actions-tasks", "start-time", "end-time", parameter_display_string)