...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/waf-regional/delete-permission-policy.html
...
The user making the request must be the owner of the RuleGroup.
    ...
    write_one_parameter("waf-regional", "delete-permission-policy", "resource-arn", add_option_dict)
