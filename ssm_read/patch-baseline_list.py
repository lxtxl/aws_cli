...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ssm/describe-patch-baselines.html
if __name__ == '__main__':
    ...
    read_no_parameter("ssm", "describe-patch-baselines", add_option_dict)