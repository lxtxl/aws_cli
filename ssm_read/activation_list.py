...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ssm/describe-activations.html
if __name__ == '__main__':
    ...
    read_no_parameter("ssm", "describe-activations", add_option_dict)