...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/codeartifact/list-domains.html
if __name__ == '__main__':
    ...
    read_no_parameter("codeartifact", "list-domains", add_option_dict)