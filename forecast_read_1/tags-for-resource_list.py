...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/forecast/list-tags-for-resource.html
if __name__ == '__main__':
    ...
    execute_one_parameter("forecast", "list-tags-for-resource", "resource-arn", add_option_dict)