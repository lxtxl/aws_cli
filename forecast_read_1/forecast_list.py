...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/forecast/describe-forecast.html
if __name__ == '__main__':
    ...
    # forecast-arn : The Amazon Resource Name (ARN) of the forecast.
    """
    ...
    execute_one_parameter("forecast", "describe-forecast", "forecast-arn", add_option_dict)