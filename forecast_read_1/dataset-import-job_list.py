...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/forecast/describe-dataset-import-job.html
if __name__ == '__main__':
    ...
    # dataset-import-job-arn : The Amazon Resource Name (ARN) of the dataset import job.
    """
    ...
    execute_one_parameter("forecast", "describe-dataset-import-job", "dataset-import-job-arn", add_option_dict)