...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/forecast/describe-dataset-group.html
if __name__ == '__main__':
    ...
    # dataset-group-arn : The Amazon Resource Name (ARN) of the dataset group.
    """
    ...
    execute_one_parameter("forecast", "describe-dataset-group", "dataset-group-arn", add_option_dict)