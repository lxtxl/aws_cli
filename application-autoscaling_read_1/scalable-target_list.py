...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/application-autoscaling/describe-scalable-targets.html
...
kafka
    ...
    execute_one_parameter("application-autoscaling", "describe-scalable-targets", "service-namespace", add_option_dict)