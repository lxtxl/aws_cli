...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/logs/describe-queries.html
if __name__ == '__main__':
    ...
    read_no_parameter("logs", "describe-queries", add_option_dict)