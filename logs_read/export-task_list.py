...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/logs/describe-export-tasks.html
if __name__ == '__main__':
    ...
    read_no_parameter("logs", "describe-export-tasks", add_option_dict)