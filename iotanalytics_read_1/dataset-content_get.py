...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iotanalytics/get-dataset-content.html
if __name__ == '__main__':
    ...
    # dataset-name : The name of the data set whose contents are retrieved.
    """
    ...
    execute_one_parameter("iotanalytics", "get-dataset-content", "dataset-name", add_option_dict)