...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sts/get-access-key-info.html
...
This parameter allows (through its regex pattern) a string of characters that can consist of any upper- or lowercase letter or digit.
    ...
    execute_one_parameter("sts", "get-access-key-info", "access-key-id", add_option_dict)