...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/directconnect/update-lag.html
if __name__ == '__main__':
    ...
    write_one_parameter("directconnect", "update-lag", "lag-id", add_option_dict)
