...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/directconnect/confirm-public-virtual-interface.html
if __name__ == '__main__':
    ...
    write_one_parameter("directconnect", "confirm-public-virtual-interface", "virtual-interface-id", add_option_dict)
