...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/directconnect/delete-direct-connect-gateway.html
if __name__ == '__main__':
    ...
    write_one_parameter("directconnect", "delete-direct-connect-gateway", "direct-connect-gateway-id", add_option_dict)
