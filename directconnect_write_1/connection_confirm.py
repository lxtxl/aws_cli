...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/directconnect/confirm-connection.html
if __name__ == '__main__':
    ...
    write_one_parameter("directconnect", "confirm-connection", "connection-id", add_option_dict)
