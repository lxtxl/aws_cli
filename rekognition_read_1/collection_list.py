...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/rekognition/describe-collection.html
if __name__ == '__main__':
    ...
    # collection-id : The ID of the collection to describe.
    """
    ...
    execute_one_parameter("rekognition", "describe-collection", "collection-id", add_option_dict)