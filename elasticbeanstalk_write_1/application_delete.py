...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/elasticbeanstalk/delete-application.html
if __name__ == '__main__':
    ...
    write_one_parameter("elasticbeanstalk", "delete-application", "application-name", add_option_dict)
