...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/acm/describe-certificate.html
if __name__ == '__main__':
    ...
    # certificate-arn : The Amazon Resource Name (ARN) of the ACM certificate. The ARN must have the following form:
...
For more information about ARNs, see Amazon Resource Names (ARNs) and AWS Service Namespaces .
    ...
    execute_one_parameter("acm", "describe-certificate", "certificate-arn", add_option_dict)