...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/guardduty/delete-publishing-destination.html
if __name__ == '__main__':
    ...
    # detector-id : The unique ID of the detector associated with the publishing destination to delete.
    # destination-id : The ID of the publishing destination to delete.
    """
    add_option_dict = {}
    add_option_dict["parameter_display_string"] = parameter_display_string
    # ex: add_option_dict["no_value_parameter_list"] = "--single-parameter"
    write_two_parameter("guardduty", "delete-publishing-destination", "detector-id", "destination-id", add_option_dict)
