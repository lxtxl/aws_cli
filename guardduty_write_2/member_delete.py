...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/guardduty/delete-members.html
if __name__ == '__main__':
    ...
    # detector-id : The unique ID of the detector of the GuardDuty account whose members you want to delete.
    # account-ids : A list of account IDs of the GuardDuty member accounts that you want to delete.
(string)
    """
    add_option_dict = {}
    add_option_dict["parameter_display_string"] = parameter_display_string
    # ex: add_option_dict["no_value_parameter_list"] = "--single-parameter"
    write_two_parameter("guardduty", "delete-members", "detector-id", "account-ids", add_option_dict)
