...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/elb/create-lb-cookie-stickiness-policy.html
if __name__ == '__main__':
    ...
    write_two_parameter("elb", "create-lb-cookie-stickiness-policy", "load-balancer-name", "policy-name", add_option_dict)
