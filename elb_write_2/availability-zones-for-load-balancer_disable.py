...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/elb/disable-availability-zones-for-load-balancer.html
...
(string)
    ...
    write_two_parameter("elb", "disable-availability-zones-for-load-balancer", "load-balancer-name", "availability-zones", add_option_dict)
