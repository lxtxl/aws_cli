...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iot/describe-scheduled-audit.html
if __name__ == '__main__':
    ...
    # scheduled-audit-name : The name of the scheduled audit whose information you want to get.
    """
    ...
    execute_one_parameter("iot", "describe-scheduled-audit", "scheduled-audit-name", add_option_dict)