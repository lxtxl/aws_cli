...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iot/describe-thing.html
if __name__ == '__main__':
    ...
    execute_one_parameter("iot", "describe-thing", "thing-name", add_option_dict)