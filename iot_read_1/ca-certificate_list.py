...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iot/describe-ca-certificate.html
if __name__ == '__main__':
    ...
    execute_one_parameter("iot", "describe-ca-certificate", "certificate-id", add_option_dict)