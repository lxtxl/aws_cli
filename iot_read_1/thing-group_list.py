...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iot/describe-thing-group.html
if __name__ == '__main__':
    ...
    # thing-group-name : The name of the thing group.
    """
    ...
    execute_one_parameter("iot", "describe-thing-group", "thing-group-name", add_option_dict)