...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/glacier/abort-multipart-upload.html
if __name__ == '__main__':
    ...
    # upload-id : The upload ID of the multipart upload to delete.
    """
    add_option_dict = {}
    add_option_dict["parameter_display_string"] = parameter_display_string
    # ex: add_option_dict["no_value_parameter_list"] = "--single-parameter"
    write_three_parameter("glacier", "abort-multipart-upload", "account-id", "vault-name", "upload-id", add_option_dict)
