...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/glacier/upload-multipart-part.html
if __name__ == '__main__':
    ...
    write_three_parameter("glacier", "upload-multipart-part", "account-id", "vault-name", "upload-id", add_option_dict)
