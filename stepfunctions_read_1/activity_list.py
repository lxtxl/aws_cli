...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/stepfunctions/describe-activity.html
if __name__ == '__main__':
    ...
    # activity-arn : The Amazon Resource Name (ARN) of the activity to describe.
    """
    ...
    execute_one_parameter("stepfunctions", "describe-activity", "activity-arn", add_option_dict)