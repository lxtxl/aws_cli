...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/codeguruprofiler/delete-profiling-group.html
if __name__ == '__main__':
    ...
    # profiling-group-name : The name of the profiling group to delete.
    """
    add_option_dict = {}
    ...
    write_one_parameter("codeguruprofiler", "delete-profiling-group", "profiling-group-name", add_option_dict)
