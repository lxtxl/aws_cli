...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/cloud9/list-environments.html
if __name__ == '__main__':
    ...
    read_no_parameter("cloud9", "list-environments", add_option_dict)