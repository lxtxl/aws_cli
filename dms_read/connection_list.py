...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/dms/describe-connections.html
if __name__ == '__main__':
    ...
    read_no_parameter("dms", "describe-connections", add_option_dict)