...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/dms/describe-endpoints.html
if __name__ == '__main__':
    ...
    read_no_parameter("dms", "describe-endpoints", add_option_dict)