...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/cloudtrail/get-event-selectors.html
...
arn:aws:cloudtrail:us-east-2:123456789012:trail/MyTrail
    ...
    execute_one_parameter("cloudtrail", "get-event-selectors", "trail-name", add_option_dict)