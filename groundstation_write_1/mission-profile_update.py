...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/groundstation/update-mission-profile.html
if __name__ == '__main__':
    ...
    write_one_parameter("groundstation", "update-mission-profile", "mission-profile-id", add_option_dict)
