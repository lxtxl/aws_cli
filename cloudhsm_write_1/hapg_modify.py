...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/cloudhsm/modify-hapg.html
if __name__ == '__main__':
    ...
    # hapg-arn : The ARN of the high-availability partition group to modify.
    """
    add_option_dict = {}
    ...
    write_one_parameter("cloudhsm", "modify-hapg", "hapg-arn", add_option_dict)
