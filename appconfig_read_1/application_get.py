...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/appconfig/get-application.html
if __name__ == '__main__':
    ...
    # application-id : The ID of the application you want to get.
    """
    ...
    execute_one_parameter("appconfig", "get-application", "application-id", add_option_dict)