...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/appconfig/list-environments.html
if __name__ == '__main__':
    ...
    execute_one_parameter("appconfig", "list-environments", "application-id", add_option_dict)