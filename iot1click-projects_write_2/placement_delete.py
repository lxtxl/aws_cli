...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iot1click-projects/delete-placement.html
if __name__ == '__main__':
    ...
    # placement-name : The name of the empty placement to delete.
    # project-name : The project containing the empty placement to delete.
    """
    add_option_dict = {}
    add_option_dict["parameter_display_string"] = parameter_display_string
    # ex: add_option_dict["no_value_parameter_list"] = "--single-parameter"
    write_two_parameter("iot1click-projects", "delete-placement", "placement-name", "project-name", add_option_dict)
