...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/rds-data/rollback-transaction.html
if __name__ == '__main__':
    ...
    # transaction-id : The identifier of the transaction to roll back.
    """
    add_option_dict = {}
    add_option_dict["parameter_display_string"] = parameter_display_string
    # ex: add_option_dict["no_value_parameter_list"] = "--single-parameter"
    write_three_parameter("rds-data", "rollback-transaction", "resource-arn", "secret-arn", "transaction-id", add_option_dict)
