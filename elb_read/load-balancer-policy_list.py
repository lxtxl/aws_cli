...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/elb/describe-load-balancer-policies.html
if __name__ == '__main__':
    ...
    read_no_parameter("elb", "describe-load-balancer-policies", add_option_dict)