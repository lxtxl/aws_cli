...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/elb/describe-load-balancers.html
if __name__ == '__main__':
    ...
    read_no_parameter("elb", "describe-load-balancers", add_option_dict)