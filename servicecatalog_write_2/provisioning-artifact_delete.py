...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/servicecatalog/delete-provisioning-artifact.html
if __name__ == '__main__':
    ...
    write_two_parameter("servicecatalog", "delete-provisioning-artifact", "product-id", "provisioning-artifact-id", add_option_dict)
