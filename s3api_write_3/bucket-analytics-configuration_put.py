...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/s3api/put-bucket-analytics-configuration.html
if __name__ == '__main__':
    ...
    write_three_parameter("s3api", "put-bucket-analytics-configuration", "bucket", "id", "analytics-configuration", add_option_dict)
