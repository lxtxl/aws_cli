...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/mediapackage-vod/describe-packaging-configuration.html
if __name__ == '__main__':
    ...
    execute_one_parameter("mediapackage-vod", "describe-packaging-configuration", "id", add_option_dict)