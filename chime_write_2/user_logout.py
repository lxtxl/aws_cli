...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/chime/logout-user.html
if __name__ == '__main__':
    ...
    write_two_parameter("chime", "logout-user", "account-id", "user-id", add_option_dict)
