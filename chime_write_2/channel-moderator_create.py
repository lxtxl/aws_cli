...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/chime/create-channel-moderator.html
if __name__ == '__main__':
    ...
    # channel-moderator-arn : The ARN of the moderator.
    """
    add_option_dict = {}
    add_option_dict["parameter_display_string"] = parameter_display_string
    # ex: add_option_dict["no_value_parameter_list"] = "--single-parameter"
    write_two_parameter("chime", "create-channel-moderator", "channel-arn", "channel-moderator-arn", add_option_dict)
