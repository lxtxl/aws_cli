...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/chime/create-room.html
if __name__ == '__main__':
    ...
    write_two_parameter("chime", "create-room", "account-id", "name", add_option_dict)
