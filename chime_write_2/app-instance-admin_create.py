...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/chime/create-app-instance-admin.html
if __name__ == '__main__':
    ...
    # app-instance-admin-arn : The ARN of the administrator of the current app instance.
    # app-instance-arn : The ARN of the app instance.
    """
    add_option_dict = {}
    add_option_dict["parameter_display_string"] = parameter_display_string
    # ex: add_option_dict["no_value_parameter_list"] = "--single-parameter"
    write_two_parameter("chime", "create-app-instance-admin", "app-instance-admin-arn", "app-instance-arn", add_option_dict)
