...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/chime/delete-events-configuration.html
if __name__ == '__main__':
    ...
    write_two_parameter("chime", "delete-events-configuration", "account-id", "bot-id", add_option_dict)
