...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/translate/list-text-translation-jobs.html
if __name__ == '__main__':
    ...
    read_no_parameter("translate", "list-text-translation-jobs", add_option_dict)