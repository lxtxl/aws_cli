...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/pinpoint-sms-voice/update-configuration-set-event-destination.html
if __name__ == '__main__':
    ...
    write_two_parameter("pinpoint-sms-voice", "update-configuration-set-event-destination", "configuration-set-name", "event-destination-name", add_option_dict)
