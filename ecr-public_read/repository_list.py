...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ecr-public/describe-repositories.html
if __name__ == '__main__':
    ...
    read_no_parameter("ecr-public", "describe-repositories", add_option_dict)