...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sns/create-platform-endpoint.html
if __name__ == '__main__':
    ...
    # platform-application-arn : PlatformApplicationArn returned from CreatePlatformApplication is used to create a an endpoint.
    ...
    write_two_parameter("sns", "create-platform-endpoint", "platform-application-arn", "token", add_option_dict)
