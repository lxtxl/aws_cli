...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ecr/batch-delete-image.html
...
The tag used for the image.
    ...
    write_two_parameter("ecr", "batch-delete-image", "repository-name", "image-ids", add_option_dict)
