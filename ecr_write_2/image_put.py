...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ecr/put-image.html
if __name__ == '__main__':
    ...
    write_two_parameter("ecr", "put-image", "repository-name", "image-manifest", add_option_dict)
