...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/redshift-data/get-statement-result.html
if __name__ == '__main__':
    ...
    execute_one_parameter("redshift-data", "get-statement-result", "id", add_option_dict)