...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/redshift-data/describe-table.html
if __name__ == '__main__':
    ...
    execute_one_parameter("redshift-data", "describe-table", "cluster-identifier", add_option_dict)