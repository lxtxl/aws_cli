...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/modify-transit-gateway-prefix-list-reference.html
if __name__ == '__main__':
    ...
    write_two_parameter("ec2", "modify-transit-gateway-prefix-list-reference", "transit-gateway-route-table-id", "prefix-list-id", add_option_dict)
