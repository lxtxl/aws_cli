...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/create-transit-gateway-route.html
if __name__ == '__main__':
    ...
    write_two_parameter("ec2", "create-transit-gateway-route", "destination-cidr-block", "transit-gateway-route-table-id", add_option_dict)
