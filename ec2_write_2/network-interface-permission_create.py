...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/create-network-interface-permission.html
...
EIP-ASSOCIATE
    ...
    write_two_parameter("ec2", "create-network-interface-permission", "network-interface-id", "permission", add_option_dict)
