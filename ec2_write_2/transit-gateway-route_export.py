...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/export-transit-gateway-routes.html
if __name__ == '__main__':
    ...
    write_two_parameter("ec2", "export-transit-gateway-routes", "transit-gateway-route-table-id", "s3-bucket", add_option_dict)
