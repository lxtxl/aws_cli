...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/detach-vpn-gateway.html
if __name__ == '__main__':
    ...
    write_two_parameter("ec2", "detach-vpn-gateway", "vpc-id", "vpn-gateway-id", add_option_dict)
