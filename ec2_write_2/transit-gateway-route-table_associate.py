...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/associate-transit-gateway-route-table.html
if __name__ == '__main__':
    ...
    write_two_parameter("ec2", "associate-transit-gateway-route-table", "transit-gateway-route-table-id", "transit-gateway-attachment-id", add_option_dict)
