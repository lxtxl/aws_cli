...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/disable-fast-snapshot-restores.html
...
(string)
    # source-snapshot-ids : The IDs of one or more snapshots. For example, snap-1234567890abcdef0 .
(string)
    """
    add_option_dict = {}
    add_option_dict["parameter_display_string"] = parameter_display_string
    # ex: add_option_dict["no_value_parameter_list"] = "--single-parameter"
    write_two_parameter("ec2", "disable-fast-snapshot-restores", "availability-zones", "source-snapshot-ids", add_option_dict)
