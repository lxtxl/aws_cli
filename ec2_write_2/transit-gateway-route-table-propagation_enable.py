...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/enable-transit-gateway-route-table-propagation.html
if __name__ == '__main__':
    ...
    write_two_parameter("ec2", "enable-transit-gateway-route-table-propagation", "transit-gateway-route-table-id", "transit-gateway-attachment-id", add_option_dict)
