...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/detach-internet-gateway.html
if __name__ == '__main__':
    ...
    write_two_parameter("ec2", "detach-internet-gateway", "internet-gateway-id", "vpc-id", add_option_dict)
