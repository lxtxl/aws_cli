...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/importexport/list-jobs.html
if __name__ == '__main__':
    ...
    read_no_parameter("importexport", "list-jobs", add_option_dict)