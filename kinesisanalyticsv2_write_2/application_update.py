...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/kinesisanalyticsv2/update-application.html
if __name__ == '__main__':
    ...
    write_two_parameter("kinesisanalyticsv2", "update-application", "application-name", "current-application-version-id", add_option_dict)
