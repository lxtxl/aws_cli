...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/kinesisanalyticsv2/delete-application.html
if __name__ == '__main__':
    ...
    write_two_parameter("kinesisanalyticsv2", "delete-application", "application-name", "create-timestamp", add_option_dict)
