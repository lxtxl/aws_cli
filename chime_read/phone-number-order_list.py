...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/chime/list-phone-number-orders.html
if __name__ == '__main__':
    ...
    read_no_parameter("chime", "list-phone-number-orders", add_option_dict)