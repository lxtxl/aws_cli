...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ecs/delete-service.html
if __name__ == '__main__':
    ...
    write_one_parameter("ecs", "delete-service", "service", add_option_dict)
