...
if __name__ == '__main__':
    ...
    # ip : The IP address that you want to obtain more information about. The value you specify has to be a dedicated IP address thatâs assocaited with your AWS account.
    """
