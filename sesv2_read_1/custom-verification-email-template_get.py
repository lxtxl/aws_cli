...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sesv2/get-custom-verification-email-template.html
if __name__ == '__main__':
    ...
    execute_one_parameter("sesv2", "get-custom-verification-email-template", "template-name", add_option_dict)