...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sesv2/get-email-identity.html
if __name__ == '__main__':
    ...
    execute_one_parameter("sesv2", "get-email-identity", "email-identity", add_option_dict)