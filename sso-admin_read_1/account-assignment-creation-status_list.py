...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sso-admin/list-account-assignment-creation-status.html
if __name__ == '__main__':
    ...
    execute_one_parameter("sso-admin", "list-account-assignment-creation-status", "instance-arn", add_option_dict)