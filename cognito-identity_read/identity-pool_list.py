...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/cognito-identity/list-identity-pools.html
if __name__ == '__main__':
    ...
    read_no_parameter("cognito-identity", "list-identity-pools", add_option_dict)