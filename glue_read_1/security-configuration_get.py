...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/glue/get-security-configuration.html
if __name__ == '__main__':
    ...
    execute_one_parameter("glue", "get-security-configuration", "name", add_option_dict)