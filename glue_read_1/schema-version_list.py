...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/glue/list-schema-versions.html
if __name__ == '__main__':
    ...
    execute_one_parameter("glue", "list-schema-versions", "schema-id", add_option_dict)