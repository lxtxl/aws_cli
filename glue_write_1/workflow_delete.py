...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/glue/delete-workflow.html
if __name__ == '__main__':
    ...
    write_one_parameter("glue", "delete-workflow", "name", add_option_dict)
