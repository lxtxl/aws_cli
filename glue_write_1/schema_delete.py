...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/glue/delete-schema.html
if __name__ == '__main__':
    ...
    write_one_parameter("glue", "delete-schema", "schema-id", add_option_dict)
