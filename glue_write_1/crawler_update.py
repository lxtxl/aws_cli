...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/glue/update-crawler.html
if __name__ == '__main__':
    ...
    write_one_parameter("glue", "update-crawler", "name", add_option_dict)
