...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/glue/start-crawler.html
if __name__ == '__main__':
    ...
    write_one_parameter("glue", "start-crawler", "name", add_option_dict)
