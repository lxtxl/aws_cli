...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/glue/remove-schema-version-metadata.html
if __name__ == '__main__':
    ...
    write_one_parameter("glue", "remove-schema-version-metadata", "metadata-key-value", add_option_dict)
