...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/glue/delete-connection.html
if __name__ == '__main__':
    ...
    # connection-name : The name of the connection to delete.
    """
    add_option_dict = {}
    ...
    write_one_parameter("glue", "delete-connection", "connection-name", add_option_dict)
