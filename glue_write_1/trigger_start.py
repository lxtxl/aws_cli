...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/glue/start-trigger.html
if __name__ == '__main__':
    ...
    write_one_parameter("glue", "start-trigger", "name", add_option_dict)
