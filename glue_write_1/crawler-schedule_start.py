...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/glue/start-crawler-schedule.html
if __name__ == '__main__':
    ...
    # crawler-name : Name of the crawler to schedule.
    """
    add_option_dict = {}
    ...
    write_one_parameter("glue", "start-crawler-schedule", "crawler-name", add_option_dict)
