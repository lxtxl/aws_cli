...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/glue/delete-database.html
if __name__ == '__main__':
    ...
    write_one_parameter("glue", "delete-database", "name", add_option_dict)
