...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/glue/create-workflow.html
if __name__ == '__main__':
    ...
    write_one_parameter("glue", "create-workflow", "name", add_option_dict)
