...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/glue/stop-crawler-schedule.html
if __name__ == '__main__':
    ...
    # crawler-name : Name of the crawler whose schedule state to set.
    """
    add_option_dict = {}
    ...
    write_one_parameter("glue", "stop-crawler-schedule", "crawler-name", add_option_dict)
