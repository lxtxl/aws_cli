...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/glue/update-dev-endpoint.html
if __name__ == '__main__':
    ...
    # endpoint-name : The name of the DevEndpoint to be updated.
    """
    add_option_dict = {}
    ...
    write_one_parameter("glue", "update-dev-endpoint", "endpoint-name", add_option_dict)
