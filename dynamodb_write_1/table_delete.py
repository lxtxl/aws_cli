...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/dynamodb/delete-table.html
if __name__ == '__main__':
    ...
    write_one_parameter("dynamodb", "delete-table", "table-name", add_option_dict)
