...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/waf-regional/list-regex-match-sets.html
if __name__ == '__main__':
    ...
    read_no_parameter("waf-regional", "list-regex-match-sets", add_option_dict)