...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/route53resolver/delete-resolver-query-log-config.html
if __name__ == '__main__':
    ...
    # resolver-query-log-config-id : The ID of the query logging configuration that you want to delete.
    """
    add_option_dict = {}
    ...
    write_one_parameter("route53resolver", "delete-resolver-query-log-config", "resolver-query-log-config-id", add_option_dict)
