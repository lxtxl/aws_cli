...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/route53resolver/delete-resolver-endpoint.html
if __name__ == '__main__':
    ...
    # resolver-endpoint-id : The ID of the Resolver endpoint that you want to delete.
    """
    add_option_dict = {}
    ...
    write_one_parameter("route53resolver", "delete-resolver-endpoint", "resolver-endpoint-id", add_option_dict)
