...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/devops-guru/list-notification-channels.html
if __name__ == '__main__':
    ...
    read_no_parameter("devops-guru", "list-notification-channels", add_option_dict)