...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/robomaker/register-robot.html
if __name__ == '__main__':
    ...
    write_two_parameter("robomaker", "register-robot", "fleet", "robot", add_option_dict)
