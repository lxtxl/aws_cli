...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/appmesh/update-mesh.html
if __name__ == '__main__':
    ...
    # mesh-name : The name of the service mesh to update.
    """
    add_option_dict = {}
    ...
    write_one_parameter("appmesh", "update-mesh", "mesh-name", add_option_dict)
