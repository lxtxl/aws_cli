...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/cloudfront/list-field-level-encryption-configs.html
if __name__ == '__main__':
    ...
    read_no_parameter("cloudfront", "list-field-level-encryption-configs", add_option_dict)