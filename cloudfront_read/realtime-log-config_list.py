...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/cloudfront/list-realtime-log-configs.html
if __name__ == '__main__':
    ...
    read_no_parameter("cloudfront", "list-realtime-log-configs", add_option_dict)