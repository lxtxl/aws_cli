...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/cloudfront/list-public-keys.html
if __name__ == '__main__':
    ...
    read_no_parameter("cloudfront", "list-public-keys", add_option_dict)