...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/cloudfront/list-distributions.html
if __name__ == '__main__':
    ...
    read_no_parameter("cloudfront", "list-distributions", add_option_dict)