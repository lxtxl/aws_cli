...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/es/reject-inbound-cross-cluster-search-connection.html
if __name__ == '__main__':
    ...
    # cross-cluster-search-connection-id : The id of the inbound connection that you want to reject.
    """
    add_option_dict = {}
    ...
    write_one_parameter("es", "reject-inbound-cross-cluster-search-connection", "cross-cluster-search-connection-id", add_option_dict)
