...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/route53/get-change.html
if __name__ == '__main__':
    ...
    execute_one_parameter("route53", "get-change", "id", add_option_dict)