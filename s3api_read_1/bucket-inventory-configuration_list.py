...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/s3api/list-bucket-inventory-configurations.html
if __name__ == '__main__':
    ...
    execute_one_parameter("s3api", "list-bucket-inventory-configurations", "bucket", add_option_dict)