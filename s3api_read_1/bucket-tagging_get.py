...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/s3api/get-bucket-tagging.html
if __name__ == '__main__':
    ...
    execute_one_parameter("s3api", "get-bucket-tagging", "bucket", add_option_dict)