...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/application-insights/list-components.html
if __name__ == '__main__':
    ...
    execute_one_parameter("application-insights", "list-components", "resource-group-name", add_option_dict)