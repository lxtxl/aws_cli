...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sagemaker/delete-association.html
if __name__ == '__main__':
    ...
    write_two_parameter("sagemaker", "delete-association", "source-arn", "destination-arn", add_option_dict)
