...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sagemaker/delete-user-profile.html
if __name__ == '__main__':
    ...
    write_two_parameter("sagemaker", "delete-user-profile", "domain-id", "user-profile-name", add_option_dict)
