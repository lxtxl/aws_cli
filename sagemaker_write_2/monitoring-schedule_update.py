...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sagemaker/update-monitoring-schedule.html
if __name__ == '__main__':
    ...
    write_two_parameter("sagemaker", "update-monitoring-schedule", "monitoring-schedule-name", "monitoring-schedule-config", add_option_dict)
