...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/workspaces/describe-workspace-directories.html
if __name__ == '__main__':
    ...
    read_no_parameter("workspaces", "describe-workspace-directories", add_option_dict)