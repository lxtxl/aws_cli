...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/workspaces/describe-ip-groups.html
if __name__ == '__main__':
    ...
    read_no_parameter("workspaces", "describe-ip-groups", add_option_dict)