...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/devicefarm/delete-test-grid-project.html
if __name__ == '__main__':
    ...
    # project-arn : The ARN of the project to delete, from  CreateTestGridProject or  ListTestGridProjects .
    """
    add_option_dict = {}
    ...
    write_one_parameter("devicefarm", "delete-test-grid-project", "project-arn", add_option_dict)
