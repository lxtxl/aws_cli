...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/devicefarm/delete-upload.html
if __name__ == '__main__':
    ...
    write_one_parameter("devicefarm", "delete-upload", "arn", add_option_dict)
