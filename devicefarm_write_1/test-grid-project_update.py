...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/devicefarm/update-test-grid-project.html
if __name__ == '__main__':
    ...
    # project-arn : ARN of the project to update.
    """
    add_option_dict = {}
    ...
    write_one_parameter("devicefarm", "update-test-grid-project", "project-arn", add_option_dict)
