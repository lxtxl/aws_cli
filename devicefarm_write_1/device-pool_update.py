...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/devicefarm/update-device-pool.html
if __name__ == '__main__':
    ...
    write_one_parameter("devicefarm", "update-device-pool", "arn", add_option_dict)
