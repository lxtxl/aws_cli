...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/devicefarm/delete-remote-access-session.html
if __name__ == '__main__':
    ...
    write_one_parameter("devicefarm", "delete-remote-access-session", "arn", add_option_dict)
