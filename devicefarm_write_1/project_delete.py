...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/devicefarm/delete-project.html
if __name__ == '__main__':
    ...
    write_one_parameter("devicefarm", "delete-project", "arn", add_option_dict)
