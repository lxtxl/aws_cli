...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/devicefarm/delete-instance-profile.html
if __name__ == '__main__':
    ...
    write_one_parameter("devicefarm", "delete-instance-profile", "arn", add_option_dict)
