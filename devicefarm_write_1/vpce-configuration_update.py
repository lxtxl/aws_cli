...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/devicefarm/update-vpce-configuration.html
if __name__ == '__main__':
    ...
    write_one_parameter("devicefarm", "update-vpce-configuration", "arn", add_option_dict)
