...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/appflow/stop-flow.html
if __name__ == '__main__':
    ...
    write_one_parameter("appflow", "stop-flow", "flow-name", add_option_dict)
