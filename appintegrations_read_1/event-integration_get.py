...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/appintegrations/get-event-integration.html
if __name__ == '__main__':
    ...
    execute_one_parameter("appintegrations", "get-event-integration", "name", add_option_dict)