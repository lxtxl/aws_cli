...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ses/create-receipt-rule-set.html
...
Contain less than 64 characters.
    ...
    write_one_parameter("ses", "create-receipt-rule-set", "rule-set-name", add_option_dict)
