...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ses/delete-custom-verification-email-template.html
if __name__ == '__main__':
    ...
    write_one_parameter("ses", "delete-custom-verification-email-template", "template-name", add_option_dict)
