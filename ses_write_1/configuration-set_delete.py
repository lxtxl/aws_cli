...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ses/delete-configuration-set.html
if __name__ == '__main__':
    ...
    # configuration-set-name : The name of the configuration set to delete.
    """
    add_option_dict = {}
    ...
    write_one_parameter("ses", "delete-configuration-set", "configuration-set-name", add_option_dict)
