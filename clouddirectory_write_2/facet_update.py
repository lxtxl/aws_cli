...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/clouddirectory/update-facet.html
if __name__ == '__main__':
    ...
    write_two_parameter("clouddirectory", "update-facet", "schema-arn", "name", add_option_dict)
