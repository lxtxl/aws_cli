...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/comprehend/list-sentiment-detection-jobs.html
if __name__ == '__main__':
    ...
    read_no_parameter("comprehend", "list-sentiment-detection-jobs", add_option_dict)