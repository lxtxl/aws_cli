...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/configservice/put-aggregation-authorization.html
if __name__ == '__main__':
    ...
    write_two_parameter("configservice", "put-aggregation-authorization", "authorized-account-id", "authorized-aws-region", add_option_dict)
