...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/configservice/put-remediation-exceptions.html
if __name__ == '__main__':
    ...
    # config-rule-name : The name of the AWS Config rule for which you want to create remediation exception.
...
The ID of the resource (for example., sg-xxxxxx).
    ...
    write_two_parameter("configservice", "put-remediation-exceptions", "config-rule-name", "resource-keys", add_option_dict)
