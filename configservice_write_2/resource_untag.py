...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/configservice/untag-resource.html
...
(string)
    ...
    write_two_parameter("configservice", "untag-resource", "resource-arn", "tag-keys", add_option_dict)
