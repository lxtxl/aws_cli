...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/configservice/tag-resource.html
...
The optional part of a key-value pair that make up a tag. A value acts as a descriptor within a tag category (key).
    ...
    write_two_parameter("configservice", "tag-resource", "resource-arn", "tags", add_option_dict)
