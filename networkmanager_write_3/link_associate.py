...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/networkmanager/associate-link.html
if __name__ == '__main__':
    ...
    write_three_parameter("networkmanager", "associate-link", "global-network-id", "device-id", "link-id", add_option_dict)
