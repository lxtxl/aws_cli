...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/storagegateway/describe-working-storage.html
if __name__ == '__main__':
    ...
    execute_one_parameter("storagegateway", "describe-working-storage", "gateway-arn", add_option_dict)