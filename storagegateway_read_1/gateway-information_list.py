...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/storagegateway/describe-gateway-information.html
if __name__ == '__main__':
    ...
    execute_one_parameter("storagegateway", "describe-gateway-information", "gateway-arn", add_option_dict)