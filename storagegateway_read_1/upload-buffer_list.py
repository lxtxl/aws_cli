...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/storagegateway/describe-upload-buffer.html
if __name__ == '__main__':
    ...
    execute_one_parameter("storagegateway", "describe-upload-buffer", "gateway-arn", add_option_dict)