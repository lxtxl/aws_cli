...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/storagegateway/describe-maintenance-start-time.html
if __name__ == '__main__':
    ...
    execute_one_parameter("storagegateway", "describe-maintenance-start-time", "gateway-arn", add_option_dict)