...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/storagegateway/describe-bandwidth-rate-limit-schedule.html
if __name__ == '__main__':
    ...
    execute_one_parameter("storagegateway", "describe-bandwidth-rate-limit-schedule", "gateway-arn", add_option_dict)