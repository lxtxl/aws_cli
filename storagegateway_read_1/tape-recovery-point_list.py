...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/storagegateway/describe-tape-recovery-points.html
if __name__ == '__main__':
    ...
    execute_one_parameter("storagegateway", "describe-tape-recovery-points", "gateway-arn", add_option_dict)