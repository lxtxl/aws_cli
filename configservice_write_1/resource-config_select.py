...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/configservice/select-resource-config.html
if __name__ == '__main__':
    ...
    write_one_parameter("configservice", "select-resource-config", "expression", add_option_dict)
