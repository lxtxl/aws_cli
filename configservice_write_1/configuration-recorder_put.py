...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/configservice/put-configuration-recorder.html
if __name__ == '__main__':
    ...
    write_one_parameter("configservice", "put-configuration-recorder", "configuration-recorder", add_option_dict)
