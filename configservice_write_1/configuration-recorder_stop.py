...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/configservice/stop-configuration-recorder.html
if __name__ == '__main__':
    ...
    write_one_parameter("configservice", "stop-configuration-recorder", "configuration-recorder-name", add_option_dict)
