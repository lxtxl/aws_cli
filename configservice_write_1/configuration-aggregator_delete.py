...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/configservice/delete-configuration-aggregator.html
if __name__ == '__main__':
    ...
    write_one_parameter("configservice", "delete-configuration-aggregator", "configuration-aggregator-name", add_option_dict)
