...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/configservice/put-config-rule.html
if __name__ == '__main__':
    ...
    write_one_parameter("configservice", "put-config-rule", "config-rule", add_option_dict)
