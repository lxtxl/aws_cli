...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/apigatewayv2/get-vpc-links.html
if __name__ == '__main__':
    ...
    read_no_parameter("apigatewayv2", "get-vpc-links", add_option_dict)