...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/worklink/associate-website-authorization-provider.html
if __name__ == '__main__':
    ...
    # authorization-provider-type : The authorization provider type.
Possible values:
...
SAML
    ...
    write_two_parameter("worklink", "associate-website-authorization-provider", "fleet-arn", "authorization-provider-type", add_option_dict)
