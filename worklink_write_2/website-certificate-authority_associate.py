...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/worklink/associate-website-certificate-authority.html
if __name__ == '__main__':
    ...
    write_two_parameter("worklink", "associate-website-certificate-authority", "fleet-arn", "certificate", add_option_dict)
