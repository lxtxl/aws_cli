...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/backup/get-backup-vault-notifications.html
if __name__ == '__main__':
    ...
    execute_one_parameter("backup", "get-backup-vault-notifications", "backup-vault-name", add_option_dict)