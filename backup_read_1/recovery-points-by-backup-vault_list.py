...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/backup/list-recovery-points-by-backup-vault.html
if __name__ == '__main__':
    ...
    execute_one_parameter("backup", "list-recovery-points-by-backup-vault", "backup-vault-name", add_option_dict)