...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iot/delete-audit-suppression.html
if __name__ == '__main__':
    ...
    write_two_parameter("iot", "delete-audit-suppression", "check-name", "resource-identifier", add_option_dict)
