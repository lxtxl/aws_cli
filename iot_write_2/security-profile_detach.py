...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iot/detach-security-profile.html
if __name__ == '__main__':
    ...
    # security-profile-name : The security profile that is detached.
    # security-profile-target-arn : The ARN of the thing group from which the security profile is detached.
    """
    add_option_dict = {}
    add_option_dict["parameter_display_string"] = parameter_display_string
    # ex: add_option_dict["no_value_parameter_list"] = "--single-parameter"
    write_two_parameter("iot", "detach-security-profile", "security-profile-name", "security-profile-target-arn", add_option_dict)
