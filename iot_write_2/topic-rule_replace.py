...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iot/replace-topic-rule.html
if __name__ == '__main__':
    ...
    write_two_parameter("iot", "replace-topic-rule", "rule-name", "topic-rule-payload", add_option_dict)
