...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iot/transfer-certificate.html
if __name__ == '__main__':
    ...
    # target-aws-account : The AWS account.
    """
    add_option_dict = {}
    add_option_dict["parameter_display_string"] = parameter_display_string
    # ex: add_option_dict["no_value_parameter_list"] = "--single-parameter"
    write_two_parameter("iot", "transfer-certificate", "certificate-id", "target-aws-account", add_option_dict)
