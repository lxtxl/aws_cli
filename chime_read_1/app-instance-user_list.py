...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/chime/describe-app-instance-user.html
if __name__ == '__main__':
    ...
    execute_one_parameter("chime", "describe-app-instance-user", "app-instance-user-arn", add_option_dict)