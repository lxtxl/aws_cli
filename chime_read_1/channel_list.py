...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/chime/describe-channel.html
if __name__ == '__main__':
    ...
    execute_one_parameter("chime", "describe-channel", "channel-arn", add_option_dict)