...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/chime/get-phone-number-order.html
if __name__ == '__main__':
    ...
    # phone-number-order-id : The ID for the phone number order.
    """
    ...
    execute_one_parameter("chime", "get-phone-number-order", "phone-number-order-id", add_option_dict)