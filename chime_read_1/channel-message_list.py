...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/chime/list-channel-messages.html
if __name__ == '__main__':
    ...
    execute_one_parameter("chime", "list-channel-messages", "channel-arn", add_option_dict)