...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/chime/get-app-instance-streaming-configurations.html
if __name__ == '__main__':
    ...
    execute_one_parameter("chime", "get-app-instance-streaming-configurations", "app-instance-arn", add_option_dict)