...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/chime/get-voice-connector-group.html
if __name__ == '__main__':
    ...
    execute_one_parameter("chime", "get-voice-connector-group", "voice-connector-group-id", add_option_dict)