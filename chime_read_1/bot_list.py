...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/chime/list-bots.html
if __name__ == '__main__':
    ...
    execute_one_parameter("chime", "list-bots", "account-id", add_option_dict)