...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/discovery/describe-tags.html
if __name__ == '__main__':
    ...
    read_no_parameter("discovery", "describe-tags", add_option_dict)