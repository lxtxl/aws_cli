...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/discovery/describe-continuous-exports.html
if __name__ == '__main__':
    ...
    read_no_parameter("discovery", "describe-continuous-exports", add_option_dict)