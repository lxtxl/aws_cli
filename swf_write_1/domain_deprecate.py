...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/swf/deprecate-domain.html
if __name__ == '__main__':
    ...
    write_one_parameter("swf", "deprecate-domain", "name", add_option_dict)
