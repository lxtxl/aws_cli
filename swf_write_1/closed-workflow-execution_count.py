...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/swf/count-closed-workflow-executions.html
if __name__ == '__main__':
    ...
    write_one_parameter("swf", "count-closed-workflow-executions", "domain", add_option_dict)
