...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ds/describe-directories.html
if __name__ == '__main__':
    ...
    read_no_parameter("ds", "describe-directories", add_option_dict)