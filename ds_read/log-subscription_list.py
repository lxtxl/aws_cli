...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ds/list-log-subscriptions.html
if __name__ == '__main__':
    ...
    read_no_parameter("ds", "list-log-subscriptions", add_option_dict)