...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/dataexchange/delete-revision.html
if __name__ == '__main__':
    ...
    write_two_parameter("dataexchange", "delete-revision", "data-set-id", "revision-id", add_option_dict)
