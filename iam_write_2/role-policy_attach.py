...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iam/attach-role-policy.html
if __name__ == '__main__':
    ...
    # role-name : The name (friendly name, not ARN) of the role to attach the policy to.
...
For more information about ARNs, see Amazon Resource Names (ARNs) and AWS Service Namespaces in the AWS General Reference .
    ...
    write_two_parameter("iam", "attach-role-policy", "role-name", "policy-arn", add_option_dict)
