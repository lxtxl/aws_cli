...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ecr/delete-repository-policy.html
if __name__ == '__main__':
    ...
    write_one_parameter("ecr", "delete-repository-policy", "repository-name", add_option_dict)
