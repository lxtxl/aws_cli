...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ecr/initiate-layer-upload.html
if __name__ == '__main__':
    ...
    write_one_parameter("ecr", "initiate-layer-upload", "repository-name", add_option_dict)
