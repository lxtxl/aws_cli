...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/authorize-security-group-ingress.html
if __name__ == '__main__':
    ...
    # --source-group : The name or ID of the source security group.
    """
    add_option_dict = {}
    add_option_dict["parameter_display_string"] = parameter_display_string
    add_option_dict["no_value_parameter_list"] = ["--protocol tcp"]
    write_three_parameter("ec2", "authorize-security-group-ingress", "group-id", "port", "source-group", add_option_dict)
