...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ecr/get-repository-policy.html
if __name__ == '__main__':
    ...
    execute_one_parameter("ecr", "get-repository-policy", "repository-name", add_option_dict)