...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sso-admin/get-inline-policy-for-permission-set.html
if __name__ == '__main__':
    ...
    execute_two_parameter("sso-admin", "get-inline-policy-for-permission-set", "instance-arn", "permission-set-arn", parameter_display_string)