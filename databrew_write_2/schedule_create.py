...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/databrew/create-schedule.html
if __name__ == '__main__':
    ...
    write_two_parameter("databrew", "create-schedule", "cron-expression", "name", add_option_dict)
