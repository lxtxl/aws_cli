...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/apigateway/delete-model.html
if __name__ == '__main__':
    ...
    write_two_parameter("apigateway", "delete-model", "rest-api-id", "model-name", add_option_dict)
