...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/apigateway/delete-gateway-response.html
...
QUOTA_EXCEEDED
    ...
    write_two_parameter("apigateway", "delete-gateway-response", "rest-api-id", "response-type", add_option_dict)
