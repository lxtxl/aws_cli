...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/apigateway/update-documentation-part.html
if __name__ == '__main__':
    ...
    # documentation-part-id : [Required] The identifier of the to-be-updated documentation part.
    """
    add_option_dict = {}
    add_option_dict["parameter_display_string"] = parameter_display_string
    # ex: add_option_dict["no_value_parameter_list"] = "--single-parameter"
    write_two_parameter("apigateway", "update-documentation-part", "rest-api-id", "documentation-part-id", add_option_dict)
