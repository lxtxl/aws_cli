...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/apigateway/update-resource.html
if __name__ == '__main__':
    ...
    write_two_parameter("apigateway", "update-resource", "rest-api-id", "resource-id", add_option_dict)
