...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/apigateway/delete-documentation-version.html
if __name__ == '__main__':
    ...
    # documentation-version : [Required] The version identifier of a to-be-deleted documentation snapshot.
    """
    add_option_dict = {}
    add_option_dict["parameter_display_string"] = parameter_display_string
    # ex: add_option_dict["no_value_parameter_list"] = "--single-parameter"
    write_two_parameter("apigateway", "delete-documentation-version", "rest-api-id", "documentation-version", add_option_dict)
