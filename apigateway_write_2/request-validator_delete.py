...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/apigateway/delete-request-validator.html
if __name__ == '__main__':
    ...
    # request-validator-id : [Required] The identifier of the  RequestValidator to be deleted.
    """
    add_option_dict = {}
    add_option_dict["parameter_display_string"] = parameter_display_string
    # ex: add_option_dict["no_value_parameter_list"] = "--single-parameter"
    write_two_parameter("apigateway", "delete-request-validator", "rest-api-id", "request-validator-id", add_option_dict)
