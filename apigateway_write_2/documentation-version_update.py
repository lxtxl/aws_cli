...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/apigateway/update-documentation-version.html
if __name__ == '__main__':
    ...
    # documentation-version : [Required] The version identifier of the to-be-updated documentation version.
    """
    add_option_dict = {}
    add_option_dict["parameter_display_string"] = parameter_display_string
    # ex: add_option_dict["no_value_parameter_list"] = "--single-parameter"
    write_two_parameter("apigateway", "update-documentation-version", "rest-api-id", "documentation-version", add_option_dict)
