...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iot1click-projects/create-project.html
if __name__ == '__main__':
    ...
    write_one_parameter("iot1click-projects", "create-project", "project-name", add_option_dict)
