...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/quicksight/list-data-sources.html
if __name__ == '__main__':
    ...
    execute_one_parameter("quicksight", "list-data-sources", "aws-account-id", add_option_dict)