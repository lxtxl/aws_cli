...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/glue/delete-user-defined-function.html
if __name__ == '__main__':
    ...
    # function-name : The name of the function definition to be deleted.
    """
    add_option_dict = {}
    add_option_dict["parameter_display_string"] = parameter_display_string
    # ex: add_option_dict["no_value_parameter_list"] = "--single-parameter"
    write_two_parameter("glue", "delete-user-defined-function", "database-name", "function-name", add_option_dict)
