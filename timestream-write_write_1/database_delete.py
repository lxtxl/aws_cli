...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/timestream-write/delete-database.html
if __name__ == '__main__':
    ...
    # database-name : The name of the Timestream database to be deleted.
    """
    add_option_dict = {}
    ...
    write_one_parameter("timestream-write", "delete-database", "database-name", add_option_dict)
