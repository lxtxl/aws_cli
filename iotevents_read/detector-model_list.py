...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iotevents/list-detector-models.html
if __name__ == '__main__':
    ...
    read_no_parameter("iotevents", "list-detector-models", add_option_dict)