...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/datasync/update-agent.html
if __name__ == '__main__':
    ...
    # agent-arn : The Amazon Resource Name (ARN) of the agent to update.
    """
    add_option_dict = {}
    ...
    write_one_parameter("datasync", "update-agent", "agent-arn", add_option_dict)
