...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/datasync/start-task-execution.html
if __name__ == '__main__':
    ...
    # task-arn : The Amazon Resource Name (ARN) of the task to start.
    """
    add_option_dict = {}
    ...
    write_one_parameter("datasync", "start-task-execution", "task-arn", add_option_dict)
