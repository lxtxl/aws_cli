...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/appintegrations/update-event-integration.html
if __name__ == '__main__':
    ...
    write_one_parameter("appintegrations", "update-event-integration", "name", add_option_dict)
