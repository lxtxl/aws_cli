...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/waf/get-logging-configuration.html
if __name__ == '__main__':
    ...
    execute_one_parameter("waf", "get-logging-configuration", "resource-arn", add_option_dict)