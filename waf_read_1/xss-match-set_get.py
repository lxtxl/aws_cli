...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/waf/get-xss-match-set.html
if __name__ == '__main__':
    ...
    execute_one_parameter("waf", "get-xss-match-set", "xss-match-set-id", add_option_dict)