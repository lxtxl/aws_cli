...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/waf/get-size-constraint-set.html
if __name__ == '__main__':
    ...
    execute_one_parameter("waf", "get-size-constraint-set", "size-constraint-set-id", add_option_dict)