...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/waf/get-ip-set.html
if __name__ == '__main__':
    ...
    execute_one_parameter("waf", "get-ip-set", "ip-set-id", add_option_dict)