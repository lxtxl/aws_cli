...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/elbv2/deregister-targets.html
...
If the target type is lambda , this parameter is optional and the only supported value is all .
    ...
    write_two_parameter("elbv2", "deregister-targets", "target-group-arn", "targets", add_option_dict)
