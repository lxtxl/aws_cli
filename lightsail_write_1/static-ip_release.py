...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/lightsail/release-static-ip.html
if __name__ == '__main__':
    ...
    # static-ip-name : The name of the static IP to delete.
    """
    add_option_dict = {}
    ...
    write_one_parameter("lightsail", "release-static-ip", "static-ip-name", add_option_dict)
