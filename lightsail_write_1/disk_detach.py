...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/lightsail/detach-disk.html
if __name__ == '__main__':
    ...
    # disk-name : The unique name of the disk you want to detach from your instance (e.g., my-disk ).
    """
    add_option_dict = {}
    ...
    write_one_parameter("lightsail", "detach-disk", "disk-name", add_option_dict)
