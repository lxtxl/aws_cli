...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/lightsail/create-key-pair.html
if __name__ == '__main__':
    ...
    # key-pair-name : The name for your new key pair.
    """
    add_option_dict = {}
    ...
    write_one_parameter("lightsail", "create-key-pair", "key-pair-name", add_option_dict)
