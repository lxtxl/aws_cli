...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/lightsail/delete-instance.html
if __name__ == '__main__':
    ...
    write_one_parameter("lightsail", "delete-instance", "instance-name", add_option_dict)
