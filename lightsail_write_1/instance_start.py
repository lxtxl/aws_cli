...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/lightsail/start-instance.html
if __name__ == '__main__':
    ...
    # instance-name : The name of the instance (a virtual private server) to start.
    """
    add_option_dict = {}
    ...
    write_one_parameter("lightsail", "start-instance", "instance-name", add_option_dict)
