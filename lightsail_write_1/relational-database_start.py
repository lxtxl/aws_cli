...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/lightsail/start-relational-database.html
if __name__ == '__main__':
    ...
    # relational-database-name : The name of your database to start.
    """
    add_option_dict = {}
    ...
    write_one_parameter("lightsail", "start-relational-database", "relational-database-name", add_option_dict)
