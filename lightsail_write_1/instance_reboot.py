...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/lightsail/reboot-instance.html
if __name__ == '__main__':
    ...
    # instance-name : The name of the instance to reboot.
    """
    add_option_dict = {}
    ...
    write_one_parameter("lightsail", "reboot-instance", "instance-name", add_option_dict)
