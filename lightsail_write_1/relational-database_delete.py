...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/lightsail/delete-relational-database.html
if __name__ == '__main__':
    ...
    # relational-database-name : The name of the database that you are deleting.
    """
    add_option_dict = {}
    ...
    write_one_parameter("lightsail", "delete-relational-database", "relational-database-name", add_option_dict)
