...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/lightsail/delete-container-service.html
if __name__ == '__main__':
    ...
    # service-name : The name of the container service to delete.
    """
    add_option_dict = {}
    ...
    write_one_parameter("lightsail", "delete-container-service", "service-name", add_option_dict)
