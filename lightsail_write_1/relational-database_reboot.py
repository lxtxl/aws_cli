...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/lightsail/reboot-relational-database.html
if __name__ == '__main__':
    ...
    # relational-database-name : The name of your database to reboot.
    """
    add_option_dict = {}
    ...
    write_one_parameter("lightsail", "reboot-relational-database", "relational-database-name", add_option_dict)
