...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/transfer/stop-server.html
if __name__ == '__main__':
    ...
    # server-id : A system-assigned unique identifier for a server that you stopped.
    """
    add_option_dict = {}
    ...
    write_one_parameter("transfer", "stop-server", "server-id", add_option_dict)
