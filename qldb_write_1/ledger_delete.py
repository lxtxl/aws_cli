...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/qldb/delete-ledger.html
if __name__ == '__main__':
    ...
    write_one_parameter("qldb", "delete-ledger", "name", add_option_dict)
