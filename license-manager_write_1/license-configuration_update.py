...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/license-manager/update-license-configuration.html
if __name__ == '__main__':
    ...
    write_one_parameter("license-manager", "update-license-configuration", "license-configuration-arn", add_option_dict)
