...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/license-manager/reject-grant.html
if __name__ == '__main__':
    ...
    write_one_parameter("license-manager", "reject-grant", "grant-arn", add_option_dict)
