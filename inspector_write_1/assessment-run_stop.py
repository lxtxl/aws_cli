...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/inspector/stop-assessment-run.html
if __name__ == '__main__':
    ...
    # assessment-run-arn : The ARN of the assessment run that you want to stop.
    """
    add_option_dict = {}
    ...
    write_one_parameter("inspector", "stop-assessment-run", "assessment-run-arn", add_option_dict)
