...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/es/describe-inbound-cross-cluster-search-connections.html
if __name__ == '__main__':
    ...
    read_no_parameter("es", "describe-inbound-cross-cluster-search-connections", add_option_dict)