...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/forecast/delete-dataset.html
if __name__ == '__main__':
    ...
    write_one_parameter("forecast", "delete-dataset", "dataset-arn", add_option_dict)
