...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/apigatewayv2/delete-route-response.html
if __name__ == '__main__':
    ...
    write_three_parameter("apigatewayv2", "delete-route-response", "api-id", "route-id", "route-response-id", add_option_dict)
