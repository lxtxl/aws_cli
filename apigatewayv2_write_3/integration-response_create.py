...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/apigatewayv2/create-integration-response.html
if __name__ == '__main__':
    ...
    # integration-response-key : The integration response key.
    """
    add_option_dict = {}
    add_option_dict["parameter_display_string"] = parameter_display_string
    # ex: add_option_dict["no_value_parameter_list"] = "--single-parameter"
    write_three_parameter("apigatewayv2", "create-integration-response", "api-id", "integration-id", "integration-response-key", add_option_dict)
