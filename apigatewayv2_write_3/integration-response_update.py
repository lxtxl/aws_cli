...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/apigatewayv2/update-integration-response.html
if __name__ == '__main__':
    ...
    write_three_parameter("apigatewayv2", "update-integration-response", "api-id", "integration-id", "integration-response-id", add_option_dict)
