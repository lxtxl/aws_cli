...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/rds/delete-db-cluster-endpoint.html
if __name__ == '__main__':
    ...
    write_one_parameter("rds", "delete-db-cluster-endpoint", "db-cluster-endpoint-identifier", add_option_dict)
