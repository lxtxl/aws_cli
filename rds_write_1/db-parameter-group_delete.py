...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/rds/delete-db-parameter-group.html
...
Canât be associated with any DB instances
    """
    add_option_dict = {}
    ...
    write_one_parameter("rds", "delete-db-parameter-group", "db-parameter-group-name", add_option_dict)
