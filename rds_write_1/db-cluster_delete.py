...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/rds/delete-db-cluster.html
...
Must match an existing DBClusterIdentifier.
    ...
    write_one_parameter("rds", "delete-db-cluster", "db-cluster-identifier", add_option_dict)
