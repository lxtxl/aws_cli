...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/rds/reboot-db-instance.html
...
Must match the identifier of an existing DBInstance.
    ...
    write_one_parameter("rds", "reboot-db-instance", "db-instance-identifier", add_option_dict)
