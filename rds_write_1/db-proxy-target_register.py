...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/rds/register-db-proxy-targets.html
if __name__ == '__main__':
    ...
    write_one_parameter("rds", "register-db-proxy-targets", "db-proxy-name", add_option_dict)
