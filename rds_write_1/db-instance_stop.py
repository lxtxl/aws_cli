...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/rds/stop-db-instance.html
if __name__ == '__main__':
    ...
    write_one_parameter("rds", "stop-db-instance", "db-instance-identifier", add_option_dict)
