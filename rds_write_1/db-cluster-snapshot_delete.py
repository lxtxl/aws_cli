...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/rds/delete-db-cluster-snapshot.html
...
Constraints: Must be the name of an existing DB cluster snapshot in the available state.
    ...
    write_one_parameter("rds", "delete-db-cluster-snapshot", "db-cluster-snapshot-identifier", add_option_dict)
