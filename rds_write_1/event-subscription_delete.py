...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/rds/delete-event-subscription.html
if __name__ == '__main__':
    ...
    # subscription-name : The name of the RDS event notification subscription you want to delete.
    """
    add_option_dict = {}
    ...
    write_one_parameter("rds", "delete-event-subscription", "subscription-name", add_option_dict)
