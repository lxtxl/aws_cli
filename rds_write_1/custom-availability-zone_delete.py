...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/rds/delete-custom-availability-zone.html
if __name__ == '__main__':
    ...
    # custom-availability-zone-id : The custom AZ identifier.
    """
    add_option_dict = {}
    ...
    write_one_parameter("rds", "delete-custom-availability-zone", "custom-availability-zone-id", add_option_dict)
