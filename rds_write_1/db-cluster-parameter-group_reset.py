...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/rds/reset-db-cluster-parameter-group.html
if __name__ == '__main__':
    ...
    write_one_parameter("rds", "reset-db-cluster-parameter-group", "db-cluster-parameter-group-name", add_option_dict)
