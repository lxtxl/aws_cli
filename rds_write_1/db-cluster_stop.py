...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/rds/stop-db-cluster.html
if __name__ == '__main__':
    ...
    # db-cluster-identifier : The DB cluster identifier of the Amazon Aurora DB cluster to be stopped. This parameter is stored as a lowercase string.
    """
    add_option_dict = {}
    ...
    write_one_parameter("rds", "stop-db-cluster", "db-cluster-identifier", add_option_dict)
