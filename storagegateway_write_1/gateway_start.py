...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/storagegateway/start-gateway.html
if __name__ == '__main__':
    ...
    write_one_parameter("storagegateway", "start-gateway", "gateway-arn", add_option_dict)
