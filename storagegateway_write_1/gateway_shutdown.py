...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/storagegateway/shutdown-gateway.html
if __name__ == '__main__':
    ...
    write_one_parameter("storagegateway", "shutdown-gateway", "gateway-arn", add_option_dict)
