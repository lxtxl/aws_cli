...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/storagegateway/delete-gateway.html
if __name__ == '__main__':
    ...
    write_one_parameter("storagegateway", "delete-gateway", "gateway-arn", add_option_dict)
