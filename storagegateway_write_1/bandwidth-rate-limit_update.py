...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/storagegateway/update-bandwidth-rate-limit.html
if __name__ == '__main__':
    ...
    write_one_parameter("storagegateway", "update-bandwidth-rate-limit", "gateway-arn", add_option_dict)
