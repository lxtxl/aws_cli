...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/lakeformation/batch-revoke-permissions.html
...
(string)
    ...
    write_one_parameter("lakeformation", "batch-revoke-permissions", "entries", add_option_dict)
