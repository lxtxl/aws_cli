...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/apigateway/delete-integration.html
if __name__ == '__main__':
    ...
    # resource-id : [Required] Specifies a delete integration requestâs resource identifier.
    # http-method : [Required] Specifies a delete integration requestâs HTTP method.
    """
    add_option_dict = {}
    add_option_dict["parameter_display_string"] = parameter_display_string
    # ex: add_option_dict["no_value_parameter_list"] = "--single-parameter"
    write_three_parameter("apigateway", "delete-integration", "rest-api-id", "resource-id", "http-method", add_option_dict)
