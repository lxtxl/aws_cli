...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/gamelift/list-scripts.html
if __name__ == '__main__':
    ...
    read_no_parameter("gamelift", "list-scripts", add_option_dict)