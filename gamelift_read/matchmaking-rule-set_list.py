...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/gamelift/describe-matchmaking-rule-sets.html
if __name__ == '__main__':
    ...
    read_no_parameter("gamelift", "describe-matchmaking-rule-sets", add_option_dict)