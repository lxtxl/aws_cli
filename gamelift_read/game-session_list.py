...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/gamelift/describe-game-sessions.html
if __name__ == '__main__':
    ...
    read_no_parameter("gamelift", "describe-game-sessions", add_option_dict)