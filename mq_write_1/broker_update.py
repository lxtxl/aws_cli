...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/mq/update-broker.html
if __name__ == '__main__':
    ...
    write_one_parameter("mq", "update-broker", "broker-id", add_option_dict)
