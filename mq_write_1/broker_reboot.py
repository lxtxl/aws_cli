...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/mq/reboot-broker.html
if __name__ == '__main__':
    ...
    write_one_parameter("mq", "reboot-broker", "broker-id", add_option_dict)
