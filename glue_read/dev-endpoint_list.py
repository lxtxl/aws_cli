...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/glue/list-dev-endpoints.html
if __name__ == '__main__':
    ...
    read_no_parameter("glue", "list-dev-endpoints", add_option_dict)