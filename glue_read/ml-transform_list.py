...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/glue/list-ml-transforms.html
if __name__ == '__main__':
    ...
    read_no_parameter("glue", "list-ml-transforms", add_option_dict)