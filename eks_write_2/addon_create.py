...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/eks/create-addon.html
if __name__ == '__main__':
    ...
    # cluster-name : The name of the cluster to create the add-on for.
    ...
    write_two_parameter("eks", "create-addon", "cluster-name", "addon-name", add_option_dict)
