...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/eks/update-addon.html
if __name__ == '__main__':
    ...
    write_two_parameter("eks", "update-addon", "cluster-name", "addon-name", add_option_dict)
