...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ecs/list-account-settings.html
if __name__ == '__main__':
    ...
    read_no_parameter("ecs", "list-account-settings", add_option_dict)