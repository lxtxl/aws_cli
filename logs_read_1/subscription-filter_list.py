...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/logs/describe-subscription-filters.html
if __name__ == '__main__':
    ...
    execute_one_parameter("logs", "describe-subscription-filters", "log-group-name", add_option_dict)