...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iotanalytics/delete-dataset-content.html
if __name__ == '__main__':
    ...
    # dataset-name : The name of the dataset whose content is deleted.
    """
    add_option_dict = {}
    ...
    write_one_parameter("iotanalytics", "delete-dataset-content", "dataset-name", add_option_dict)
