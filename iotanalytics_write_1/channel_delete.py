...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iotanalytics/delete-channel.html
if __name__ == '__main__':
    ...
    # channel-name : The name of the channel to delete.
    """
    add_option_dict = {}
    ...
    write_one_parameter("iotanalytics", "delete-channel", "channel-name", add_option_dict)
