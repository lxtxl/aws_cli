...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iotanalytics/delete-datastore.html
if __name__ == '__main__':
    ...
    # datastore-name : The name of the data store to delete.
    """
    add_option_dict = {}
    ...
    write_one_parameter("iotanalytics", "delete-datastore", "datastore-name", add_option_dict)
