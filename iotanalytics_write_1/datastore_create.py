...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iotanalytics/create-datastore.html
if __name__ == '__main__':
    ...
    write_one_parameter("iotanalytics", "create-datastore", "datastore-name", add_option_dict)
