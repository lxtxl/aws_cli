...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iotevents/describe-detector-model.html
if __name__ == '__main__':
    ...
    execute_one_parameter("iotevents", "describe-detector-model", "detector-model-name", add_option_dict)