...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/quicksight/create-group.html
if __name__ == '__main__':
    ...
    # group-name : A name for the group that you want to create.
    ...
    write_three_parameter("quicksight", "create-group", "group-name", "aws-account-id", "namespace", add_option_dict)
