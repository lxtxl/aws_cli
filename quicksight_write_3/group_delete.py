...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/quicksight/delete-group.html
if __name__ == '__main__':
    ...
    # group-name : The name of the group that you want to delete.
    ...
    write_three_parameter("quicksight", "delete-group", "group-name", "aws-account-id", "namespace", add_option_dict)
