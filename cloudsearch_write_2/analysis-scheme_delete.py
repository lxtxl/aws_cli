...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/cloudsearch/delete-analysis-scheme.html
if __name__ == '__main__':
    ...
    # analysis-scheme-name : The name of the analysis scheme you want to delete.
    """
    add_option_dict = {}
    add_option_dict["parameter_display_string"] = parameter_display_string
    # ex: add_option_dict["no_value_parameter_list"] = "--single-parameter"
    write_two_parameter("cloudsearch", "delete-analysis-scheme", "domain-name", "analysis-scheme-name", add_option_dict)
