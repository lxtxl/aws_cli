...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/cloudsearch/define-suggester.html
if __name__ == '__main__':
    ...
    write_two_parameter("cloudsearch", "define-suggester", "domain-name", "suggester", add_option_dict)
