...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iot-data/get-thing-shadow.html
if __name__ == '__main__':
    ...
    execute_one_parameter("iot-data", "get-thing-shadow", "thing-name", add_option_dict)