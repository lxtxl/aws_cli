...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/amplify/create-domain-association.html
if __name__ == '__main__':
    ...
    # domain-name : The domain name for the domain association.
    # sub-domain-settings : The setting for the subdomain.
(structure)
...
The branch name setting for the subdomain.
    ...
    write_three_parameter("amplify", "create-domain-association", "app-id", "domain-name", "sub-domain-settings", add_option_dict)
