...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/servicecatalog-appregistry/create-attribute-group.html
if __name__ == '__main__':
    ...
    write_two_parameter("servicecatalog-appregistry", "create-attribute-group", "name", "attributes", add_option_dict)
