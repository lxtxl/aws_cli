...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/rekognition/list-collections.html
if __name__ == '__main__':
    ...
    read_no_parameter("rekognition", "list-collections", add_option_dict)