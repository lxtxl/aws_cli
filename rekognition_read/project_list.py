...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/rekognition/describe-projects.html
if __name__ == '__main__':
    ...
    read_no_parameter("rekognition", "describe-projects", add_option_dict)