...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/redshift/describe-hsm-client-certificates.html
if __name__ == '__main__':
    ...
    read_no_parameter("redshift", "describe-hsm-client-certificates", add_option_dict)