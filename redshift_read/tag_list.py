...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/redshift/describe-tags.html
if __name__ == '__main__':
    ...
    read_no_parameter("redshift", "describe-tags", add_option_dict)