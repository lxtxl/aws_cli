...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/redshift/describe-cluster-subnet-groups.html
if __name__ == '__main__':
    ...
    read_no_parameter("redshift", "describe-cluster-subnet-groups", add_option_dict)