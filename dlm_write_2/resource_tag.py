...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/dlm/tag-resource.html
...
value -> (string)
    ...
    write_two_parameter("dlm", "tag-resource", "resource-arn", "tags", add_option_dict)
