...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/dlm/untag-resource.html
...
(string)
    ...
    write_two_parameter("dlm", "untag-resource", "resource-arn", "tag-keys", add_option_dict)
