...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/customer-profiles/update-domain.html
if __name__ == '__main__':
    ...
    # domain-name : The unique name for the domain.
    """
    add_option_dict = {}
    ...
    write_one_parameter("customer-profiles", "update-domain", "domain-name", add_option_dict)
