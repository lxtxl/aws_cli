...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/lookoutvision/delete-model.html
if __name__ == '__main__':
    ...
    # project-name : The name of the project that contains the model that you want to delete.
    # model-version : The version of the model that you want to delete.
    """
    add_option_dict = {}
    add_option_dict["parameter_display_string"] = parameter_display_string
    # ex: add_option_dict["no_value_parameter_list"] = "--single-parameter"
    write_two_parameter("lookoutvision", "delete-model", "project-name", "model-version", add_option_dict)
