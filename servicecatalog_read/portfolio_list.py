...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/servicecatalog/list-portfolios.html
if __name__ == '__main__':
    ...
    read_no_parameter("servicecatalog", "list-portfolios", add_option_dict)