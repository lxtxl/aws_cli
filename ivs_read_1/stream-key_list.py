...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ivs/list-stream-keys.html
if __name__ == '__main__':
    ...
    # channel-arn : Channel ARN used to filter the list.
    """
    ...
    execute_one_parameter("ivs", "list-stream-keys", "channel-arn", add_option_dict)