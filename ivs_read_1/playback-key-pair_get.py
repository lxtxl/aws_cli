...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ivs/get-playback-key-pair.html
if __name__ == '__main__':
    ...
    execute_one_parameter("ivs", "get-playback-key-pair", "arn", add_option_dict)