...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/cloudfront/create-invalidation.html
if __name__ == '__main__':
    ...
    write_one_parameter("cloudfront", "create-invalidation", "distribution-id", add_option_dict)
