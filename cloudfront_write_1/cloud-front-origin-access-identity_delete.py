...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/cloudfront/delete-cloud-front-origin-access-identity.html
if __name__ == '__main__':
    ...
    # id : The origin access identityâs ID.
    """
    add_option_dict = {}
    ...
    write_one_parameter("cloudfront", "delete-cloud-front-origin-access-identity", "id", add_option_dict)
