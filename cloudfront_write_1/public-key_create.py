...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/cloudfront/create-public-key.html
if __name__ == '__main__':
    ...
    write_one_parameter("cloudfront", "create-public-key", "public-key-config", add_option_dict)
