...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/cloudfront/create-field-level-encryption-config.html
if __name__ == '__main__':
    ...
    write_one_parameter("cloudfront", "create-field-level-encryption-config", "field-level-encryption-config", add_option_dict)
