...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/cloudfront/delete-key-group.html
if __name__ == '__main__':
    ...
    write_one_parameter("cloudfront", "delete-key-group", "id", add_option_dict)
