...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/cloudfront/delete-streaming-distribution.html
if __name__ == '__main__':
    ...
    write_one_parameter("cloudfront", "delete-streaming-distribution", "id", add_option_dict)
