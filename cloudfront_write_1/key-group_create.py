...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/cloudfront/create-key-group.html
if __name__ == '__main__':
    ...
    write_one_parameter("cloudfront", "create-key-group", "key-group-config", add_option_dict)
