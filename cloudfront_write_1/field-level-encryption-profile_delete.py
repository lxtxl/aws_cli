...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/cloudfront/delete-field-level-encryption-profile.html
if __name__ == '__main__':
    ...
    write_one_parameter("cloudfront", "delete-field-level-encryption-profile", "id", add_option_dict)
