...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/cloudfront/delete-public-key.html
if __name__ == '__main__':
    ...
    write_one_parameter("cloudfront", "delete-public-key", "id", add_option_dict)
