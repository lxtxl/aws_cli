...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/cloudfront/delete-distribution.html
if __name__ == '__main__':
    ...
    write_one_parameter("cloudfront", "delete-distribution", "id", add_option_dict)
