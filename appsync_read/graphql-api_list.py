...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/appsync/list-graphql-apis.html
if __name__ == '__main__':
    ...
    read_no_parameter("appsync", "list-graphql-apis", add_option_dict)