...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/shield/create-protection-group.html
...
BY_RESOURCE_TYPE
    ...
    write_three_parameter("shield", "create-protection-group", "protection-group-id", "aggregation", "pattern", add_option_dict)
