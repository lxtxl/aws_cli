...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/codestar-connections/update-host.html
if __name__ == '__main__':
    ...
    # host-arn : The Amazon Resource Name (ARN) of the host to be updated.
    """
    add_option_dict = {}
    ...
    write_one_parameter("codestar-connections", "update-host", "host-arn", add_option_dict)
