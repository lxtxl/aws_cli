...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/associate-route-table.html
if __name__ == '__main__':
    ...
    write_one_parameter("ec2", "associate-route-table", "route-table-id", add_option_dict)
