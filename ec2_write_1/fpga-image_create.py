...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/create-fpga-image.html
if __name__ == '__main__':
    ...
    write_one_parameter("ec2", "create-fpga-image", "input-storage-location", add_option_dict)
