...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/reset-fpga-image-attribute.html
if __name__ == '__main__':
    ...
    write_one_parameter("ec2", "reset-fpga-image-attribute", "fpga-image-id", add_option_dict)
