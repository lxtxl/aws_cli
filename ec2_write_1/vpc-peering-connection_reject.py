...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/reject-vpc-peering-connection.html
if __name__ == '__main__':
    ...
    write_one_parameter("ec2", "reject-vpc-peering-connection", "vpc-peering-connection-id", add_option_dict)
