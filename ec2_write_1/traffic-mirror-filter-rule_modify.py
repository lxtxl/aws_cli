...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/modify-traffic-mirror-filter-rule.html
if __name__ == '__main__':
    ...
    write_one_parameter("ec2", "modify-traffic-mirror-filter-rule", "traffic-mirror-filter-rule-id", add_option_dict)
