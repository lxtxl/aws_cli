...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/modify-network-interface-attribute.html
if __name__ == '__main__':
    ...
    write_one_parameter("ec2", "modify-network-interface-attribute", "network-interface-id", add_option_dict)
