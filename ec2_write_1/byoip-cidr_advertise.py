...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/advertise-byoip-cidr.html
if __name__ == '__main__':
    ...
    write_one_parameter("ec2", "advertise-byoip-cidr", "cidr", add_option_dict)
