...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/bundle-instance.html
if __name__ == '__main__':
    ...
    # instance-id : The ID of the instance to bundle.
Type: String
Default: None
Required: Yes
    """
    ...
    write_one_parameter("ec2", "bundle-instance", "instance-id", add_option_dict)
