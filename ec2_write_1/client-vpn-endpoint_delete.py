...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/delete-client-vpn-endpoint.html
if __name__ == '__main__':
    ...
    # client-vpn-endpoint-id : The ID of the Client VPN to be deleted.
    """
    add_option_dict = {}
    ...
    write_one_parameter("ec2", "delete-client-vpn-endpoint", "client-vpn-endpoint-id", add_option_dict)
