...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/release-hosts.html
if __name__ == '__main__':
    ...
    # host-ids : The IDs of the Dedicated Hosts to release.
(string)
    """
    add_option_dict = {}
    ...
    write_one_parameter("ec2", "release-hosts", "host-ids", add_option_dict)
