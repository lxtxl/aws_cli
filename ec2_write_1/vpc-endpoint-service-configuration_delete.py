...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/delete-vpc-endpoint-service-configurations.html
if __name__ == '__main__':
    ...
    # service-ids : The IDs of one or more services.
(string)
    """
    add_option_dict = {}
    ...
    write_one_parameter("ec2", "delete-vpc-endpoint-service-configurations", "service-ids", add_option_dict)
