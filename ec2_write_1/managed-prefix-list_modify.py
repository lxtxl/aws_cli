...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/modify-managed-prefix-list.html
if __name__ == '__main__':
    ...
    write_one_parameter("ec2", "modify-managed-prefix-list", "prefix-list-id", add_option_dict)
