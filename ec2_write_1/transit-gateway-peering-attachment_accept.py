...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/accept-transit-gateway-peering-attachment.html
if __name__ == '__main__':
    ...
    write_one_parameter("ec2", "accept-transit-gateway-peering-attachment", "transit-gateway-attachment-id", add_option_dict)
