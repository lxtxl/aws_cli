...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/delete-customer-gateway.html
if __name__ == '__main__':
    ...
    write_one_parameter("ec2", "delete-customer-gateway", "customer-gateway-id", add_option_dict)
