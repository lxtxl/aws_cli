...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/modify-volume.html
if __name__ == '__main__':
    ...
    write_one_parameter("ec2", "modify-volume", "volume-id", add_option_dict)
