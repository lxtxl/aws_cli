...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/delete-transit-gateway.html
if __name__ == '__main__':
    ...
    write_one_parameter("ec2", "delete-transit-gateway", "transit-gateway-id", add_option_dict)
