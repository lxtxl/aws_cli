...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/delete-transit-gateway-multicast-domain.html
if __name__ == '__main__':
    ...
    write_one_parameter("ec2", "delete-transit-gateway-multicast-domain", "transit-gateway-multicast-domain-id", add_option_dict)
