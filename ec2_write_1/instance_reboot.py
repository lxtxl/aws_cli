...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/reboot-instances.html
...
(string)
    ...
    write_one_parameter("ec2", "reboot-instances", "instance-ids", add_option_dict)
