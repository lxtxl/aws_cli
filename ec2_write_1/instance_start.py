...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/start-instances.html
...
(string)
    ...
    write_one_parameter("ec2", "start-instances", "instance-ids", add_option_dict)
