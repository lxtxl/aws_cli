...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/delete-vpn-connection.html
if __name__ == '__main__':
    ...
    write_one_parameter("ec2", "delete-vpn-connection", "vpn-connection-id", add_option_dict)
