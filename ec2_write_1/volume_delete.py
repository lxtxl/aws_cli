...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/delete-volume.html
if __name__ == '__main__':
    ...
    write_one_parameter("ec2", "delete-volume", "volume-id", add_option_dict)
