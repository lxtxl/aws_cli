...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/modify-transit-gateway-vpc-attachment.html
if __name__ == '__main__':
    ...
    write_one_parameter("ec2", "modify-transit-gateway-vpc-attachment", "transit-gateway-attachment-id", add_option_dict)
