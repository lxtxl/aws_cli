...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/monitor-instances.html
...
(string)
    ...
    write_one_parameter("ec2", "monitor-instances", "instance-ids", add_option_dict)
