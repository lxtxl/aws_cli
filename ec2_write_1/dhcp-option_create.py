...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/create-dhcp-options.html
if __name__ == '__main__':
    ...
    # dhcp-configurations : A DHCP configuration option.
(structure)
...
(string)
    ...
    write_one_parameter("ec2", "create-dhcp-options", "dhcp-configurations", add_option_dict)
