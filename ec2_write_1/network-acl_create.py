...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/create-network-acl.html
if __name__ == '__main__':
    ...
    write_one_parameter("ec2", "create-network-acl", "vpc-id", add_option_dict)
