...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/kinesis/describe-stream.html
if __name__ == '__main__':
    ...
    execute_one_parameter("kinesis", "describe-stream", "stream-name", add_option_dict)