...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/logs/untag-log-group.html
...
(string)
    ...
    write_two_parameter("logs", "untag-log-group", "log-group-name", "tags", add_option_dict)
