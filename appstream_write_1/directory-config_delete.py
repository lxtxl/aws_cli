...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/appstream/delete-directory-config.html
if __name__ == '__main__':
    ...
    # directory-name : The name of the directory configuration.
    """
    add_option_dict = {}
    ...
    write_one_parameter("appstream", "delete-directory-config", "directory-name", add_option_dict)
