...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/appstream/create-stack.html
if __name__ == '__main__':
    ...
    write_one_parameter("appstream", "create-stack", "name", add_option_dict)
