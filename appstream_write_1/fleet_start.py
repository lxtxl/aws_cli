...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/appstream/start-fleet.html
if __name__ == '__main__':
    ...
    write_one_parameter("appstream", "start-fleet", "name", add_option_dict)
