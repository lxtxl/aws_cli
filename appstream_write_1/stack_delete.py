...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/appstream/delete-stack.html
if __name__ == '__main__':
    ...
    write_one_parameter("appstream", "delete-stack", "name", add_option_dict)
