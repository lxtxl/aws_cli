...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/appstream/delete-fleet.html
if __name__ == '__main__':
    ...
    write_one_parameter("appstream", "delete-fleet", "name", add_option_dict)
