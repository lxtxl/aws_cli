...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/appstream/stop-image-builder.html
if __name__ == '__main__':
    ...
    write_one_parameter("appstream", "stop-image-builder", "name", add_option_dict)
