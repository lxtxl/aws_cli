...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/appflow/describe-connector-profiles.html
if __name__ == '__main__':
    ...
    read_no_parameter("appflow", "describe-connector-profiles", add_option_dict)