...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/workmail/list-organizations.html
if __name__ == '__main__':
    ...
    read_no_parameter("workmail", "list-organizations", add_option_dict)