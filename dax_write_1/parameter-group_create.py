...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/dax/create-parameter-group.html
if __name__ == '__main__':
    ...
    # parameter-group-name : The name of the parameter group to apply to all of the clusters in this replication group.
    """
    add_option_dict = {}
    ...
    write_one_parameter("dax", "create-parameter-group", "parameter-group-name", add_option_dict)
