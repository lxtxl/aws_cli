...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/appsync/flush-api-cache.html
if __name__ == '__main__':
    ...
    write_one_parameter("appsync", "flush-api-cache", "api-id", add_option_dict)
