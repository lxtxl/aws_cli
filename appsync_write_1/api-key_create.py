...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/appsync/create-api-key.html
if __name__ == '__main__':
    ...
    # api-id : The ID for your GraphQL API.
    """
    add_option_dict = {}
    ...
    write_one_parameter("appsync", "create-api-key", "api-id", add_option_dict)
