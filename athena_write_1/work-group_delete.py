...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/athena/delete-work-group.html
if __name__ == '__main__':
    ...
    # work-group : The unique name of the workgroup to delete.
    """
    add_option_dict = {}
    ...
    write_one_parameter("athena", "delete-work-group", "work-group", add_option_dict)
