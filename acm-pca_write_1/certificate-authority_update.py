...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/acm-pca/update-certificate-authority.html
...
``arn:aws:acm-pca:region :account :certificate-authority/12345678-1234-1234-1234-123456789012 ``
    ...
    write_one_parameter("acm-pca", "update-certificate-authority", "certificate-authority-arn", add_option_dict)
