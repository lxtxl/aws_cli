...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/pinpoint/create-push-template.html
if __name__ == '__main__':
    ...
    write_two_parameter("pinpoint", "create-push-template", "push-notification-template-request", "template-name", add_option_dict)
