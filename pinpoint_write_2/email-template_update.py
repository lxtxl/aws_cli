...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/pinpoint/update-email-template.html
if __name__ == '__main__':
    ...
    write_two_parameter("pinpoint", "update-email-template", "email-template-request", "template-name", add_option_dict)
