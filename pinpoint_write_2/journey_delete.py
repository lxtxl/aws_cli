...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/pinpoint/delete-journey.html
if __name__ == '__main__':
    ...
    write_two_parameter("pinpoint", "delete-journey", "application-id", "journey-id", add_option_dict)
