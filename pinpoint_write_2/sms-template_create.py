...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/pinpoint/create-sms-template.html
if __name__ == '__main__':
    ...
    write_two_parameter("pinpoint", "create-sms-template", "sms-template-request", "template-name", add_option_dict)
