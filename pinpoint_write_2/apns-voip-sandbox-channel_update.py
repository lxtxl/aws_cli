...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/pinpoint/update-apns-voip-sandbox-channel.html
if __name__ == '__main__':
    ...
    write_two_parameter("pinpoint", "update-apns-voip-sandbox-channel", "apns-voip-sandbox-channel-request", "application-id", add_option_dict)
