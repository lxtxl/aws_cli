...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/pinpoint/create-voice-template.html
if __name__ == '__main__':
    ...
    write_two_parameter("pinpoint", "create-voice-template", "template-name", "voice-template-request", add_option_dict)
