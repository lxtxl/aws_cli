...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/application-insights/create-application.html
if __name__ == '__main__':
    ...
    write_one_parameter("application-insights", "create-application", "resource-group-name", add_option_dict)
