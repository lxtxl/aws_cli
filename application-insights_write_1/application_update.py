...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/application-insights/update-application.html
if __name__ == '__main__':
    ...
    write_one_parameter("application-insights", "update-application", "resource-group-name", add_option_dict)
