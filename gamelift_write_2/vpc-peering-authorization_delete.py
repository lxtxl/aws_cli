...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/gamelift/delete-vpc-peering-authorization.html
if __name__ == '__main__':
    ...
    write_two_parameter("gamelift", "delete-vpc-peering-authorization", "game-lift-aws-account-id", "peer-vpc-id", add_option_dict)
