...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/gamelift/resume-game-server-group.html
if __name__ == '__main__':
    ...
    # resume-actions : The activity to resume for this game server group.
(string)
    """
    add_option_dict = {}
    add_option_dict["parameter_display_string"] = parameter_display_string
    # ex: add_option_dict["no_value_parameter_list"] = "--single-parameter"
    write_two_parameter("gamelift", "resume-game-server-group", "game-server-group-name", "resume-actions", add_option_dict)
