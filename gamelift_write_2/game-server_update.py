...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/gamelift/update-game-server.html
if __name__ == '__main__':
    ...
    # game-server-id : A custom string that uniquely identifies the game server to update.
    """
    add_option_dict = {}
    add_option_dict["parameter_display_string"] = parameter_display_string
    # ex: add_option_dict["no_value_parameter_list"] = "--single-parameter"
    write_two_parameter("gamelift", "update-game-server", "game-server-group-name", "game-server-id", add_option_dict)
