...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/pinpoint-email/list-email-identities.html
if __name__ == '__main__':
    ...
    read_no_parameter("pinpoint-email", "list-email-identities", add_option_dict)