...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/pinpoint-email/list-configuration-sets.html
if __name__ == '__main__':
    ...
    read_no_parameter("pinpoint-email", "list-configuration-sets", add_option_dict)