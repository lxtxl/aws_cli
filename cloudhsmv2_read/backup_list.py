...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/cloudhsmv2/describe-backups.html
if __name__ == '__main__':
    ...
    read_no_parameter("cloudhsmv2", "describe-backups", add_option_dict)