...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/devicefarm/get-device-pool.html
if __name__ == '__main__':
    ...
    execute_one_parameter("devicefarm", "get-device-pool", "arn", add_option_dict)