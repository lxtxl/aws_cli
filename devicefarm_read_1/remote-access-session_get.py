...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/devicefarm/get-remote-access-session.html
if __name__ == '__main__':
    ...
    execute_one_parameter("devicefarm", "get-remote-access-session", "arn", add_option_dict)