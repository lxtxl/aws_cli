...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/devicefarm/get-network-profile.html
if __name__ == '__main__':
    ...
    execute_one_parameter("devicefarm", "get-network-profile", "arn", add_option_dict)