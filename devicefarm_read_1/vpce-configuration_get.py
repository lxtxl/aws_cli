...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/devicefarm/get-vpce-configuration.html
if __name__ == '__main__':
    ...
    execute_one_parameter("devicefarm", "get-vpce-configuration", "arn", add_option_dict)