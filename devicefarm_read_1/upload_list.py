...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/devicefarm/list-uploads.html
if __name__ == '__main__':
    ...
    execute_one_parameter("devicefarm", "list-uploads", "arn", add_option_dict)