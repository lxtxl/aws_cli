...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/mturk/delete-qualification-type.html
if __name__ == '__main__':
    ...
    # qualification-type-id : The ID of the QualificationType to dispose.
    """
    add_option_dict = {}
    ...
    write_one_parameter("mturk", "delete-qualification-type", "qualification-type-id", add_option_dict)
