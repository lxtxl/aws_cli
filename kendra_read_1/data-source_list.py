...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/kendra/list-data-sources.html
if __name__ == '__main__':
    ...
    execute_one_parameter("kendra", "list-data-sources", "index-id", add_option_dict)