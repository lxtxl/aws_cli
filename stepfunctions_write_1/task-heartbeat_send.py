...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/stepfunctions/send-task-heartbeat.html
if __name__ == '__main__':
    ...
    write_one_parameter("stepfunctions", "send-task-heartbeat", "task-token", add_option_dict)
