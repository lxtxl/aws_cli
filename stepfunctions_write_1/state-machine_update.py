...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/stepfunctions/update-state-machine.html
if __name__ == '__main__':
    ...
    write_one_parameter("stepfunctions", "update-state-machine", "state-machine-arn", add_option_dict)
