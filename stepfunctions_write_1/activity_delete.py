...
# url : https://awscli.amazonaws.com/v2/documentation/api/latest/reference/stepfunctions/delete-activity.html
if __name__ == '__main__':
    ...
    # activity-arn : The Amazon Resource Name (ARN) of the activity to delete.
    """
    add_option_dict = {}
    ...
    write_one_parameter("stepfunctions", "delete-activity", "activity-arn", add_option_dict)
